 ...
 * @author pchretien
 */
public final class AccountServicesImpl implements AccountServices {
	 ...
	 */
	@Inject
	public AccountServicesImpl(final AccountStorePlugin accountStorePlugin, final FileManager fileManager, final VSecurityManager securityManager) {
		...
		defaultPhoto = fileManager.createFile("defaultPhoto.png", "image/png", AccountServicesImpl.class.getResource("defaultPhoto.png"));
	}

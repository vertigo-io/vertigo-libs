...
- [ui-vuejs] better ajaxError support 
	fix case when response doesn't exist
	add case when ajax response is a redirect
	add case when a message is built on server side

 ...
 * @author pchretien
 */
public final class StoreFeatures extends Features<StoreFeatures> {
	 ...
	 */
	@Feature("store")
	public StoreFeatures withStore() {
	...
	public StoreFeatures withSqlStore(final Param... params) {
		getModuleConfigBuilder()
	...
	public StoreFeatures withFsFileStore(final Param... params) {
		getModuleConfigBuilder()
	...
	public StoreFeatures withDbFileStore(final Param... params) {
		getModuleConfigBuilder()
	...
	public StoreFeatures withFsFullFileStore(final Param... params) {
		getModuleConfigBuilder()
	 ...
	 */
	@Feature("kvStore")
	public StoreFeatures withKVStore() {
		getModuleConfigBuilder()
	...
	public StoreFeatures withBerkleyKV(final Param... params) {
		getModuleConfigBuilder()
	...
	public StoreFeatures withDelayedMemoryKV(final Param... params) {
		getModuleConfigBuilder()
	...
	public StoreFeatures withTaskProxyMethod() {
		getModuleConfigBuilder()
	...
	public StoreFeatures withDomainMetrics() {
		getModuleConfigBuilder()

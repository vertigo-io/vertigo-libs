 ...
 * @author pchretien
 */
public final class DataFeatures extends Features<DataFeatures> {
	...
	@Feature("search")
	public DataFeatures withSearch() {
	...
	public DataFeatures withESClient(final Param... params) {
		getModuleConfigBuilder()
	...
	public DataFeatures withESHL(final Param... params) {
		getModuleConfigBuilder()
	...
	public DataFeatures withLuceneIndex() {
		getModuleConfigBuilder()

...
public interface CollectionsManager extends Manager {
	 ...
	 */
	<D extends DataObject> Predicate<D> filter(final ListFilter listFilter);
	 ...
	 */
	<D extends DataObject> IndexDtListFunctionBuilder<D> createIndexDtListFunctionBuilder();
	 ...
	 */
	<R extends DataObject> FacetedQueryResult<R, DtList<R>> facetList(final DtList<R> dtList, final FacetedQuery facetedQuery, final Optional<FacetDefinition> clusterFacetDefinition);
}

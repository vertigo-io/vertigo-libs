 ...
 */
package io.vertigo.datafactory.impl.task.proxy;
...
public final class TaskAmplifierMethod implements AmplifierMethod {
	...
	@Override
	public Class<io.vertigo.datafactory.task.proxy.TaskProxyAnnotation> getAnnotationType() {
		return io.vertigo.datafactory.task.proxy.TaskProxyAnnotation.class;
	}
	...
	private static TaskDefinition createTaskDefinition(final Method method) {
		final io.vertigo.datafactory.task.proxy.TaskProxyAnnotation taskAnnotation = method.getAnnotation(io.vertigo.datafactory.task.proxy.TaskProxyAnnotation.class);

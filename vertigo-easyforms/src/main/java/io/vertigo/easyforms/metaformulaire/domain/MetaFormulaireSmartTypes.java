...
public enum MetaFormulaireSmartTypes {
	...
	@Constraint(
			...
			msg = "Le numéro de téléphone n'est pas valide. Utilisez un numéro français à 10 chiffres, ou indiquez un numéro au format international avec le préfixe du pays (exemple: +33 pour la France)")

...
public final class SelectorDefinition implements Entity {
	...
	private io.vertigo.dynamo.domain.model.DtList<io.vertigo.rules.domain.RuleFilterDefinition> ruleFilterDefinition;
	...
	public io.vertigo.dynamo.domain.model.DtList<io.vertigo.rules.domain.RuleFilterDefinition> getRuleFilterDefinitionList() {
		...
		if (io.vertigo.dynamo.domain.util.DtObjectUtil.getId(this) == null) {
			return new io.vertigo.dynamo.domain.model.DtList<>(io.vertigo.rules.domain.RuleFilterDefinition.class);
		}

 ...
 */
package io.vertigo.quarto.export;
...
import io.vertigo.quarto.export.data.DtDefinitions.ContinentFields;
import io.vertigo.quarto.export.data.DtDefinitions.CountryFields;
import io.vertigo.quarto.export.data.domain.Continent;
import io.vertigo.quarto.export.data.domain.Country;
...
public final class ExportManagerTest extends AbstractTestCaseJU4 {
	...
	public void testExportFieldOverrideLabel() {
		...
		final Export export = new ExportBuilder(ExportFormat.CSV, OUTPUT_PATH + "test3.csv")
				.beginSheet(china, "china")
				.addField(CountryFields.NAME, new MessageText("test", null))
				.endSheet()
				.build();
	...
	public void testExportFieldDenormOverrideLabel() {
		...
		final Export export = new ExportBuilder(ExportFormat.CSV, OUTPUT_PATH + "test5.csv")
				...
				.addField(CountryFields.ID, dtc, CountryFields.NAME, new MessageText("test", null))
				.endSheet()
				.build();

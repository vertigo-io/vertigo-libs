...
public final class MisEnCause implements DtObject {
	...
	private io.vertigo.dynamo.domain.model.DtList<io.vertigo.quarto.publisher.data.domain.Address> adressesConnues;
	 ...
	 */
	public final io.vertigo.dynamo.domain.model.DtList<io.vertigo.quarto.publisher.data.domain.Address> getAdressesConnues() {
	 ...
	 */
	public final void setAdressesConnues(final io.vertigo.dynamo.domain.model.DtList<io.vertigo.quarto.publisher.data.domain.Address> adressesConnues) {

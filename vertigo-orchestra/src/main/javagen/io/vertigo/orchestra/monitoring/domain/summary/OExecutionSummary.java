...
public final class OExecutionSummary implements DtObject {
	 ...
	 */
	@Field(domain = "STyOLibelle", cardinality = io.vertigo.core.lang.Cardinality.ONE, label = "Nom du processus")
	 ...
	 */
	@Field(domain = "STyOLibelle", cardinality = io.vertigo.core.lang.Cardinality.ONE, label = "Libellé du processus")
	 ...
	 */
	@Field(domain = "STyOTimestamp", label = "Dernière exécution le")
	 ...
	 */
	@Field(domain = "STyOTimestamp", label = "Prochaine exécution le")
	 ...
	 */
	@Field(domain = "STyONombre", label = "Nombre en erreur")
	 ...
	 */
	@Field(domain = "STyONombre", label = "Nombre non executés")
	 ...
	 */
	@Field(domain = "STyONombre", label = "Nombre en succès")
	 ...
	 */
	@Field(domain = "STyONombre", label = "Nombre en cours")
	 ...
	 */
	@Field(domain = "STyONombre", label = "Durée moyenne d'exécution")
	 ...
	 */
	@Field(domain = "STyOCodeIdentifiant", cardinality = io.vertigo.core.lang.Cardinality.ONE, label = "Santé du processus")

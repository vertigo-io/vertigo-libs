...
public final class OActivityExecution implements Entity {
	 ...
	 */
	@io.vertigo.dynamo.domain.stereotype.ForeignKey(domain = "STyOIdentifiant", label = "Activity", fkDefinition = "DtOActivity" )
	 ...
	 */
	@io.vertigo.dynamo.domain.stereotype.ForeignKey(domain = "STyOIdentifiant", label = "Processus", fkDefinition = "DtOProcessExecution" )

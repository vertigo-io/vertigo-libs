...
public final class TriggerTypeDAO extends DAO<TriggerType, java.lang.String> implements StoreServices {
	 ...
	 */
	@Inject
	public TriggerTypeDAO(final EntityStoreManager entityStoreManager, final TaskManager taskManager, final ModelManager modelManager) {
		super(TriggerType.class, entityStoreManager, taskManager, modelManager);
	}

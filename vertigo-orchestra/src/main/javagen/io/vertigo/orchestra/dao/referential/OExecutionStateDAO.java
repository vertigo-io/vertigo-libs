...
public final class OExecutionStateDAO extends DAO<OExecutionState, java.lang.String> implements StoreServices {
	 ...
	 */
	@Inject
	public OExecutionStateDAO(final EntityStoreManager entityStoreManager, final TaskManager taskManager) {
		super(OExecutionState.class, entityStoreManager, taskManager);
	}

 ...
 *
 * Simply use vu:utext instead of th:utext to enable the behaviour
 *
 * @author mlaroche, npi2loup
 *
 */
public class VuiUTextTagProcessor extends AbstractAttributeTagProcessor {

	public static final int PRECEDENCE = 1400;
	public static final String ATTR_NAME = "utext";

	public VuiUTextTagProcessor(final String dialectPrefix) {
		super(TemplateMode.HTML, // only HTML supported
				dialectPrefix, null, false, ATTR_NAME, true, PRECEDENCE, true);
	}
	...
	protected void doProcess(
		 ...
		 */
		final TemplateModel parsedFragment = configuration.getTemplateManager().parseString(

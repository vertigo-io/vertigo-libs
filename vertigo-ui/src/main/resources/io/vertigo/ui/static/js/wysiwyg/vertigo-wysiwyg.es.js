...
function ae(e, t, n) {
	for (let r = 0;; r++) {
		...
		if (i.content.size || a.content.size) {
			let e = ae(i.content, a.content, n + 1);
			if (e != null) return e;
		}
		n += i.nodeSize;
	}
...
function oe(e, t, n, r) {
	for (let i = e.childCount, a = t.childCount;;) {
		...
		if (o.content.size || s.content.size) {
			let e = oe(o.content, s.content, n - 1, r - 1);
			if (e) return e;
		}
		n -= c, r -= c;
	}
...
function ce(e, t) {
	return se.index = e, se.offset = t, se;
}
function le(e, t) {
	if (e === t) return !0;
...
T.none = [];
var ue = class extends Error {}, E = class e {
	constructor(e, t, n) {
	...
	insertAt(t, n) {
		let r = fe(this.content, t + this.openStart, n);
...
function be(e, t, n, r, i) {
	...
	return ve(null, e, i, s), a && o && t.index(i) == n.index(i) ? (he(a, o), _e(ye(a, be(e, t, n, r, i + 1)), s)) : (a && _e(ye(a, xe(e, t, i + 1)), s), ve(t, n, i, s), o && _e(ye(o, xe(n, r, i + 1)), s)), ve(r, null, i, s), new w(s);
}
function xe(e, t, n) {
	let r = [];
	return ve(null, e, n, r), e.depth > n && _e(ye(ge(e, t, n + 1), xe(e, t, n + 1)), r), ve(t, null, n, r), new w(r);
}
function Se(e, t) {
...
var Ce = class e {
	...
	hasMarkup(e, t, n) {
		return this.type == e && le(this.attrs, t || e.defaultAttrs || Oe) && T.sameSet(this.marks, n || T.none);
	}
	copy(t = null) {
...
var Xe = class e {
	...
	create(e = null, t, n) {
		...
		return new ke(this, this.computeAttrs(e), w.from(t), T.setFrom(n));
	}
	createChecked(e = null, t, n) {
		return t = w.from(t), this.checkContent(t), new ke(this, this.computeAttrs(e), t, T.setFrom(n));
	}
	createAndFill(e = null, t, n) {
		...
		return i ? new ke(this, e, t.append(i), T.setFrom(n)) : null;
	}
	validContent(e) {
...
var Qe = class {
	...
	create(e = null) {
		return !e && this.instance ? this.instance : new T(this, qe(this.attrs, e));
	}
	static compile(t, n) {
	...
	constructor(e) {
		...
		t.nodes = C.from(e.nodes), t.marks = C.from(e.marks || {}), this.nodes = Xe.compile(this.spec.nodes, this), this.marks = $e.compile(this.spec.marks, this);
		let n = Object.create(null);
		...
		this.nodeFromJSON = (e) => ke.fromJSON(this, e), this.markFromJSON = (e) => T.fromJSON(this, e), this.topNodeType = this.nodes[this.spec.topNode || "doc"], this.cached.wrappings = Object.create(null);
	}
	node(e, t = null, n, r) {
	...
	text(e, t) {
		...
		return new Ae(n, n.defaultAttrs, e, T.setFrom(t));
	}
	mark(e, t) {
...
var ft = class {
	constructor(e, t, n, r, i, a) {
		this.type = e, this.attrs = t, this.marks = n, this.solid = r, this.options = a, this.content = [], this.activeMarks = T.none, this.match = i || (a & ut ? null : e.contentMatch);
	}
	findWrapping(e) {
		if (!this.match) {
			if (!this.type) return [];
	...
	constructor(e, t, n) {
		...
		i = r ? new ft(r.type, r.attrs, T.none, !0, t.topMatch || r.type.contentMatch, a) : n ? new ft(null, null, T.none, !0, null, a) : new ft(e.schema.topNodeType, null, T.none, !0, null, a), this.nodes = [i], this.find = t.findPositions, this.needsBlock = !1;
	}
	get top() {
...
var zt = class e extends D {
	constructor(e, t, n) {
		super(), this.from = e, this.to = t, this.mark = n;
	}
	apply(e) {
		let t = e.slice(this.from, this.to), n = e.resolve(this.from), r = n.node(n.sharedDepth(this.to)), i = new E(Rt(t.content, (e, t) => !e.isAtom || !t.type.allowsMarkType(this.mark.type) ? e : e.mark(this.mark.addToSet(e.marks)), r), t.openStart, t.openEnd);
...
D.jsonID("addMark", zt);
var Bt = class e extends D {
	constructor(e, t, n) {
		super(), this.from = e, this.to = t, this.mark = n;
	}
	apply(e) {
		let t = e.slice(this.from, this.to), n = new E(Rt(t.content, (e) => e.mark(this.mark.removeFromSet(e.marks)), e), t.openStart, t.openEnd);
...
D.jsonID("removeMark", Bt);
var Vt = class e extends D {
	constructor(e, t) {
...
D.jsonID("addNodeMark", Vt);
var Ht = class e extends D {
	constructor(e, t) {
		super(), this.pos = e, this.mark = t;
	}
	apply(e) {
...
D.jsonID("removeNodeMark", Ht);
var Ut = class e extends D {
	constructor(e, t, n, r = !1) {
		super(), this.from = e, this.to = t, this.slice = n, this.structure = r;
	}
	apply(e) {
		return this.structure && Gt(e, this.from, this.to) ? O.fail("Structure replace would overwrite content") : O.fromReplace(e, this.from, this.to, this.slice);
	}
	getMap() {
		return new Ft([
			this.from,
...
var Wt = class e extends D {
	...
	apply(e) {
		if (this.structure && (Gt(e, this.from, this.gapFrom) || Gt(e, this.gapTo, this.to))) return O.fail("Structure gap-replace would overwrite content");
...
function Jt(e, t, n, r = n.contentMatch, i = !0) {
	...
	for (let t = 0; t < a.childCount; t++) {
		...
		if (!u) o.push(new Ut(s, l, E.empty));
		else {
			r = u;
			for (let t = 0; t < c.marks.length; t++) n.allowsMarkType(c.marks[t].type) || e.step(new Bt(s, l, c.marks[t]));
			if (i && c.isText && n.whitespace != "pre") {
				let e, t = /\r?\n|\r/g, r;
				for (; e = t.exec(c.text);) r ||= new E(w.from(n.schema.text(" ", n.allowedMarks(c.marks))), 0, 0), o.push(new Ut(s + e.index, s + e.index + e[0].length, r));
			}
		}
		s = l;
	}
...
function Xt(e) {
	...
	for (let n = e.depth;; --n) {
		...
		if (n == 0 || r.type.spec.isolating || !Yt(r, i, a)) break;
	}
	return null;
}
function Zt(e, t, n) {
	...
	e.step(new Wt(c, l, o, s, new E(u.append(f), d, p), u.size - d, !0));
}
function Qt(e, t, n = null, r = e) {
	let i = en(e, t), a = i && tn(r, t);
	return a ? i.map($t).concat({
		type: t,
		attrs: n
	}).concat(a.map($t)) : null;
}
...
function nn(e, t, n) {
	...
	e.step(new Wt(i, a, i, a, new E(r, 0, 0), n.length, !0));
}
function rn(e, t, n, r, i) {
	...
	e.doc.nodesBetween(t, n, (t, n) => {
		...
		if (t.isTextblock && !t.hasMarkup(r, o) && sn(e.doc, e.mapping.slice(a).map(n), r)) {
			let i = null;
			if (r.schema.linebreakReplacement) {
				let e = r.whitespace == "pre", t = !!r.contentMatch.matchType(r.schema.linebreakReplacement);
				e && !t ? i = !1 : !e && t && (i = !0);
			}
			i === !1 && on(e, t, n, a), Jt(e, e.mapping.slice(a).map(n, 1), r, void 0, i === null);
			let s = e.mapping.slice(a), c = s.map(n, 1), l = s.map(n + t.nodeSize, 1);
			return e.step(new Wt(c, l, c + 1, l - 1, new E(w.from(r.create(o, null, t.marks)), 0, 0), 1, !0)), i === !0 && an(e, t, n, a), !1;
		}
	});
}
function an(e, t, n, r) {
...
function cn(e, t, n, r, i) {
	...
	e.step(new Wt(t, t + a.nodeSize, t + 1, t + a.nodeSize - 1, new E(w.from(o), 0, 0), 1, !0));
}
...
function un(e, t, n = 1, r) {
	...
	e.step(new Ut(t, t, new E(a.append(o), n, n), !0));
}
function dn(e, t) {
	let n = e.resolve(t), r = n.index();
	return pn(n.nodeBefore, n.nodeAfter) && n.parent.canReplace(r, r + 1);
}
function fn(e, t) {
...
function pn(e, t) {
	return !!(e && t && !e.isLeaf && fn(e, t));
}
function mn(e, t, n = -1) {
	let r = e.resolve(t);
	for (let e = r.depth;; e--) {
		let i, a, o = r.index(e);
		if (e == r.depth ? (i = r.nodeBefore, a = r.nodeAfter) : n > 0 ? (i = r.node(e + 1), o++, a = r.node(e).maybeChild(o)) : (i = r.node(e).maybeChild(o - 1), a = r.node(e + 1)), i && !i.isTextblock && pn(i, a) && r.node(e).canReplace(o, o + 1)) return t;
		if (e == 0) break;
...
function vn(e, t, n = t, r = E.empty) {
	if (t == n && !r.size) return null;
	let i = e.resolve(t), a = e.resolve(n);
	return yn(i, a, r) ? new Ut(t, n, r) : new bn(i, a, r).fit();
}
function yn(e, t, n) {
...
var bn = class {
	...
	fit() {
		...
		let s = new E(i, a, o);
		return e > -1 ? new Wt(n.pos, e, this.$to.pos, this.$to.end(), s, t) : s.size || n.pos != this.$to.pos ? new Ut(n.pos, r.pos, s) : null;
	}
	findFittable() {
	...
	dropNode() {
		...
		if (r.childCount <= 1 && t > 0) {
			...
			this.unplaced = new E(xn(e, t - 1, 1), t - 1, i ? t - 1 : n);
		} else this.unplaced = new E(xn(e, t, 1), t, n);
	}
	placeNodes({ sliceDepth: e, frontierDepth: t, parent: n, inject: r, wrap: i }) {
		...
		p || (f = -1), this.placed = Sn(this.placed, t, w.from(l)), this.frontier[t].match = u, p && f < 0 && n && n.type == this.frontier[this.depth].type && this.frontier.length > 1 && this.closeFrontierNode();
		...
		this.unplaced = p ? e == 0 ? E.empty : new E(xn(a.content, e - 1, 1), e - 1, f < 0 ? a.openEnd : e - 1) : new E(xn(a.content, e, c), a.openStart, a.openEnd);
	}
	mustMoveInline() {
	...
	openFrontierNode(e, t = null, n) {
		...
		r.match = r.match.matchType(e), this.placed = Sn(this.placed, this.depth, w.from(e.create(t, n))), this.frontier.push({
			type: e,
...
function wn(e, t, n) {
	if (t <= 0) return e;
	let r = e.content;
	return t > 1 && (r = r.replaceChild(0, wn(r.firstChild, t - 1, r.childCount == 1 ? n - 1 : 0))), t > 0 && (r = e.type.contentMatch.fillBefore(r).append(r), n <= 0 && (r = r.append(e.type.contentMatch.matchFragment(r).fillBefore(w.empty, !0)))), e.copy(r);
}
...
function On(e, t, n, r) {
	...
	if (yn(i, a, r)) return e.step(new Ut(t, n, r));
	let o = Mn(i, e.doc.resolve(n));
	...
	for (let t = r.openStart; t >= 0; t--) {
		...
		if (d) for (let t = 0; t < o.length; t++) {
			...
			if (f.canReplaceWith(p, p, d.type, d.marks)) return e.replace(i.before(l), u ? a.after(l) : n, new E(kn(r.content, 0, r.openStart, s), s, r.openEnd));
		}
	}
...
function jn(e, t, n) {
	let r = e.doc.resolve(t), i = e.doc.resolve(n), a = Mn(r, i);
...
var In = class {
	...
	removeNodeMark(e, t) {
		...
		if (t instanceof T) t.isInSet(n.marks) && this.step(new Ht(e, t));
		else {
			let r = n.marks, i, a = [];
	...
	replace(e, t = E.empty) {
		...
		for (let o = 0; o < a.length; o++) {
			...
			e.replaceRange(l.map(s.pos), l.map(c.pos), o ? E.empty : t), o == 0 && Kn(e, i, (n ? n.isInline : r && r.isTextblock) ? -1 : 1);
		}
	}
	replaceWith(e, t) {
	...
	static findFrom(e, t, n = !1) {
		let r = e.parent.inlineContent ? new A(e) : Gn(e.node(0), e.parent, e.pos, e.index(), t, n);
		if (r) return r;
...
function Kn(e, t, n) {
	...
	if (r < t) return;
	let i = e.steps[r];
	if (!(i instanceof Ut || i instanceof Wt)) return;
...
function ir(e) {
	return e in rr ? e + "$" + ++rr[e] : (rr[e] = 0, e + "$");
}
var N = class {
	constructor(e = "key") {
		this.key = ir(e);
...
}, ar = (e, t) => !e.selection.empty && (t && t(e.tr.deleteSelection().scrollIntoView()), !0);
function or(e, t) {
...
var sr = (e, t, n) => {
	...
	let i = pr(r);
	if (!i) {
		let n = r.blockRange(), i = n && Xt(n);
		return i != null && (t && t(e.tr.lift(n, i).scrollIntoView()), !0);
	}
	let a = i.nodeBefore;
	if (jr(e, i, t, -1)) return !0;
	if (r.parent.content.size == 0 && (dr(a, "end") || j.isSelectable(a))) for (let n = r.depth;; n--) {
		let o = vn(e.doc, r.before(n), r.after(n), E.empty);
		if (o && o.slice.size < o.to - o.from) {
			if (t) {
				let n = e.tr.step(o);
				n.setSelection(dr(a, "end") ? k.findFrom(n.doc.resolve(n.mapping.map(i.pos, -1)), -1) : j.create(n.doc, i.pos - a.nodeSize)), t(n.scrollIntoView());
			}
			return !0;
		}
...
function ur(e, t, n) {
	...
	let s = vn(e.doc, i, o, E.empty);
	if (!s || s.from != i || s instanceof Ut && s.slice.size >= o - i) return !1;
	if (n) {
		let t = e.tr.step(s);
...
var hr = (e, t, n) => {
	...
	let a = i.nodeAfter;
	if (jr(e, i, t, 1)) return !0;
	if (r.parent.content.size == 0 && (dr(a, "start") || j.isSelectable(a))) {
		let n = vn(e.doc, r.before(), r.after(), E.empty);
		if (n && n.slice.size < n.to - n.from) {
			if (t) {
				let r = e.tr.step(n);
				r.setSelection(dr(a, "start") ? k.findFrom(r.doc.resolve(r.mapping.map(i.pos)), 1) : j.create(r.doc, r.mapping.map(i.pos))), t(r.scrollIntoView());
			}
			return !0;
		}
	}
...
var vr = (e, t) => {
	...
	if (r) {
		if (n.node.isTextblock || !dn(e.doc, n.from)) return !1;
		i = n.from;
	} else if (i = mn(e.doc, n.from, -1), i == null) return !1;
	if (t) {
		let n = e.tr.join(i);
	...
	let n = e.selection, r;
	if (n instanceof j) {
		if (n.node.isTextblock || !dn(e.doc, n.to)) return !1;
		r = n.to;
	} else if (r = mn(e.doc, n.to, 1), r == null) return !1;
	return t && t(e.tr.join(r).scrollIntoView()), !0;
}, br = (e, t) => {
	let { $from: n, $to: r } = e.selection, i = n.blockRange(r), a = i && Xt(i);
...
var Cr = (e, t) => {
	...
	let i = n.node(-1), a = n.indexAfter(-1), o = Sr(i.contentMatchAt(a));
	...
	if (n.depth > 1 && n.after() != n.end(-1)) {
		let r = n.before();
		if (ln(e.doc, r)) return t && t(e.tr.split(r).scrollIntoView()), !0;
	}
	let r = n.blockRange(), i = r && Xt(r);
	return i != null && (t && t(e.tr.lift(r, i).scrollIntoView()), !0);
};
function Er(e) {
	return (t, n) => {
		let { $from: r, $to: i } = t.selection;
		if (t.selection instanceof j && t.selection.node.isBlock) return !r.parentOffset || !ln(t.doc, r.pos) ? !1 : (n && n(t.tr.split(r.pos).scrollIntoView()), !0);
		if (!r.depth) return !1;
		let a = [], o, s, c = !1, l = !1;
		for (let t = r.depth;; t--) if (r.node(t).isBlock) {
			c = r.end(t) == r.pos + (r.depth - t), l = r.start(t) == r.pos - (r.depth - t), s = Sr(r.node(t - 1).contentMatchAt(r.indexAfter(t - 1)));
		...
		let u = t.tr;
		(t.selection instanceof A || t.selection instanceof Un) && u.deleteSelection();
		let d = u.mapping.map(r.pos), f = ln(u.doc, d, a.length, a);
		if (f ||= (a[0] = s ? { type: s } : null, ln(u.doc, d, a.length, a)), !f) return !1;
...
var Dr = Er(), Or = (e, t) => {
	...
	return a != 0 && (i = n.before(a), t && t(e.tr.setSelection(j.create(e.doc, i))), !0);
}, kr = (e, t) => (t && t(e.tr.setSelection(new Un(e.doc))), !0);
function Ar(e, t, n) {
	let r = t.nodeBefore, i = t.nodeAfter, a = t.index();
	return !r || !i || !r.type.compatibleContent(i.type) ? !1 : !r.content.size && t.parent.canReplace(a - 1, a) ? (n && n(e.tr.delete(t.pos - r.nodeSize, t.pos).scrollIntoView()), !0) : !t.parent.canReplace(a, a + 1) || !(i.isTextblock || dn(e.doc, t.pos)) ? !1 : (n && n(e.tr.join(t.pos).scrollIntoView()), !0);
}
function jr(e, t, n, r) {
	let i = t.nodeBefore, a = t.nodeAfter, o, s, c = i.type.spec.isolating || a.type.spec.isolating;
	if (!c && Ar(e, t, n)) return !0;
	...
	if (l && (o = (s = i.contentMatchAt(i.childCount)).findWrapping(a.type)) && s.matchType(o[0] || a.type).validEnd) {
		if (n) {
			...
			s = w.from(i.copy(s));
			let c = e.tr.step(new Wt(t.pos - 1, r, t.pos, r, new E(s, 1, 0), o.length, !0)), l = c.doc.resolve(r + 2 * o.length);
			l.nodeAfter && l.nodeAfter.type == i.type && dn(c.doc, l.pos) && c.join(l.pos), n(c.scrollIntoView());
		}
		return !0;
	}
	let u = a.type.spec.isolating || r > 0 && c ? null : k.findFrom(t, 1), d = u && u.$from.blockRange(u.$to), f = d && Xt(d);
	if (f != null && f >= t.depth) return n && n(e.tr.lift(d, f).scrollIntoView()), !0;
	if (l && dr(a, "start", !0) && dr(i, "end")) {
		let r = i, o = [];
		...
		if (r.canReplace(r.childCount, r.childCount, s.content)) {
			if (n) {
				...
				n(e.tr.step(new Wt(t.pos - o.length, t.pos + a.nodeSize, t.pos + c, t.pos + a.nodeSize - c, new E(r, o.length, 0), 0, !0)).scrollIntoView());
			}
			return !0;
		}
	}
...
var Rr = Lr(ar, sr, fr), zr = Lr(ar, hr, gr), Br = {
	Enter: Lr(xr, wr, Tr, Dr),
	"Mod-Enter": Cr,
	Backspace: Rr,
	"Mod-Backspace": Rr,
	"Shift-Backspace": Rr,
...
function Hr(e, t = null) {
	return function(n, r) {
		...
		if (!o) return !1;
		let s = r ? n.tr : null;
		return Ur(s, o, e, t) ? (r && r(s.scrollIntoView()), !0) : !1;
	};
}
...
function Wr(e, t, n, r, i) {
	...
	e.step(new Wt(t.start - (r ? 2 : 0), t.end, t.start, t.end, new E(a, 0, 0), n.length, !0));
	let o = 0;
	for (let e = 0; e < n.length; e++) n[e].type == i && (o = e + 1);
	let s = n.length - o, c = t.start + n.length - (r ? 2 : 0), l = t.parent;
	for (let n = t.startIndex, r = t.endIndex, i = !0; n < r; n++, i = !1) !i && ln(e.doc, c, s) && (e.split(c, s), c += 2 * s), c += l.child(n).nodeSize;
	return e;
}
function Gr(e) {
	return function(t, n) {
		let { $from: r, $to: i } = t.selection, a = r.blockRange(i, (t) => t.childCount > 0 && t.firstChild.type == e);
		return a ? n ? r.node(a.depth - 1).type == e ? Kr(t, n, e, a) : qr(t, n, a) : !0 : !1;
	};
}
function Kr(e, t, n, r) {
	let i = e.tr, a = r.end, o = r.$to.end(r.depth);
	a < o && (i.step(new Wt(a - 1, o, a, o, new E(w.from(n.create(null, r.parent.copy())), 1, 0), 1, !0)), r = new De(i.doc.resolve(r.$from.pos), i.doc.resolve(o), r.depth));
	let s = Xt(r);
	if (s == null) return !1;
	i.lift(r, s);
	let c = i.doc.resolve(i.mapping.map(a, -1) - 1);
	return dn(i.doc, c.pos) && c.nodeBefore.type == c.nodeAfter.type && i.join(c.pos), t(i.scrollIntoView()), !0;
}
function qr(e, t, n) {
	...
	return r.step(new Wt(d - +!!s, f + +!!c, d + 1, f - 1, new E((s ? w.empty : w.from(i.copy(w.empty))).append(c ? w.empty : w.from(i.copy(w.empty))), +!s, +!c), +!s)), t(r.scrollIntoView()), !0;
}
function Jr(e) {
	return function(t, n) {
		let { $from: r, $to: i } = t.selection, a = r.blockRange(i, (t) => t.childCount > 0 && t.firstChild.type == e);
		...
		if (n) {
			...
			n(t.tr.step(new Wt(l - (r ? 3 : 1), u, l, u, o, 1, !0)).scrollIntoView());
		}
		return !0;
	};
}
...
}, Xr = null, Zr = function(e, t, n) {
	let r = Xr ||= document.createRange();
	return r.setEnd(e, n ?? e.nodeValue.length), r.setStart(e, t || 0), r;
}, Qr = function() {
	Xr = null;
}, $r = function(e, t, n, r) {
	return n && (ti(e, t, n, r, -1) || ti(e, t, n, r, 1));
...
function ti(e, t, n, r, i) {
	for (;;) {
		...
		if (t == (i < 0 ? 0 : ni(e))) {
			let n = e.parentNode;
			if (!n || n.nodeType != 1 || oi(e) || ei.test(e.nodeName) || e.contentEditable == "false") return !1;
			t = P(e) + (i < 0 ? 0 : 1), e = n;
...
function ri(e, t) {
	for (;;) {
		...
		if (e.nodeType == 1 && t > 0) {
			...
			e = e.childNodes[t - 1], t = ni(e);
		} else if (e.parentNode && !oi(e)) t = P(e), e = e.parentNode;
		else return null;
	}
}
function ii(e, t) {
	for (;;) {
		...
		} else if (e.parentNode && !oi(e)) t = P(e) + 1, e = e.parentNode;
		else return null;
	}
}
function ai(e, t, n) {
	for (let r = t == 0, i = t == ni(e); r || i;) {
		if (e == n) return !0;
		let t = P(e);
...
var si = function(e) {
	return e.focusNode && $r(e.focusNode, e.focusOffset, e.anchorNode, e.anchorOffset);
};
function ci(e, t) {
...
var di = typeof navigator < "u" ? navigator : null, fi = typeof document < "u" ? document : null, pi = di && di.userAgent || "", mi = /Edge\/(\d+)/.exec(pi), hi = /MSIE \d/.exec(pi), gi = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(pi), _i = !!(hi || gi || mi), vi = hi ? document.documentMode : gi ? +gi[1] : mi ? +mi[1] : 0, yi = !_i && /gecko\/(\d+)/i.test(pi);
yi && +(/Firefox\/(\d+)/.exec(pi) || [0, 0])[1];
var bi = !_i && /Chrome\/(\d+)/.exec(pi), F = !!bi, xi = bi ? +bi[1] : 0, I = !_i && !!di && /Apple Computer/.test(di.vendor), Si = I && (/Mobile\/\w+/.test(pi) || !!di && di.maxTouchPoints > 2), Ci = Si || (di ? /Mac/.test(di.platform) : !1), wi = di ? /Win/.test(di.platform) : !1, Ti = /Android \d/.test(pi), Ei = !!fi && "webkitFontSmoothing" in fi.documentElement.style, Di = Ei ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function Oi(e) {
...
function ji(e, t, n) {
	...
	for (let o = n || e.dom; o;) {
		...
		let e = o, n = e == a.body, s = n ? Oi(a) : Ai(e), c = 0, l = 0;
		if (t.top < s.top + ki(r, "top") ? l = -(s.top - t.top + ki(i, "top")) : t.bottom > s.bottom - ki(r, "bottom") && (l = t.bottom - t.top > s.bottom - s.top ? t.top + ki(i, "top") - s.top : t.bottom - s.bottom + ki(i, "bottom")), t.left < s.left + ki(r, "left") ? c = -(s.left - t.left + ki(i, "left")) : t.right > s.right - ki(r, "right") && (c = t.right - s.right + ki(i, "right")), c || l) {
...
function Ri(e, t) {
	...
	for (let u = e.firstChild, d = 0; u; u = u.nextSibling, d++) {
		...
		else if (u.nodeType == 3) e = Zr(u).getClientRects();
		else continue;
	...
	return !n && c && (n = c, i = l, r = 0), n && n.nodeType == 3 ? zi(n, i) : !n || r && n.nodeType == 1 ? {
		node: e,
		offset: a
	} : Ri(n, i);
}
function zi(e, t) {
	...
	for (let i = 0; i < n; i++) {
		...
		let n = qi(r, 1);
		if (n.top != n.bottom && Bi(t, n)) return {
			node: e,
...
function Hi(e, t, n) {
	let { node: r, offset: i } = Ri(t, n), a = -1;
...
function Gi(e, t) {
	let n = e.dom.ownerDocument, r, i = 0, a = ui(n, t.left, t.top);
	a && ({node: r, offset: i} = a);
	...
	if (!o || !e.dom.contains(o.nodeType == 1 ? o : o.parentNode)) {
		...
		if (!Bi(t, n) || (o = Wi(e.dom, t, n), !o)) return null;
	}
	if (I) for (let e = o; r && e; e = Yr(e)) e.draggable && (r = void 0);
	if (o = Vi(o, t), r) {
		if (yi && r.nodeType == 1 && (i = Math.min(i, r.childNodes.length), i < r.childNodes.length)) {
			let e = r.childNodes[i], n;
			e.nodeName == "IMG" && (n = e.getBoundingClientRect()).right <= t.left && n.bottom > t.top && i++;
		}
		let n;
		Ei && i && r.nodeType == 1 && (n = r.childNodes[i - 1]).nodeType == 1 && n.contentEditable == "false" && n.getBoundingClientRect().top >= t.top && i--, r == e.dom && i == r.childNodes.length - 1 && r.lastChild.nodeType == 1 && t.top > r.lastChild.getBoundingClientRect().bottom ? s = e.state.doc.content.size : (i == 0 || r.nodeType != 1 || r.childNodes[i - 1].nodeName != "BR") && (s = Ui(e, r, i, t));
	}
	s ??= Hi(e, o, t);
...
var Ji = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
function Yi(e, t, n) {
	let { node: r, offset: i, atom: a } = e.docView.domFromPos(t, n < 0 ? -1 : 1), o = Ei || yi;
	if (r.nodeType == 3) {
		if (o && (Ji.test(r.nodeValue) || (n < 0 ? !i : i == r.nodeValue.length))) {
			let e = qi(Zr(r, i, i), n);
			if (yi && i && /\s/.test(r.nodeValue[i - 1]) && i < r.nodeValue.length) {
				let t = qi(Zr(r, i - 1, i - 1), -1);
				if (t.top == e.top) {
					let n = qi(Zr(r, i, i + 1), -1);
					if (n.top != e.top) return Xi(n, n.left < t.left);
				}
			}
			return e;
		}
		{
			...
			return n < 0 && !i ? (t++, a = -1) : n >= 0 && i == r.nodeValue.length ? (e--, a = 1) : n < 0 ? e-- : t++, Xi(qi(Zr(r, e, t), a), a < 0);
		}
	}
	if (!e.state.doc.resolve(t - (a || 0)).parent.inlineContent) {
		if (a == null && i && (n < 0 || i == ni(r))) {
	...
	if (a == null && i && (n < 0 || i == ni(r))) {
		let e = r.childNodes[i - 1], t = e.nodeType == 3 ? Zr(e, ni(e) - +!o) : e.nodeType == 1 && (e.nodeName != "BR" || !e.nextSibling) ? e : null;
		if (t) return Xi(qi(t, 1), !1);
	}
	if (a == null && i < ni(r)) {
		let e = r.childNodes[i];
		for (; e.pmViewDesc && e.pmViewDesc.ignoreForCoords;) e = e.nextSibling;
		let t = e ? e.nodeType == 3 ? Zr(e, 0, +!o) : e.nodeType == 1 ? e : null : null;
		if (t) return Xi(qi(t, -1), !0);
	}
	return Xi(qi(r.nodeType == 3 ? Zr(r) : r, -n), n >= 0);
}
function Xi(e, t) {
...
function $i(e, t, n) {
	...
	return Qi(e, t, () => {
		...
		for (let e = t.firstChild; e; e = e.nextSibling) {
			...
			else if (e.nodeType == 3) t = Zr(e, 0, e.nodeValue.length).getClientRects();
			else continue;
			for (let e = 0; e < t.length; e++) {
				let i = t[e];
...
function ta(e, t, n) {
	...
	return s ? !ea.test(r.parent.textContent) || !s.modify ? n == "left" || n == "backward" ? a : o : Qi(e, t, () => {
...
var na = null, ra = null, ia = !1;
function aa(e, t, n) {
	return na == t && ra == n ? ia : (na = t, ra = n, ia = n == "up" || n == "down" ? $i(e, t, n) : ta(e, t, n));
}
var oa = 0, sa = 1, ca = 2, la = 3, ua = class {
	constructor(e, t, n, r) {
		this.parent = e, this.children = t, this.dom = n, this.contentDOM = r, this.dirty = oa, n.pmViewDesc = this;
	}
	matchesWidget(e) {
		return !1;
	}
	...
	domFromPos(e, t) {
		...
		for (let e; n && !(e = this.children[n - 1]).size && e instanceof da && e.side >= 0; n--);
		if (t <= 0) {
			let e, r = !0;
	...
	setSelection(e, t, n, r = !1) {
		...
		if (yi && l.focusNode && l.focusNode != s.node && l.focusNode.nodeType == 1) {
			let e = l.focusNode.childNodes[l.focusOffset];
			e && e.contentEditable == "false" && (r = !0);
		}
		if (!(r || u && I) && $r(o.node, o.offset, l.anchorNode, l.anchorOffset) && $r(s.node, s.offset, l.focusNode, l.focusOffset)) return;
		let d = !1;
		if ((c.extend || e == t) && !(u && yi)) {
	...
	markDirty(e, t) {
		for (let n = 0, r = 0; r < this.children.length; r++) {
			...
			if (n == a ? e <= a && t >= n : e < a && t > n) {
				...
				if (e >= r && t <= o) {
					this.dirty = e == n || t == a ? ca : sa, e == r && t == o && (i.contentLost || i.dom.parentNode != this.contentDOM) ? i.dirty = la : i.markDirty(e - r, t - r);
					return;
				}
				i.dirty = i.dom == i.contentDOM && i.dom.parentNode == this.contentDOM && !i.children.length ? ca : la;
			}
			n = a;
		}
		this.dirty = ca;
	...
	matchesWidget(e) {
		return this.dirty == oa && e.type.eq(this.widget.type);
	}
	parseRule() {
		return { ignore: !0 };
	}
	...
	parseRule() {
		return this.dirty & la || this.mark.type.spec.reparseInView ? null : {
	...
	matchesMark(e) {
		return this.dirty != la && this.mark.eq(e);
	}
	markDirty(e, t) {
		if (super.markDirty(e, t), this.dirty != oa) {
			let e = this.parent;
			for (; !e.node;) e = e.parent;
			e.dirty < this.dirty && (e.dirty = this.dirty), this.dirty = oa;
		}
	}
	slice(t, n, r) {
	...
	static create(t, n, r, i, a, o) {
		...
		let f = u;
		return u = Ta(u, r, n), l ? c = new va(t, n, r, i, u, d || null, f, l, a, o + 1) : n.isText ? new ga(t, n, r, i, u, f, a) : new e(t, n, r, i, u, d || null, f, a, o + 1);
	}
	parseRule() {
	...
	matchesNode(e, t, n) {
		return this.dirty == oa && e.eq(this.node) && Ea(t, this.outerDeco) && n.eq(this.innerDeco);
	}
	get size() {
	...
	updateChildren(e, t) {
		...
		ja(this.node, this.innerDeco, (t, i, a) => {
			t.spec.marks ? s.syncToMarks(t.spec.marks, n, e) : t.type.side >= 0 && !a && s.syncToMarks(i == this.node.childCount ? T.none : this.node.child(i).marks, n, e), s.placeWidget(t, e, r);
		}, (t, a, c, l) => {
		...
		}), s.syncToMarks([], n, e), this.node.isTextblock && s.addTextblockHacks(), s.destroyRest(), (s.changed || this.dirty == ca) && (a && this.protectLocalComposition(e, a), ya(this.contentDOM, this.children, e), Si && Ma(this.dom));
	}
	...
	protectLocalComposition(e, { node: t, pos: n, text: r }) {
		...
		let a = new fa(this, i, t, r);
		e.input.compositionNodes.push(a), this.children = Pa(this.children, n, n + r.length, e, a);
	}
	update(e, t, n, r) {
		return this.dirty == la || !e.sameMarkup(this.node) ? !1 : (this.updateInner(e, t, n, r), !0);
	}
	updateInner(e, t, n, r) {
		this.updateOuterDeco(t), this.node = e, this.innerDeco = n, this.contentDOM && this.updateChildren(r, this.posAtStart), this.dirty = oa;
	}
	updateOuterDeco(e) {
		if (Ea(e, this.outerDeco)) return;
		let t = this.nodeDOM.nodeType != 1, n = this.dom;
		this.dom = Ca(this.dom, this.nodeDOM, Sa(this.outerDeco, this.node, t), Sa(e, this.node, t)), this.dom != n && (n.pmViewDesc = void 0, this.dom.pmViewDesc = this), this.outerDeco = e;
	}
	selectNode() {
...
function ha(e, t, n, r, i) {
	Ta(r, t, e);
	let a = new ma(void 0, e, t, n, r, r, r, i, 0);
	return a.contentDOM && a.updateChildren(i, 0), a;
}
var ga = class e extends ma {
	...
	update(e, t, n, r) {
		return this.dirty == la || this.dirty != oa && !this.inParent() || !e.sameMarkup(this.node) ? !1 : (this.updateOuterDeco(t), (this.dirty != oa || e.text != this.node.text) && e.text != this.nodeDOM.nodeValue && (this.nodeDOM.nodeValue = e.text, r.trackWrites == this.nodeDOM && (r.trackWrites = null)), this.node = e, this.dirty = oa, !0);
	}
	inParent() {
	...
	markDirty(e, t) {
		super.markDirty(e, t), this.dom != this.nodeDOM && (e == 0 || t == this.nodeDOM.nodeValue.length) && (this.dirty = la);
	}
	get domAtom() {
		return !1;
	}
	...
	matchesHack(e) {
		return this.dirty == oa && this.dom.nodeName == e;
	}
	get domAtom() {
		return !0;
	}
...
function ya(e, t, n) {
	...
	for (let a = 0; a < t.length; a++) {
		...
		if (o instanceof pa) {
			...
			ya(o.contentDOM, o.children, n), r = t ? t.nextSibling : e.firstChild;
		}
	}
	for (; r;) r = Da(r), i = !0;
...
ba.prototype = Object.create(null);
var xa = [new ba()];
function Sa(e, t, n) {
	if (e.length == 0) return xa;
	let r = n ? xa[0] : new ba(), i = [r];
	for (let a = 0; a < e.length; a++) {
		let o = e[a].type.attrs;
		if (o) {
			o.nodeName && i.push(r = new ba(o.nodeName));
			for (let e in o) {
				let a = o[e];
				a != null && (n && i.length == 1 && i.push(r = new ba(t.isInline ? "span" : "div")), e == "class" ? r.class = (r.class ? r.class + " " : "") + a : e == "style" ? r.style = (r.style ? r.style + ";" : "") + a : e != "nodeName" && (r[e] = a));
			}
		}
	}
	return i;
...
function Ca(e, t, n, r) {
	if (n == xa && r == xa) return t;
	let i = t;
	for (let t = 0; t < r.length; t++) {
		let a = r[t], o = n[t];
		if (t) {
			let t;
			o && o.nodeName == a.nodeName && i != e && (t = i.parentNode) && t.nodeName.toLowerCase() == a.nodeName ? i = t : (t = document.createElement(a.nodeName), t.pmIsDeco = !0, t.appendChild(i), o = xa[0], i = t);
		}
		wa(i, o || xa[0], a);
	}
	return i;
...
function Ta(e, t, n) {
	return Ca(e, e, xa, Sa(t, n, e.nodeType != 1));
}
function Ea(e, t) {
	if (e.length != t.length) return !1;
...
var Oa = class {
	constructor(e, t, n) {
		this.lock = t, this.view = n, this.index = 0, this.stack = [], this.changed = !1, this.top = e, this.preMatch = ka(e.node.content, e);
	}
	destroyBetween(e, t) {
		if (e != t) {
	...
	syncToMarks(e, t, n) {
		...
		for (; r < i;) this.destroyRest(), this.top.dirty = oa, this.index = this.stack.pop(), this.top = this.stack.pop(), i--;
		for (; i < e.length;) {
			...
			if (r > -1) r > this.index && (this.changed = !0, this.destroyBetween(this.index, r)), this.top = this.top.children[this.index];
				...
				let r = pa.create(this.top, e[i], t, n);
	...
	updateNodeAt(e, t, n, r, i) {
		let a = this.top.children[r];
		return a.dirty == la && a.dom == a.contentDOM && (a.dirty = ca), a.update(e, t, n, i) ? (this.destroyBetween(this.index, r), this.index++, !0) : !1;
	}
	...
	updateNextNode(e, t, n, r, i, a) {
		for (let o = this.index; o < this.top.children.length; o++) {
			...
			if (s instanceof ma) {
				...
				let l = s.dom, u, d = this.isLocked(l) && !(e.isText && s.node && s.node.isText && s.nodeDOM.nodeValue == e.text && s.dirty != la && Ea(t, s.outerDeco));
				if (!d && s.update(e, t, n, r)) return this.destroyBetween(this.index, o), s.dom != l && (this.changed = !0), this.index++, !0;
				if (!d && (u = this.recreateWrapper(s, e, t, n, r, a))) return this.destroyBetween(this.index, o), this.top.children[this.index] = u, u.contentDOM && (u.dirty = ca, u.updateChildren(r, a + 1), u.dirty = oa), this.changed = !0, this.index++, !0;
				break;
			}
		}
		return !1;
	...
	recreateWrapper(e, t, n, r, i, a) {
		if (e.dirty || t.isAtom || !e.children.length || !e.node.content.eq(t.content) || !Ea(n, e.outerDeco) || !r.eq(e.innerDeco)) return null;
		let o = ma.create(this.top, t, n, r, i, a);
		if (o.contentDOM) {
	...
	addNode(e, t, n, r, i) {
		let a = ma.create(this.top, e, t, n, r, i);
	...
	placeWidget(e, t, n) {
		...
		if (r && r.matchesWidget(e) && (e == r.widget || !r.widget.type.toDOM.parentNode)) this.index++;
			...
			let r = new da(this.top, e, t, n);
			this.top.children.splice(this.index++, 0, r), this.changed = !0;
		}
	}
	addTextblockHacks() {
		let e = this.top.children[this.index - 1], t = this.top;
		for (; e instanceof pa;) t = e, e = t.children[t.children.length - 1];
...
function ka(e, t) {
	...
	outer: for (; i > 0;) {
		...
		for (;;) if (r) {
			...
			if (e instanceof pa) n = e, r = e.children.length;
			else {
				s = e, r--;
				break;
			}
...
function Fa(e, t = null) {
	...
	if (si(n)) {
		...
		let e = i.node;
		if (i && e.isAtom && j.isSelectable(e) && i.parent && !(e.isInline && ai(n.focusNode, n.focusOffset, i.dom))) {
			let e = i.posBefore;
...
function La(e, t = !1) {
	...
	if (Wa(e, n), Ia(e)) {
		if (!t && e.input.mouseDown && e.input.mouseDown.allowDefault && F) {
			...
			if (t.anchorNode && n.anchorNode && $r(t.anchorNode, t.anchorOffset, n.anchorNode, n.anchorOffset)) {
		...
		if (e.domObserver.disconnectSelection(), e.cursorWrapper) Ua(e);
			...
			Ra && !(n instanceof A) && (n.$from.parent.inlineContent || (a = za(e, n.from)), !n.empty && !n.$from.parent.inlineContent && (o = za(e, n.to))), e.docView.setSelection(r, i, e, t), Ra && (a && Va(a), o && Va(o)), n.visible ? e.dom.classList.remove("ProseMirror-hideselection") : (e.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && Ha(e));
		}
...
function za(e, t) {
	...
	if (I && i && i.contentEditable == "false") return Ba(i);
...
function Ua(e) {
	...
	r ? t.collapse(n.parentNode, P(n) + 1) : t.collapse(n, 0), !r && !e.state.selection.visible && _i && vi <= 11 && (n.disabled = !0, n.disabled = !1);
}
function Wa(e, t) {
	if (t instanceof j) {
		let n = e.docView.descAt(t.from);
		n != e.lastSelectedViewDesc && (Ga(e), n && n.selectNode(), e.lastSelectedViewDesc = n);
	} else Ga(e);
}
function Ga(e) {
...
function Qa(e, t, n) {
	...
	if (r instanceof A) {
		if (n.indexOf("s") > -1) {
			...
			return Za(e, new A(r.$anchor, a));
		}
		if (!r.empty) return !1;
		if (e.endOfTextblock(t > 0 ? "forward" : "backward")) {
			let n = Xa(e.state, t);
			return n && n instanceof j ? Za(e, n) : !1;
		}
		if (!(Ci && n.indexOf("m") > -1)) {
			let n = r.$head, i = n.textOffset ? null : t < 0 ? n.nodeBefore : n.nodeAfter, a;
			if (!i || i.isText) return !1;
			let o = t < 0 ? n.pos - i.nodeSize : n.pos;
			return i.isAtom || (a = e.docView.descAt(o)) && !a.contentDOM ? j.isSelectable(i) ? Za(e, new j(t < 0 ? e.state.doc.resolve(n.pos - i.nodeSize) : n)) : Ei ? Za(e, new A(e.state.doc.resolve(t < 0 ? o : o + i.nodeSize))) : !1 : !1;
		}
	} else if (r instanceof j && r.node.isInline) return Za(e, new A(t > 0 ? r.$to : r.$from));
	else {
		let n = Xa(e.state, t);
		return n ? Za(e, n) : !1;
	}
...
function to(e, t) {
	return t < 0 ? no(e) : ro(e);
}
function no(e) {
	let t = e.domSelectionRange(), n = t.focusNode, r = t.focusOffset;
	if (!n) return;
	let i, a, o = !1;
	for (yi && n.nodeType == 1 && r < $a(n) && eo(n.childNodes[r], -1) && (o = !0);;) if (r > 0) {
		...
		for (; t && eo(t, -1);) i = n.parentNode, a = P(t), t = t.previousSibling;
		if (t) n = t, r = $a(n);
		else {
...
function ro(e) {
	...
	for (;;) if (r < i) {
		...
		let t = n.nextSibling;
		for (; t && eo(t, 1);) a = t.parentNode, o = P(t) + 1, t = t.nextSibling;
		if (t) n = t, r = 0, i = $a(n);
		else {
			if (n = n.parentNode, n == e.dom) break;
			r = i = 0;
...
function ao(e, t) {
	for (; e && t == e.childNodes.length && !oi(e);) t = P(e) + 1, e = e.parentNode;
...
function oo(e, t) {
	for (; e && !t && !oi(e);) t = P(e), e = e.parentNode;
	for (; e && t;) {
		let n = e.childNodes[t - 1];
		if (n.nodeType == 3) return n;
		if (n.nodeType == 1 && n.contentEditable == "false") break;
...
function so(e, t, n) {
	if (t.nodeType != 3) {
		let e, r;
		(r = ao(t, n)) ? (t = r, n = 0) : (e = oo(t, n)) && (t = e, n = e.nodeValue.length);
	}
...
function co(e, t) {
	...
	if (!(F || wi) && n.parent.inlineContent) {
...
function lo(e, t, n) {
	let r = e.state.selection;
	if (r instanceof A && !r.empty || n.indexOf("s") > -1 || Ci && n.indexOf("m") > -1) return !1;
	let { $from: i, $to: a } = r;
	if (!i.parent.inlineContent || e.endOfTextblock(t < 0 ? "up" : "down")) {
		let n = Xa(e.state, t);
		if (n && n instanceof j) return Za(e, n);
	}
	if (!i.parent.inlineContent) {
		let n = t < 0 ? i : a, o = r instanceof Un ? k.near(n, t) : k.findFrom(n, t);
		return o ? Za(e, o) : !1;
	}
	return !1;
}
...
function po(e) {
	...
	if (t && t.nodeType == 1 && n == 0 && t.firstChild && t.firstChild.contentEditable == "false") {
		let n = t.firstChild;
		fo(e, n, "true"), setTimeout(() => fo(e, n, "false"), 20);
	}
	return !1;
}
function mo(e) {
...
function ho(e, t) {
	let n = t.keyCode, r = mo(t);
	if (n == 8 || Ci && n == 72 && r == "c") return uo(e, -1) || to(e, -1);
	if (n == 46 && !t.shiftKey || Ci && n == 68 && r == "c") return uo(e, 1) || to(e, 1);
	if (n == 13 || n == 27) return !0;
	if (n == 37 || Ci && n == 66 && r == "c") {
		let t = n == 37 ? co(e, e.state.selection.from) == "ltr" ? -1 : 1 : -1;
		return Qa(e, t, r) || to(e, t);
	}
	if (n == 39 || Ci && n == 70 && r == "c") {
		let t = n == 39 ? co(e, e.state.selection.from) == "ltr" ? 1 : -1 : 1;
		return Qa(e, t, r) || to(e, t);
	}
	return n == 38 || Ci && n == 80 && r == "c" ? lo(e, -1, r) || to(e, -1) : n == 40 || Ci && n == 78 && r == "c" ? po(e) || lo(e, 1, r) || to(e, 1) : !(r != (Ci ? "m" : "c") || n != 66 && n != 73 && n != 89 && n != 90);
}
function go(e, t) {
	...
	let o = e.someProp("clipboardSerializer") || vt.fromSchema(e.state.schema), s = Do(), c = s.createElement("div");
	c.appendChild(o.serializeFragment(r, { document: s }));
	let l = c.firstChild, u, d = 0;
	for (; l && l.nodeType == 1 && (u = To[l.nodeName.toLowerCase()]);) {
...
function _o(e, t, n, r, i) {
	...
	if (s ||= (e.someProp("clipboardParser") || e.someProp("domParser") || it.fromSchema(e.state.schema)).parseSlice(o, {
		...
		context: i,
		ruleFromNode(e) {
			return e.nodeName == "BR" && !e.nextSibling && e.parentNode && !vo.test(e.parentNode.nodeName) ? { ignore: !0 } : null;
		}
	}), u) s = Mo(wo(s, +u[1], +u[2]), u[4]);
	else if (s = E.maxOpen(yo(s.content, i), !0), s.openStart || s.openEnd) {
		let e = 0, t = 0;
...
var vo = /^(a|abbr|acronym|b|cite|code|del|em|i|ins|kbd|label|output|q|ruby|s|samp|span|strong|sub|sup|time|u|tt|var)$/i;
function yo(e, t) {
	...
	for (let n = t.depth; n >= 0; n--) {
		...
		if (e.forEach((e) => {
			...
			if (!t) return a = null;
			if (n = a.length && i.length && xo(t, i, e, a[a.length - 1], 0)) a[a.length - 1] = n;
			else {
...
function xo(e, t, n, r, i) {
	if (i < e.length && i < t.length && e[i] == t[i]) {
		let a = xo(e, t, n, r.lastChild, i + 1);
		if (a) return r.copy(r.content.replaceChild(r.childCount - 1, a));
		if (r.contentMatchAt(r.childCount).matchType(i == e.length - 1 ? n.type : e[i + 1])) return r.copy(r.content.append(w.from(bo(n, e, i + 1))));
	}
}
function So(e, t) {
	if (t == 0) return e;
	let n = e.content.replaceChild(e.childCount - 1, So(e.lastChild, t - 1)), r = e.contentMatchAt(e.childCount).fillBefore(w.empty, !0);
	return e.copy(n.append(r));
}
function Co(e, t, n, r, i, a) {
	let o = t < 0 ? e.firstChild : e.lastChild, s = o.content;
	return e.childCount > 1 && (a = 0), i < r - 1 && (s = Co(s, t, n, r, i + 1, a)), i >= n && (s = t < 0 ? o.contentMatchAt(0).fillBefore(s, a <= i).append(s) : s.append(o.contentMatchAt(o.childCount).fillBefore(w.empty, !0))), e.replaceChild(t < 0 ? 0 : e.childCount - 1, o.copy(s));
}
function wo(e, t, n) {
	return t < e.openStart && (e = new E(Co(e.content, -1, t, e.openStart, 0, e.openEnd), t, e.openEnd)), n < e.openEnd && (e = new E(Co(e.content, 1, n, e.openEnd, 0, 0), e.openStart, n)), e;
}
var To = {
	thead: ["table"],
	tbody: ["table"],
...
function Do() {
	return Eo ||= document.implementation.createHTMLDocument("title");
}
var Oo = null;
function ko(e) {
...
function Ao(e) {
	...
	let n = Do().createElement("div"), r = /<([a-z][^>\s]+)/i.exec(e), i;
	if ((i = r && To[r[1].toLowerCase()]) && (e = i.map((e) => "<" + e + ">").join("") + e + i.map((e) => "</" + e + ">").reverse().join("")), n.innerHTML = ko(e), i) for (let e = 0; e < i.length; e++) n = n.querySelector(i[e]) || n;
	return n;
}
function jo(e) {
...
function Fo(e) {
	for (let t in L) {
		...
		e.dom.addEventListener(t, e.input.eventHandlers[t] = (t) => {
			Bo(e, t) && !zo(e, t) && (e.editable || !(t.type in R)) && n(e, t);
		}, No[t] ? { passive: !0 } : void 0);
	}
	I && e.dom.addEventListener("input", () => null), Ro(e);
}
function Io(e, t) {
...
function Ro(e) {
	e.someProp("handleDOMEvents", (t) => {
		for (let n in t) e.input.eventHandlers[n] || e.dom.addEventListener(n, e.input.eventHandlers[n] = (t) => zo(e, t));
	});
}
function zo(e, t) {
...
function Vo(e, t) {
	!zo(e, t) && L[t.type] && (e.editable || !(t.type in R)) && L[t.type](e, t);
}
R.keydown = (e, t) => {
	let n = t;
	if (e.input.shiftKey = n.keyCode == 16 || n.shiftKey, !ts(e, n) && (e.input.lastKeyCode = n.keyCode, e.input.lastKeyCodeTime = Date.now(), !(Ti && F && n.keyCode == 13))) {
		if (n.keyCode != 229 && e.domObserver.forceFlush(), Si && n.keyCode == 13 && !n.ctrlKey && !n.altKey && !n.metaKey) {
			let t = Date.now();
			e.input.lastIOSEnter = t, e.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
				e.input.lastIOSEnter == t && (e.someProp("handleKeyDown", (t) => t(e, ci(13, "Enter"))), e.input.lastIOSEnter = 0);
			}, 200);
		} else e.someProp("handleKeyDown", (t) => t(e, n)) || ho(e, n) ? n.preventDefault() : Io(e, "key");
	}
}, R.keyup = (e, t) => {
	t.keyCode == 16 && (e.input.shiftKey = !1);
}, R.keypress = (e, t) => {
	let n = t;
	if (ts(e, n) || !n.charCode || n.ctrlKey && !n.altKey || Ci && n.metaKey) return;
...
function Ko(e, t) {
	...
	return r && r.isAtom && j.isSelectable(r) ? (Go(e, new j(n), "pointer"), !0) : !1;
}
function qo(e, t) {
	if (t == -1) return !1;
	...
	return i != null && (Go(e, j.create(e.state.doc, i), "pointer"), !0);
}
function Jo(e, t, n, r, i) {
	return Wo(e, "handleClickOn", t, n, r) || e.someProp("handleClick", (n) => n(e, t, r)) || (i ? qo(e, n) : Ko(e, n));
}
function Yo(e, t, n, r) {
	return Wo(e, "handleDoubleClickOn", t, n, r) || e.someProp("handleDoubleClick", (n) => n(e, t, r));
}
function Xo(e, t, n, r) {
	return Wo(e, "handleTripleClickOn", t, n, r) || e.someProp("handleTripleClick", (n) => n(e, t, r)) || Zo(e, n, r);
}
function Zo(e, t, n) {
	if (n.button != 0) return !1;
	let r = e.state.doc;
	if (t == -1) return r.inlineContent ? (Go(e, A.create(r, 0, r.content.size), "pointer"), !0) : !1;
	let i = r.resolve(t);
	for (let t = i.depth + 1; t > 0; t--) {
		let n = t > i.depth ? i.nodeAfter : i.node(t), a = i.before(t);
		if (n.inlineContent) Go(e, A.create(r, a + 1, a + 1 + n.content.size), "pointer");
		else if (j.isSelectable(n)) Go(e, j.create(r, a), "pointer");
		else continue;
		return !0;
	}
}
...
var $o = Ci ? "metaKey" : "ctrlKey";
L.mousedown = (e, t) => {
	let n = t;
	e.input.shiftKey = n.shiftKey;
	let r = Qo(e), i = Date.now(), a = "singleClick";
	i - e.input.lastClick.time < 500 && Uo(n, e.input.lastClick) && !n[$o] && e.input.lastClick.button == n.button && (e.input.lastClick.type == "singleClick" ? a = "doubleClick" : e.input.lastClick.type == "doubleClick" && (a = "tripleClick")), e.input.lastClick = {
		time: i,
		x: n.clientX,
		y: n.clientY,
		type: a,
	...
	let o = e.posAtCoords(Ho(n));
	o && (a == "singleClick" ? (e.input.mouseDown && e.input.mouseDown.done(), e.input.mouseDown = new es(e, o, n, !!r)) : (a == "doubleClick" ? Yo : Xo)(e, o.pos, o.inside, n) ? n.preventDefault() : Io(e, "pointer"));
};
var es = class {
	constructor(e, t, n, r) {
		this.view = e, this.pos = t, this.event = n, this.flushed = r, this.delayedSelectionSync = !1, this.mightDrag = null, this.startDoc = e.state.doc, this.selectNode = !!n[$o], this.allowDefault = n.shiftKey;
		let i, a;
		...
		(n.button == 0 && i.type.spec.draggable && i.type.spec.selectable !== !1 || c instanceof j && c.from <= a && c.to > a) && (this.mightDrag = {
			...
			setUneditable: !!(this.target && yi && !this.target.hasAttribute("contentEditable"))
		...
		this.view.root.removeEventListener("mouseup", this.up), this.view.root.removeEventListener("mousemove", this.move), this.mightDrag && this.target && (this.view.domObserver.stop(), this.mightDrag.addAttr && this.target.removeAttribute("draggable"), this.mightDrag.setUneditable && this.target.removeAttribute("contentEditable"), this.view.domObserver.start()), this.delayedSelectionSync && setTimeout(() => La(this.view)), this.view.input.mouseDown = null;
	}
	up(e) {
		if (this.done(), !this.view.dom.contains(e.target)) return;
		let t = this.pos;
		this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(Ho(e))), this.updateAllowDefault(e), this.allowDefault || !t ? Io(this.view, "pointer") : Jo(this.view, t.pos, t.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || I && this.mightDrag && !this.mightDrag.node.isAtom || F && !this.view.state.selection.visible && Math.min(Math.abs(t.pos - this.view.state.selection.from), Math.abs(t.pos - this.view.state.selection.to)) <= 2) ? (Go(this.view, k.near(this.view.state.doc.resolve(t.pos)), "pointer"), e.preventDefault()) : Io(this.view, "pointer");
	}
	move(e) {
...
L.touchstart = (e) => {
	e.input.lastTouch = Date.now(), Qo(e), Io(e, "pointer");
}, L.touchmove = (e) => {
	e.input.lastTouch = Date.now(), Io(e, "pointer");
}, L.contextmenu = (e) => Qo(e);
function ts(e, t) {
...
R.compositionstart = R.compositionupdate = (e) => {
	if (!e.composing) {
		...
		if (t.selection instanceof A && (t.storedMarks || !n.textOffset && n.parentOffset && n.nodeBefore.marks.some((e) => e.type.spec.inclusive === !1))) e.markCursor = e.state.storedMarks || n.marks(), cs(e, !0), e.markCursor = null;
		else if (cs(e, !t.selection.empty), yi && t.selection.empty && n.parentOffset && !n.textOffset && n.nodeBefore.marks.length) {
			let t = e.domSelectionRange();
	...
	e.composing && (e.input.composing = !1, e.input.compositionEndedAt = t.timeStamp, e.input.compositionPendingChanges = e.domObserver.pendingRecords().length ? e.input.compositionID : 0, e.input.compositionNode = null, e.input.compositionPendingChanges && Promise.resolve().then(() => e.domObserver.flush()), e.input.compositionID++, rs(e, 20));
};
function rs(e, t) {
	clearTimeout(e.input.composingTimeout), t > -1 && (e.input.composingTimeout = setTimeout(() => cs(e), t));
}
function is(e) {
	for (e.composing && (e.input.composing = !1, e.input.compositionEndedAt = ss()); e.input.compositionNodes.length > 0;) e.input.compositionNodes.pop().markParentsDirty();
}
function as(e) {
	let t = e.domSelectionRange();
	if (!t.focusNode) return null;
	let n = ri(t.focusNode, t.focusOffset), r = ii(t.focusNode, t.focusOffset);
	if (n && r && n != r) {
...
function cs(e, t = !1) {
	if (!(Ti && e.domObserver.flushingSoon >= 0)) {
		if (e.domObserver.forceFlush(), is(e), t || e.docView && e.docView.dirty) {
			let n = Fa(e), r = e.state.selection;
...
var us = _i && vi < 15 || Si && Di < 604;
L.copy = R.cut = (e, t) => {
	let n = t, r = e.state.selection, i = n.type == "cut";
	if (r.empty) return;
	let a = us ? null : n.clipboardData, { dom: o, text: s } = go(e, r.content());
	a ? (n.preventDefault(), a.clearData(), a.setData("text/html", o.innerHTML), a.setData("text/plain", s)) : ls(e, o), i && e.dispatch(e.state.tr.deleteSelection().scrollIntoView().setMeta("uiEvent", "cut"));
};
function ds(e) {
...
function fs(e, t) {
	...
	setTimeout(() => {
		e.focus(), r.parentNode && r.parentNode.removeChild(r), n ? ps(e, r.value, null, i, t) : ps(e, r.textContent, r.innerHTML, i, t);
	}, 50);
}
function ps(e, t, n, r, i) {
	let a = _o(e, t, n, r, e.state.selection.$from);
	if (e.someProp("handlePaste", (t) => t(e, i, a || E.empty))) return !0;
	if (!a) return !1;
	let o = ds(a), s = o ? e.state.tr.replaceSelectionWith(o, r) : e.state.tr.replaceSelection(a);
...
R.paste = (e, t) => {
	let n = t;
	if (e.composing && !Ti) return;
	let r = us ? null : n.clipboardData, i = e.input.shiftKey && e.input.lastKeyCode != 45;
	r && ps(e, ms(r), r.getData("text/html"), i, n) ? n.preventDefault() : fs(e, n);
};
var hs = class {
	constructor(e, t, n) {
		this.slice = e, this.move = t, this.node = n;
	}
}, gs = Ci ? "altKey" : "ctrlKey";
function _s(e, t) {
	return e.someProp("dragCopies", (e) => !e(t)) ?? !t[gs];
}
L.dragstart = (e, t) => {
	let n = t, r = e.input.mouseDown;
	if (r && r.done(), !n.dataTransfer) return;
	let i = e.state.selection, a = i.empty ? null : e.posAtCoords(Ho(n)), o;
	...
	let { dom: s, text: c, slice: l } = go(e, (o || e.state.selection).content());
	(!n.dataTransfer.files.length || !F || xi > 120) && n.dataTransfer.clearData(), n.dataTransfer.setData(us ? "Text" : "text/html", s.innerHTML), n.dataTransfer.effectAllowed = "copyMove", us || n.dataTransfer.setData("text/plain", c), e.dragging = new hs(l, _s(e, n), o);
}, L.dragend = (e) => {
	let t = e.dragging;
	window.setTimeout(() => {
	...
	let i = e.posAtCoords(Ho(n));
	if (!i) return;
	let a = e.state.doc.resolve(i.pos), o = r && r.slice;
	o ? e.someProp("transformPasted", (t) => {
		o = t(o, e, !1);
	}) : o = _o(e, ms(n.dataTransfer), us ? null : n.dataTransfer.getData("text/html"), !1, a);
	let s = !!(r && _s(e, n));
	if (e.someProp("handleDrop", (t) => t(e, n, o || E.empty, s))) {
		n.preventDefault();
		return;
	}
	if (!o) return;
	n.preventDefault();
	let c = o ? _n(e.state.doc, a.pos, o) : a.pos;
	c ??= a.pos;
	let l = e.state.tr;
	if (s) {
		let { node: e } = r;
	...
	let u = l.mapping.map(c), d = o.openStart == 0 && o.openEnd == 0 && o.content.childCount == 1, f = l.doc;
	if (d ? l.replaceRangeWith(u, u, o.content.firstChild) : l.replaceRange(u, u, o), l.doc.eq(f)) return;
	let p = l.doc.resolve(u);
	if (d && j.isSelectable(o.content.firstChild) && p.nodeAfter && p.nodeAfter.sameMarkup(o.content.firstChild)) l.setSelection(new j(p));
	else {
		let t = l.mapping.map(c);
		l.mapping.maps[l.mapping.maps.length - 1].forEach((e, n, r, i) => t = i), l.setSelection(Ka(e, p, l.doc.resolve(t)));
	}
	...
	e.input.lastFocus = Date.now(), e.focused || (e.domObserver.stop(), e.dom.classList.add("ProseMirror-focused"), e.domObserver.start(), e.focused = !0, setTimeout(() => {
		e.docView && e.hasFocus() && !e.domObserver.currentSelection.eq(e.domSelectionRange()) && La(e);
	}, 20));
}, L.blur = (e, t) => {
	let n = t;
	...
	if (F && Ti && t.inputType == "deleteContentBackward") {
		e.domObserver.flushSoon();
		let { domChangeCount: t } = e.input;
		setTimeout(() => {
			if (e.input.domChangeCount != t || (e.dom.blur(), e.focus(), e.someProp("handleKeyDown", (t) => t(e, ci(8, "Backspace"))))) return;
...
var ys = class e {
	...
	map(e, t, n) {
		return this == B || e.maps.length == 0 ? this : this.mapInner(e, t, 0, 0, n || ws);
	}
	mapInner(t, n, r, i, a) {
		let o;
		...
		return this.children.length ? Es(this.children, o || [], t, n, r, i, a) : o ? new e(o.sort(Ms), Cs) : B;
	}
	add(t, n) {
	...
	addInner(t, n, r) {
		...
		t.forEach((e, t) => {
			...
			if (s = ks(n, e, o)) {
				...
				i[a] == t ? i[a + 2] = i[a + 2].addInner(e, s, o + 1) : i.splice(a, 0, t, t + e.nodeSize, js(s, e, o + 1, ws)), a += 3;
			}
		});
		let o = Ds(a ? As(n) : n, -r);
	...
	forChild(t, n) {
		...
		if (i) {
			let t = new e(i.sort(Ms), Cs);
			return r ? new Ts([t, r]) : t;
		}
		return r || B;
	}
	eq(t) {
...
z.empty = new z([], []), z.removeOverlap = Ns;
var B = z.empty, Ts = class e {
	constructor(e) {
		this.members = e;
	}
	map(t, n) {
...
function Es(e, t, n, r, i, a, o) {
	...
	if (c) {
		let c = js(Os(s, e, t, n, i, a, o), r, 0, o);
		t = c.local;
...
function js(e, t, n, r) {
	...
	t.forEach((t, o) => {
		...
		if (s) {
			a = !0;
			let e = js(s, t, n + o + 1, r);
			e != B && i.push(o, o + t.nodeSize, e);
		}
	});
	let o = Ds(a ? As(e) : e, -n).sort(Ms);
...
function Ns(e) {
	...
	for (let n = 0; n < t.length - 1; n++) {
		...
		if (r.from != r.to) for (let i = n + 1; i < t.length; i++) {
			let a = t[i];
			if (a.from == r.from) {
				a.to != r.to && (t == e && (t = e.slice()), t[i] = a.copy(a.from, r.to), Ps(t, i + 1, a.copy(r.to, a.to)));
				continue;
			}
			a.from < r.to && (t == e && (t = e.slice()), t[n] = r.copy(r.from, a.from), Ps(t, i, r.copy(a.from, r.to)));
			break;
		}
	}
	return t;
...
function Fs(e) {
	...
	return e.someProp("decorations", (n) => {
		let r = n(e.state);
		r && r != B && t.push(r);
	}), e.cursorWrapper && t.push(z.create(e.state.doc, [e.cursorWrapper.deco])), Ts.from(t);
}
var Is = {
	childList: !0,
	characterData: !0,
	...
	constructor(e, t) {
		this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new Rs(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.lastChangedTextNode = null, this.observer = window.MutationObserver && new window.MutationObserver((e) => {
			for (let t = 0; t < e.length; t++) this.queue.push(e[t]);
			_i && vi <= 11 && e.some((e) => e.type == "childList" && e.removedNodes.length || e.type == "characterData" && e.oldValue.length > e.target.nodeValue.length) ? this.flushSoon() : this.flush();
		}), Ls && (this.onCharData = (e) => {
			this.queue.push({
				target: e.target,
				type: "characterData",
	...
	onSelectionChange() {
		if (qa(this.view)) {
			if (this.suppressingSelectionUpdates) return La(this.view);
			if (_i && vi <= 11 && !this.view.state.selection.empty) {
				let e = this.view.domSelectionRange();
				if (e.focusNode && $r(e.focusNode, e.focusOffset, e.anchorNode, e.anchorOffset)) return this.flushSoon();
			}
			this.flush();
		}
	}
	...
	flush() {
		...
		t.length && (this.queue = []);
		let n = e.domSelectionRange(), r = !this.suppressingSelectionUpdates && !this.currentSelection.eq(n) && qa(e) && !this.ignoreSelectionChange(n), i = -1, a = -1, o = !1, s = [];
		...
		let c = null;
		i < 0 && r && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && si(n) && (c = Fa(e)) && c.eq(k.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, La(e), this.currentSelection.set(n), e.scrollToSelection()) : (i > -1 || r) && (i > -1 && (e.docView.markDirty(i, a), Hs(e)), this.handleDOMChange(i, a, o, s), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(n) || La(e), this.currentSelection.set(n));
	}
	registerMutation(e, t) {
		...
		if (e.type == "childList") {
			...
			if (_i && vi <= 11 && e.addedNodes.length) for (let t = 0; t < e.addedNodes.length; t++) {
...
}, Bs = /* @__PURE__ */ new WeakMap(), Vs = !1;
function Hs(e) {
	if (!Bs.has(e) && (Bs.set(e, null), [
		"normal",
		"nowrap",
		"pre-line"
	].indexOf(getComputedStyle(e.dom).whiteSpace) !== -1)) {
		if (e.requiresGeckoHackNode = yi, Vs) return;
		console.warn("ProseMirror expects the CSS white-space property to be set, preferably to 'pre-wrap'. It is recommended to load style/prosemirror.css from the prosemirror-view package."), Vs = !0;
	}
}
function Us(e, t) {
	let n = t.startContainer, r = t.startOffset, i = t.endContainer, a = t.endOffset, o = e.domAtPos(e.state.selection.anchor);
	return $r(o.node, o.offset, i, a) && ([n, r, i, a] = [
		i,
		a,
		n,
		r
...
function Ks(e, t, n) {
	...
	let d = e.state.doc, f = e.someProp("domParser") || it.fromSchema(e.state.schema), p = d.resolve(o), m = null, h = f.parse(r, {
		topNode: p.parent,
...
function Ys(e, t, n, r, i) {
	...
	if (e.input.compositionPendingChanges = 0, t < 0) {
		let t = e.input.lastSelectionTime > Date.now() - 50 ? e.input.lastSelectionOrigin : null, n = Fa(e, t);
		if (n && !e.state.selection.eq(n)) {
			if (F && Ti && e.input.lastKeyCode === 13 && Date.now() - 100 < e.input.lastKeyCodeTime && e.someProp("handleKeyDown", (t) => t(e, ci(13, "Enter")))) return;
	...
	if (m && e.input.domChangeCount++, (Si && e.input.lastIOSEnter > Date.now() - 225 || Ti) && i.some((e) => e.nodeType == 1 && !Js.test(e.nodeName)) && (!m || m.endA >= m.endB) && e.someProp("handleKeyDown", (t) => t(e, ci(13, "Enter")))) {
		e.input.lastIOSEnter = 0;
		return;
	}
	if (!m) {
		if (r && c instanceof A && !c.empty && c.$head.sameParent(c.$anchor) && !e.composing && !(l.sel && l.sel.anchor != l.sel.head)) m = {
			start: c.from,
			endA: c.to,
			endB: c.to
		};
	...
	e.state.selection.from < e.state.selection.to && m.start == m.endB && e.state.selection instanceof A && (m.start > e.state.selection.from && m.start <= e.state.selection.from + 2 && e.state.selection.from >= l.from ? m.start = e.state.selection.from : m.endA < e.state.selection.to && m.endA >= e.state.selection.to - 2 && e.state.selection.to <= l.to && (m.endB += e.state.selection.to - m.endA, m.endA = e.state.selection.to)), _i && vi <= 11 && m.endB == m.start + 1 && m.endA == m.start && m.start > l.from && l.doc.textBetween(m.start - l.from - 1, m.start - l.from + 1) == " \xA0" && (m.start--, m.endA--, m.endB--);
	...
	if ((Si && e.input.lastIOSEnter > Date.now() - 225 && (!v || i.some((e) => e.nodeName == "DIV" || e.nodeName == "P")) || !v && h.pos < l.doc.content.size && (!h.sameParent(g) || !h.parent.inlineContent) && h.pos < g.pos && !/\S/.test(l.doc.textBetween(h.pos, g.pos, "", ""))) && e.someProp("handleKeyDown", (t) => t(e, ci(13, "Enter")))) {
		e.input.lastIOSEnter = 0;
		return;
	}
	if (e.state.selection.anchor > m.start && Qs(u, m.start, m.endA, h, g) && e.someProp("handleKeyDown", (t) => t(e, ci(8, "Backspace")))) {
		Ti && F && e.domObserver.suppressSelectionUpdates();
		return;
	}
	F && m.endB == m.start && (e.input.lastChromeDelete = Date.now()), Ti && !v && h.start() != g.start() && g.parentOffset == 0 && h.depth == g.depth && l.sel && l.sel.anchor == l.sel.head && l.sel.head == m.endA && (m.endB -= 2, g = l.doc.resolveNoCache(m.endB - l.from), setTimeout(() => {
		e.someProp("handleKeyDown", function(t) {
			return t(e, ci(13, "Enter"));
		});
	}, 20));
	let y = m.start, b = m.endA, x = (t) => {
		...
		if (l.sel) {
			...
			t && !(F && e.composing && t.empty && (m.start != m.endB || e.input.lastChromeDelete < Date.now() - 100) && (t.head == y || t.head == n.mapping.map(b) - 1) || _i && t.empty && t.head == y) && n.setSelection(t);
		}
		return a && n.setMeta("composition", a), n.scrollIntoView();
	}, ee;
	if (v) {
		if (h.pos == g.pos) {
			_i && vi <= 11 && h.parentOffset == 0 && (e.domObserver.suppressSelectionUpdates(), setTimeout(() => La(e), 20));
			let t = x(e.state.tr.delete(y, b)), n = u.resolve(m.start).marksAcross(u.resolve(m.endA));
			n && t.ensureMarks(n), e.dispatch(t);
		} else if (m.endA == m.endB && (ee = Zs(h.parent.content.cut(h.parentOffset, g.parentOffset), _.parent.content.cut(_.parentOffset, m.endA - _.start())))) {
			let t = x(e.state.tr);
...
function Qs(e, t, n, r, i) {
	...
	return !o.parent.isTextblock || o.pos > n || $s(o, !0, !1) < n ? !1 : r.parent.content.cut(r.parentOffset).eq(o.parent.content);
}
function $s(e, t, n) {
...
function ec(e, t, n, r, i) {
	...
	if (o < a && e.size < t.size) {
		let e = r <= a && r >= o ? a - r : 0;
		a -= e, a && a < t.size && tc(t.textBetween(a - 1, a + 1)) && (a += e ? 1 : -1), s = a + (s - o), o = a;
	} else if (s < a) {
		let t = r <= a && r >= s ? a - r : 0;
		a -= t, a && a < e.size && tc(e.textBetween(a - 1, a + 1)) && (a += t ? 1 : -1), o = a + (o - s), s = a;
	}
	return {
		start: a,
		endA: o,
...
var nc = class {
	constructor(e, t) {
		this._root = null, this.focused = !1, this.trackWrites = null, this.mounted = !1, this.markCursor = null, this.cursorWrapper = null, this.lastSelectedViewDesc = void 0, this.input = new Po(), this.prevDirectPlugins = [], this.pluginViews = [], this.requiresGeckoHackNode = !1, this.dragging = null, this._props = t, this.state = t.state, this.directPlugins = t.plugins || [], this.directPlugins.forEach(lc), this.dispatch = this.dispatch.bind(this), this.dom = e && e.mount || document.createElement("div"), e && (e.appendChild ? e.appendChild(this.dom) : typeof e == "function" ? e(this.dom) : e.mount && (this.mounted = !0)), this.editable = ac(this), ic(this), this.nodeViews = sc(this), this.docView = ha(this.state.doc, rc(this), Fs(this), this.dom, this), this.domObserver = new zs(this, (e, t, n, r) => Ys(this, e, t, n, r)), this.domObserver.start(), Fo(this), this.updatePluginViews();
	}
	get composing() {
	...
	update(e) {
		...
		let t = this._props;
		this._props = e, e.plugins && (e.plugins.forEach(lc), this.directPlugins = e.plugins), this.updateStateInner(e.state, t);
	}
	setProps(e) {
		let t = {};
	...
	updateStateInner(e, t) {
		...
		(a || t.handleDOMEvents != this._props.handleDOMEvents) && Ro(this), this.editable = ac(this), ic(this);
		let o = Fs(this), s = rc(this), c = n.plugins != e.plugins && !n.doc.eq(e.doc) ? "reset" : e.scrollToSelection > n.scrollToSelection ? "to selection" : "preserve", l = r || !this.docView.matchesNode(e.doc, s, o);
		(l || !e.selection.eq(n.selection)) && (i = !0);
		let u = c == "preserve" && i && this.dom.style.overflowAnchor == null && Mi(this);
		if (i) {
			this.domObserver.stop();
			let t = l && (_i || F) && !this.composing && !n.selection.empty && !e.selection.empty && oc(n.selection, e.selection);
			if (l) {
				let n = F ? this.trackWrites = this.domSelectionRange().focusNode : null;
				this.composing && (this.input.compositionNode = as(this)), (r || !this.docView.update(e.doc, s, o, this)) && (this.docView.updateOuterDeco(s), this.docView.destroy(), this.docView = ha(e.doc, s, o, this.dom, this)), n && !this.trackWrites && (t = !0);
			}
			t || !(this.input.mouseDown && this.domObserver.currentSelection.eq(this.domSelectionRange()) && Ya(this)) ? La(this, t) : (Wa(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
		}
	...
	scrollToSelection() {
		...
		if (!(!e || !this.dom.contains(e.nodeType == 1 ? e : e.parentNode)) && !this.someProp("handleScrollToSelection", (e) => e(this))) {
			if (this.state.selection instanceof j) {
				...
				t.nodeType == 1 && ji(this, t.getBoundingClientRect(), e);
			} else ji(this, this.coordsAtPos(this.state.selection.head, 1), e);
		}
	}
	destroyPluginViews() {
		let e;
	...
	updateDraggedNode(e, t) {
		...
		this.dragging = new hs(e.slice, e.move, r < 0 ? void 0 : j.create(this.state.doc, r));
	}
	someProp(e, t) {
	...
	focus() {
		this.domObserver.stop(), this.editable && Li(this.dom), La(this), this.domObserver.start();
	}
	get root() {
		let e = this._root;
		if (e == null) {
	...
	pasteHTML(e, t) {
		return ps(this, "", e, !1, t || new ClipboardEvent("paste"));
	}
	pasteText(e, t) {
		return ps(this, e, null, !0, t || new ClipboardEvent("paste"));
	}
	serializeForClipboard(e) {
		return go(this, e);
	}
	destroy() {
		this.docView && (Lo(this), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], Fs(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), this.docView.destroy(), this.docView = null, Qr());
	}
	get isDestroyed() {
	...
	domSelectionRange() {
		...
		return e ? I && this.root.nodeType === 11 && li(this.dom.ownerDocument) == this.dom && Ws(this, e) || e : {
			focusNode: null,
			focusOffset: 0,
			anchorNode: null,
			anchorOffset: 0
...
for (var uc = {
	...
	221: "}",
	222: "\""
}, fc = typeof navigator < "u" && /Mac/.test(navigator.platform), pc = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent), V = 0; V < 10; V++) uc[48 + V] = uc[96 + V] = String(V);
for (var V = 1; V <= 24; V++) uc[V + 111] = "F" + V;
for (var V = 65; V <= 90; V++) uc[V] = String.fromCharCode(V + 32), dc[V] = String.fromCharCode(V);
for (var mc in uc) dc.hasOwnProperty(mc) || (dc[mc] = uc[mc]);
function hc(e) {
	var t = !(fc && e.metaKey && e.shiftKey && !e.ctrlKey && !e.altKey || pc && e.shiftKey && e.key && e.key.length == 1 || e.key == "Unidentified") && e.key || (e.shiftKey ? dc : uc)[e.keyCode] || e.key || "Unidentified";
...
function xc(e) {
	return new M({ props: { handleKeyDown: Sc(e) } });
}
function Sc(e) {
	let t = yc(e);
	return function(e, n) {
		...
		if (r.length == 1 && r != " ") {
			...
			if ((n.altKey || n.metaKey || n.ctrlKey) && !(_c && n.ctrlKey && n.altKey) && (i = uc[n.keyCode]) && i != r) {
				let r = t[bc(i, n)];
...
wc(Dc, {
	...
	scrollIntoView: () => Dl,
	selectAll: () => Ol,
	selectNodeBackward: () => kl,
	selectNodeForward: () => Al,
	selectParentNode: () => jl,
	selectTextblockEnd: () => Ml,
	selectTextblockStart: () => Nl,
	setContent: () => Fl,
	setMark: () => Tu,
	setMeta: () => Eu,
	setNode: () => Du,
...
}, jc = (e) => (t) => e(t), Mc = () => ({ state: e, dispatch: t }) => wr(e, t), Nc = (e, t) => ({ editor: n, tr: r }) => {
...
}, Lc = () => ({ state: e, dispatch: t }) => ar(e, t), Rc = () => ({ commands: e }) => e.keyboardShortcut("Enter"), zc = () => ({ state: e, dispatch: t }) => Cr(e, t);
function Bc(e) {
	return Object.prototype.toString.call(e) === "[object RegExp]";
}
function Vc(e, t, n = { strict: !0 }) {
	let r = Object.keys(t);
	return !r.length || r.every((r) => n.strict ? t[r] === e[r] : Bc(t[r]) ? t[r].test(e[r]) : t[r] === e[r]);
}
function Hc(e, t, n = {}) {
...
function Xc(e, t = null) {
	...
	if (t === "end") return r;
	let i = n.from, a = r.to;
	return t === "all" ? A.create(e, Yc(0, i, a), Yc(e.content.size, i, a)) : A.create(e, Yc(t, i, a), Yc(t, i, a));
}
function Zc() {
...
var $c = (e = null, t = {}) => ({ editor: n, view: r, tr: i, dispatch: a }) => {
	t = {
		scrollIntoView: !0,
		...t
	};
	let o = () => {
		(Qc() || Zc()) && r.dom.focus(), requestAnimationFrame(() => {
...
}, el = (e, t) => (n) => e.every((e, r) => t(e, {
	...n,
	index: r
})), tl = (e, t) => ({ tr: n, commands: r }) => r.insertContentAt({
	...
	for (let n = t.length - 1; n >= 0; --n) {
		let r = t[n];
		r.nodeType === 3 && r.nodeValue && /^(\n\s\s|\n)$/.test(r.nodeValue) ? e.removeChild(r) : r.nodeType === 1 && nl(r);
	}
	return e;
};
function rl(e) {
...
function il(e, t, n) {
	if (e instanceof ke || e instanceof w) return e;
	n = {
		slice: !0,
		parseOptions: {},
		...n
	...
	if (r) try {
		...
		return console.warn("[tiptap warn]: Invalid content.", "Passed value:", e, "Error:", r), il("", t, n);
	}
	if (i) {
		if (n.errorOnInvalidContent) {
			...
			if (n.slice ? it.fromSchema(a).parseSlice(rl(e), n.parseOptions) : it.fromSchema(a).parse(rl(e), n.parseOptions), n.errorOnInvalidContent && r) throw Error("[tiptap error]: Invalid HTML content", { cause: /* @__PURE__ */ Error(`Invalid element found: ${i}`) });
		}
		let r = it.fromSchema(t);
		return n.slice ? r.parseSlice(rl(e), n.parseOptions).content : r.parse(rl(e), n.parseOptions);
	}
	return il("", t, n);
}
function al(e, t, n) {
...
var ol = (e) => !("type" in e), sl = (e, t, n) => ({ tr: r, dispatch: i, editor: a }) => {
	if (i) {
		n = {
	...
	return !0;
}, cl = () => ({ state: e, dispatch: t }) => vr(e, t), ll = () => ({ state: e, dispatch: t }) => yr(e, t), ul = () => ({ state: e, dispatch: t }) => sr(e, t), dl = () => ({ state: e, dispatch: t }) => hr(e, t), fl = () => ({ state: e, dispatch: t, tr: n }) => {
	try {
		let r = mn(e.doc, e.selection.$from.pos, -1);
		return r != null && (n.join(r, 2), t && t(n), !0);
	} catch {
		return !1;
	}
}, pl = () => ({ state: e, dispatch: t, tr: n }) => {
	try {
		let r = mn(e.doc, e.selection.$from.pos, 1);
		return r != null && (n.join(r, 2), t && t(n), !0);
	} catch {
...
}, ml = () => ({ state: e, dispatch: t }) => cr(e, t), hl = () => ({ state: e, dispatch: t }) => lr(e, t);
function gl() {
...
function _l(e) {
	...
	for (let e = 0; e < t.length - 1; e += 1) {
		...
		else if (/^mod$/i.test(n)) Qc() || gl() ? o = !0 : i = !0;
		else throw Error(`Unrecognized modifier name: ${n}`);
	}
	return r && (n = `Alt-${n}`), i && (n = `Ctrl-${n}`), o && (n = `Meta-${n}`), a && (n = `Shift-${n}`), n;
}
var vl = (e) => ({ editor: t, view: n, tr: r, dispatch: i }) => {
	let a = _l(e).split(/-(?!$)/), o = a.find((e) => ![
		"Alt",
		"Ctrl",
		"Meta",
		"Shift"
...
function yl(e, t, n = {}) {
	...
	let c = i - r, l = s.filter((e) => !o || o.name === e.node.type.name).filter((e) => Vc(e.node.attrs, n, { strict: !1 }));
	return a ? !!l.length : l.reduce((e, t) => e + t.to - t.from, 0) >= c;
}
var bl = (e, t = {}) => ({ state: n, dispatch: r }) => yl(n, H(e, n.schema), t) ? br(n, r) : !1, xl = () => ({ state: e, dispatch: t }) => Tr(e, t), Sl = (e) => ({ state: t, dispatch: n }) => Gr(H(e, t.schema))(t, n), Cl = () => ({ state: e, dispatch: t }) => xr(e, t);
function wl(e, t) {
...
var El = (e, t) => ({ tr: n, state: r, dispatch: i }) => {
	let a = null, o = null, s = wl(typeof e == "string" ? e : e.name, r.schema);
	return s ? (s === "node" && (a = H(e, r.schema)), s === "mark" && (o = Gc(e, r.schema)), i && n.selection.ranges.forEach((e) => {
		r.doc.nodesBetween(e.$from.pos, e.$to.pos, (e, r) => {
			a && a === e.type && n.setNodeMarkup(r, void 0, Tl(e.attrs, t)), o && e.marks.length && e.marks.forEach((i) => {
				o === i.type && n.addMark(r, r + e.nodeSize, o.create(Tl(i.attrs, t)));
			});
		});
	}), !0) : !1;
}, Dl = () => ({ tr: e, dispatch: t }) => (t && e.scrollIntoView(), !0), Ol = () => ({ tr: e, dispatch: t }) => {
	if (t) {
		let t = new Un(e.doc);
		e.setSelection(t);
	}
	return !0;
}, kl = () => ({ state: e, dispatch: t }) => fr(e, t), Al = () => ({ state: e, dispatch: t }) => gr(e, t), jl = () => ({ state: e, dispatch: t }) => Or(e, t), Ml = () => ({ state: e, dispatch: t }) => Pr(e, t), Nl = () => ({ state: e, dispatch: t }) => Nr(e, t);
function Pl(e, t, n = {}, r = {}) {
	return il(e, t, {
		slice: !1,
		parseOptions: n,
...
var Fl = (e, { errorOnInvalidContent: t, emitUpdate: n = !0, parseOptions: r = {} } = {}) => ({ editor: i, tr: a, dispatch: o, commands: s }) => {
	let { doc: c } = a;
	if (r.preserveWhitespace !== "full") {
		let s = Pl(e, i.schema, r, { errorOnInvalidContent: t ?? i.options.enableContentCheck });
...
function Ul(e, t) {
	let n = vt.fromSchema(t).serializeFragment(e), r = document.implementation.createHTMLDocument().createElement("div");
...
function Xl(e, t) {
	return "style" in e ? e : {
		...
		getAttrs: (n) => {
			...
			if (r === !1) return !1;
			let i = t.reduce((e, t) => {
				let r = t.attribute.parseHTML ? t.attribute.parseHTML(n) : Yl(n.getAttribute(t.name));
				return r == null ? e : {
					...e,
					[t.name]: r
				};
...
function Ql(e, t) {
	let n = ql(e), { nodeExtensions: r, markExtensions: i } = Kl(e), a = r.find((e) => U(e, "topNode"))?.name;
	return new et({
		topNode: a,
		nodes: Object.fromEntries(r.map((r) => {
			let i = n.filter((e) => e.type === r.name), a = {
				...
				attrs: Object.fromEntries(i.map((e) => [e.name, {
					default: e?.attribute?.default,
					validate: e?.attribute?.validate
				}]))
			}), s = W(U(r, "parseHTML", a));
			s && (o.parseDOM = s.map((e) => Xl(e, i)));
			let c = U(r, "renderHTML", a);
			c && (o.toDOM = (e) => c({
				node: e,
				HTMLAttributes: Jl(e, i)
			}));
...
function tu(e) {
	let t = eu(Hl(e)), n = $l(t.map((e) => e.name));
...
function ou(e, t) {
	let n = wl(typeof t == "string" ? t : t.name, e.schema);
	return n === "node" ? au(e, t) : n === "mark" ? Il(e, t) : {};
}
...
function hu(e, t, n = {}) {
	...
	if (r) return !!(e.storedMarks || e.selection.$from.marks()).filter((e) => !a || a.name === e.type.name).find((e) => Vc(e.attrs, n, { strict: !1 }));
	let o = 0, s = [];
	...
	let c = s.filter((e) => !a || a.name === e.mark.type.name).filter((e) => Vc(e.mark.attrs, n, { strict: !1 })).reduce((e, t) => e + t.to - t.from, 0), l = s.filter((e) => !a || e.mark.type !== a && e.mark.type.excludes(a)).reduce((e, t) => e + t.to - t.from, 0);
	return (c > 0 ? c + l : c) >= o;
}
function gu(e, t, n = {}) {
	if (!t) return yl(e, null, n) || hu(e, null, n);
	let r = wl(t, e.schema);
	return r === "node" ? yl(e, t, n) : r === "mark" && hu(e, t, n);
}
var _u = (e, t) => {
...
function xu(e, { checkChildren: t = !0, ignoreWhitespace: n = !1 } = {}) {
	if (n) {
...
function Cu(e, t, n) {
	let r = e.state.doc.content.size, i = Yc(t, 0, r), a = Yc(n, 0, r), o = e.coordsAtPos(i), s = e.coordsAtPos(a, -1), c = Math.min(o.top, s.top), l = Math.max(o.bottom, s.bottom), u = Math.min(o.left, s.left), d = Math.max(o.right, s.right), f = {
		top: c,
		bottom: l,
		left: u,
		right: d,
...
var Tu = (e, t = {}) => ({ tr: n, state: r, dispatch: i }) => {
	...
	return wu(r, n, c);
}, Eu = (e, t) => ({ tr: n }) => (n.setMeta(e, t), !0), Du = (e, t = {}) => ({ state: n, dispatch: r, chain: i }) => {
	let a = H(e, n.schema), o;
	return n.selection.$anchor.sameParent(n.selection.$head) && (o = n.selection.$anchor.parent.attrs), a.isTextblock ? i().command(({ commands: e }) => Ir(a, {
		...o,
		...t
	})(n) ? !0 : e.clearNodes()).command(({ state: e }) => Ir(a, {
		...o,
		...t
	})(e, r)).run() : (console.warn("[tiptap warn]: Currently \"setNode()\" only supports text block nodes."), !1);
}, Ou = (e) => ({ tr: t, dispatch: n }) => {
	if (n) {
		let { doc: n } = t, r = Yc(e, 0, n.content.size), i = j.create(n, r);
		t.setSelection(i);
	}
	return !0;
	...
	if (n) {
		let { doc: n } = t, { from: r, to: i } = typeof e == "number" ? {
			from: e,
			to: e
		} : e, a = A.atStart(n).from, o = A.atEnd(n).to, s = Yc(r, a, o), c = Yc(i, a, o), l = A.create(n, s, c);
		t.setSelection(l);
	}
	return !0;
}, Au = (e) => ({ state: t, dispatch: n }) => Jr(H(e, t.schema))(t, n);
function ju(e, t) {
...
var Mu = ({ keepMarks: e = !0 } = {}) => ({ tr: t, state: n, dispatch: r, editor: i }) => {
	let { selection: a, doc: o } = t, { $from: s, $to: c } = a, l = i.extensionManager.attributes, u = pu(l, s.node().type.name, s.node().attrs);
	if (a instanceof j && a.node.isBlock) return !s.parentOffset || !ln(o, s.pos) ? !1 : (r && (e && ju(n, i.extensionManager.splittableMarks), t.split(s.pos).scrollIntoView()), !0);
	if (!s.parent.isBlock) return !1;
	let d = c.parentOffset === c.parent.content.size, f = s.depth === 0 ? void 0 : Rl(s.node(-1).contentMatchAt(s.indexAfter(-1))), p = d && f ? [{
		type: f,
		attrs: u
	}] : void 0, m = ln(t.doc, t.mapping.map(s.pos), 1, p);
	if (!p && !m && ln(t.doc, t.mapping.map(s.pos), 1, f ? [{ type: f }] : void 0) && (m = !0, p = f ? [{
		type: f,
		attrs: u
	}] : void 0), r) {
	...
	if (s.parent.content.size === 0 && s.node(-1).childCount === s.indexAfter(-1)) {
		...
		if (i) {
			...
			let i = s.indexAfter(-1) < s.node(-2).childCount ? 1 : s.indexAfter(-2) < s.node(-3).childCount ? 2 : 3, a = {
				...pu(d, s.node().type.name, s.node().attrs),
				...t
	...
	return n.node.type === i?.type && dn(e.doc, n.pos) && e.join(n.pos), !0;
}, Fu = (e, t) => {
	let n = Vl((e) => e.type === t)(e.selection);
	if (!n) return !0;
	...
	if (r === void 0) return !0;
	let i = e.doc.nodeAt(r);
	return n.node.type === i?.type && dn(e.doc, r) && e.join(r), !0;
}, Iu = (e, t, n, r = {}) => ({ editor: i, tr: a, state: o, dispatch: s, chain: c, commands: l, can: u }) => {
	...
	if (!y) return !1;
	let x = Vl((e) => bu(e.type.name, d))(h);
	if (y.depth >= 1 && x && y.depth - x.depth <= 1) {
		if (x.node.type === p) return l.liftListItem(m);
		if (bu(x.node.type.name, d) && p.validContent(x.node.content) && s) return c().command(() => (a.setNodeMarkup(x.pos, p), !0)).command(() => Pu(a, p)).command(() => Fu(a, p)).run();
	}
	return !n || !b || !s ? c().command(() => u().wrapInList(p, r) ? !0 : l.clearNodes()).wrapInList(p, r).command(() => Pu(a, p)).command(() => Fu(a, p)).run() : c().command(() => {
		let e = u().wrapInList(p, r), t = b.filter((e) => f.includes(e.type.name));
		return a.ensureMarks(t), e ? !0 : l.clearNodes();
	}).wrapInList(p, r).command(() => Pu(a, p)).command(() => Fu(a, p)).run();
}, Lu = (e, t = {}, n = {}) => ({ state: r, commands: i }) => {
	let { extendEmptyMarkRange: a = !1 } = n, o = Gc(e, r.schema);
	return hu(r, o, t) ? i.unsetMark(o, { extendEmptyMarkRange: a }) : i.setMark(o, t);
}, Ru = (e, t, n = {}) => ({ state: r, commands: i }) => {
	let a = H(e, r.schema), o = H(t, r.schema), s = yl(r, a, n), c;
...
}, Uu = (e, t = {}) => ({ tr: n, state: r, dispatch: i }) => {
	let a = null, o = null, s = wl(typeof e == "string" ? e : e.name, r.schema);
	return s ? (s === "node" && (a = H(e, r.schema)), s === "mark" && (o = Gc(e, r.schema)), i && n.selection.ranges.forEach((e) => {
...
}, Wu = (e, t = {}) => ({ state: n, dispatch: r }) => Fr(H(e, n.schema), t)(n, r), Gu = (e, t = {}) => ({ state: n, dispatch: r }) => Hr(H(e, n.schema), t)(n, r), Ku = class {
	constructor() {
		this.callbacks = {};
	}
	on(e, t) {
	...
	let { editor: t, rules: n } = e, r = new M({
		state: {
			...
			apply(e, i, a) {
				...
				return s && setTimeout(() => {
					let { text: e } = s;
					e = typeof e == "string" ? e : Ul(w.from(e), a.schema);
...
function $u(e, t) {
	...
	return Qu(e) && Qu(t) && Object.keys(t).forEach((r) => {
		Qu(t[r]) && Qu(e[r]) ? n[r] = $u(e[r], t[r]) : n[r] = t[r];
	}), n;
}
var ed = class {
	constructor(e = {}) {
...
function cd(e) {
	...
	return n.map((e) => new M({
		view(e) {
			let n = (n) => {
				r = e.dom.parentElement?.contains(n.target) ? e.dom.parentElement : null, r && (od = t);
			}, i = () => {
				od &&= null;
			};
		...
		appendTransaction: (t, n, r) => {
			...
			if (f) {
				let { text: t } = d;
				t = typeof t == "string" ? t : Ul(w.from(t), r.schema);
...
var ld = class {
	constructor(e, t) {
		this.splittableMarks = [], this.editor = t, this.baseExtensions = e, this.extensions = tu(e), this.schema = Ql(this.extensions, t), this.setupExtensions();
	}
	get commands() {
	...
	get plugins() {
		let { editor: e } = this;
		return eu([...this.extensions].reverse()).flatMap((t) => {
			let n = {
				name: t.name,
				options: t.options,
				storage: this.editor.extensionStorage[t.name],
			...
			if (t.type === "mark" && U(t, "exitable", n) && (a.ArrowRight = () => td.handleExit({
				editor: e,
				mark: t
			})), i) {
			...
			if (yu(t, e.options.enableInputRules) && s) {
				let t = s();
				if (t && t.length) {
					let n = Xu({
						editor: e,
			...
			if (yu(t, e.options.enablePasteRules) && c) {
				let t = c();
				if (t && t.length) {
					let n = cd({
						editor: e,
...
ld.resolve = tu, ld.sort = eu, ld.flatten = Hl, wc({}, {
	...
	addProseMirrorPlugins() {
		return [new M({
			...
			props: { clipboardTextSerializer: () => {
				let { editor: e } = this, { state: t, schema: n } = e, { doc: r, selection: i } = t, { ranges: a } = i, o = Math.min(...a.map((e) => e.$from.pos)), s = Math.max(...a.map((e) => e.$to.pos)), c = iu(n);
				return nu(r, {
					from: o,
					to: s
				}, {
...
}), hd = new N("focusEvents"), gd = K.create({
	name: "focusEvents",
	addProseMirrorPlugins() {
		let { editor: e } = this;
		return [new M({
...
var Cd = class extends Ku {
	...
	injectCSS() {
		this.options.injectCSS && typeof document < "u" && (this.css = Sd(xd, this.options.injectNonce));
	}
	setOptions(e = {}) {
		this.options = {
			...this.options,
	...
	createExtensionManager() {
		let e = [...this.options.enableCoreExtensions ? [
			md,
			ud.configure({ blockSeparator: this.options.coreExtensionOptions?.clipboardTextSerializer?.blockSeparator }),
			dd,
			gd,
			_d,
			yd,
		...
		this.extensionManager = new ld(e, this);
	}
	...
	createDoc() {
		let e;
		try {
			e = Pl(this.options.content, this.schema, this.options.parseOptions, { errorOnInvalidContent: this.options.enableContentCheck });
		} catch (t) {
			...
			}), e = Pl(this.options.content, this.schema, this.options.parseOptions, { errorOnInvalidContent: !1 });
		}
		return e;
	}
	createView(e) {
		this.editorView = new nc(e, {
		...
		let t = this.state.reconfigure({ plugins: this.extensionManager.plugins });
	...
	$pos(e) {
		return new bd(this.state.doc.resolve(e), this);
	}
	get $doc() {
		return this.$pos(0);
	}
	...
	return new qu({
		...
		handler: ({ state: t, range: n, match: r }) => {
			...
			if (o) {
				...
				if (uu(n.from, n.to, t.doc).filter((t) => t.mark.type.excluded.find((n) => n === e.type && n !== t.mark.type)).filter((e) => e.to > c).length) return null;
...
function Dd(e) {
	return new qu({
		...
		handler: ({ state: t, range: n, match: r, chain: i }) => {
			let a = W(e.getAttributes, void 0, r) || {}, o = t.tr.delete(n.from, n.to), s = o.doc.resolve(n.from).blockRange(), c = s && Qt(s, e.type, a);
			if (!c) return null;
			...
			l && l.type === e.type && dn(o.doc, n.from - 1) && (!e.joinPredicate || e.joinPredicate(r, l)) && o.join(n.from - 1);
		},
		undoable: e.undoable
	});
}
...
wc({}, {
	createAtomBlockMarkdownSpec: () => jd,
	createBlockMarkdownSpec: () => Md,
	createInlineMarkdownSpec: () => Fd,
	parseAttributes: () => kd,
	parseIndentedBlocks: () => Id,
	renderNestedMarkdownContent: () => Ld,
	serializeAttributes: () => Ad
});
function kd(e) {
	if (!e?.trim()) return {};
...
function jd(e) {
	let { nodeName: t, name: n, parseAttributes: r = kd, serializeAttributes: i = Ad, defaultAttributes: a = {}, requiredAttributes: o = [], allowedAttributes: s } = e, c = n || t, l = (e) => {
		if (!s) return e;
		let t = {};
		return s.forEach((n) => {
			n in e && (t[n] = e[n]);
...
function Md(e) {
	let { nodeName: t, name: n, getContent: r, parseAttributes: i = kd, serializeAttributes: a = Ad, defaultAttributes: o = {}, content: s = "block", allowedAttributes: c } = e, l = n || t, u = (e) => {
		if (!c) return e;
		let t = {};
		return c.forEach((n) => {
			n in e && (t[n] = e[n]);
...
function Fd(e) {
	let { nodeName: t, name: n, getContent: r, parseAttributes: i = Nd, serializeAttributes: a = Pd, defaultAttributes: o = {}, selfClosing: s = !1, allowedAttributes: c } = e, l = n || t, u = (e) => {
		if (!c) return e;
		let t = {};
		return c.forEach((n) => {
			n in e && (t[n] = e[n]);
	...
	return new rd({
		...
		handler: ({ state: t, range: n, match: r, pasteEvent: i }) => {
			...
			if (s) {
				...
				if (uu(n.from, n.to, t.doc).filter((t) => t.mark.type.excluded.find((n) => n === e.type && n !== t.mark.type)).filter((e) => e.to > i).length) return null;
...
var Hd = class extends Cd {
	constructor(e = {}) {
		return super(e), this.contentComponent = null, this.appContext = null, this.reactiveState = Vd(this.view.state), this.reactiveExtensionStorage = Vd(this.extensionStorage), this.on("beforeTransaction", ({ nextState: e }) => {
	...
	setup(e) {
		...
		return ne(() => {
			...
			r && r.options.element && t.value && f(() => {
				if (!t.value || !r.view.dom?.firstChild) return;
				let e = x(t.value);
				t.value.append(r.view.dom), r.contentComponent = n.ctx._, n && (r.appContext = {
					...n.appContext,
					provides: n.provides
...
var Wd = (e = {}) => {
	...
	return g(() => {
		...
		var e, n;
		let r = t.value?.view.dom, i = r?.cloneNode(!0);
...
var Gd = [
	...
	"bottom",
	"left"
], Kd = ["start", "end"], qd = /*#__PURE__*/ Gd.reduce((e, t) => e.concat(t, t + "-" + Kd[0], t + "-" + Kd[1]), []), Jd = Math.min, q = Math.max, Yd = Math.round, Xd = (e) => ({
	x: e,
	y: e
}), Zd = {
	left: "right",
...
var of = /*#__PURE__*/ new Set(["top", "bottom"]);
function sf(e) {
	return of.has(tf(e)) ? "y" : "x";
}
function cf(e) {
	return rf(sf(e));
}
function lf(e, t, n) {
	n === void 0 && (n = !1);
	let r = nf(e), i = cf(e), a = af(i), o = i === "x" ? r === (n ? "end" : "start") ? "right" : "left" : r === "start" ? "bottom" : "top";
	return t.reference[a] > t.floating[a] && (o = vf(o)), [o, vf(o)];
}
function uf(e) {
	let t = vf(e);
	return [
...
function df(e) {
	return e.replace(/start|end/g, (e) => Qd[e]);
}
var ff = ["left", "right"], pf = ["right", "left"], mf = ["top", "bottom"], hf = ["bottom", "top"];
function gf(e, t, n) {
	switch (e) {
		case "top":
		case "bottom": return n ? t ? pf : ff : t ? ff : pf;
		case "left":
		case "right": return t ? mf : hf;
		default: return [];
	}
}
function _f(e, t, n, r) {
	let i = nf(e), a = gf(tf(e), n === "start", r);
	return i && (a = a.map((e) => e + "-" + i), t && (a = a.concat(a.map(df)))), a;
}
function vf(e) {
	return e.replace(/left|right|bottom|top/g, (e) => Zd[e]);
}
function yf(e) {
	return {
		top: 0,
...
function Sf(e, t, n) {
	let { reference: r, floating: i } = e, a = sf(t), o = cf(t), s = af(o), c = tf(t), l = a === "y", u = r.x + r.width / 2 - i.width / 2, d = r.y + r.height / 2 - i.height / 2, f = r[s] / 2 - i[s] / 2, p;
	switch (c) {
		case "top":
			p = {
				x: u,
...
async function wf(e, t) {
	t === void 0 && (t = {});
	let { x: n, y: r, platform: i, rects: a, elements: o, strategy: s } = e, { boundary: c = "clippingAncestors", rootBoundary: l = "viewport", elementContext: u = "floating", altBoundary: d = !1, padding: f = 0 } = ef(t, e), p = bf(f), m = o[d ? u === "floating" ? "reference" : "floating" : u], h = xf(await i.getClippingRect({
		...
		x: 1,
		y: 1
	}, y = xf(i.convertOffsetParentRelativeRectToViewportRelativeRect ? await i.convertOffsetParentRelativeRectToViewportRelativeRect({
		elements: o,
		rect: g,
		offsetParent: _,
		strategy: s
...
var Tf = (e) => ({
	...
	options: e,
	async fn(t) {
		let { x: n, y: r, placement: i, rects: a, platform: o, elements: s, middlewareData: c } = t, { element: l, padding: u = 0 } = ef(e, t) || {};
		if (l == null) return {};
		let d = bf(u), f = {
			x: n,
			y: r
		}, p = cf(i), m = af(p), h = await o.getDimensions(l), g = p === "y", _ = g ? "top" : "left", v = g ? "bottom" : "right", y = g ? "clientHeight" : "clientWidth", b = a.reference[m] + a.reference[p] - f[p] - a.floating[m], x = f[p] - a.reference[p], ee = await (o.getOffsetParent == null ? void 0 : o.getOffsetParent(l)), S = ee ? ee[y] : 0;
		(!S || !await (o.isElement == null ? void 0 : o.isElement(ee))) && (S = s.floating[y] || a.floating[m]);
		let te = b / 2 - x / 2, ne = S / 2 - h[m] / 2 - 1, re = Jd(d[_], ne), ie = Jd(d[v], ne), C = re, ae = S - h[m] - ie, oe = S / 2 - h[m] / 2 + te, w = $d(C, oe, ae), se = !c.arrow && nf(i) != null && oe !== w && a.reference[m] / 2 - (oe < C ? re : ie) - h[m] / 2 < 0, ce = se ? oe < C ? oe - C : oe - ae : 0;
		return {
			[p]: f[p] + ce,
			data: {
				[p]: w,
				centerOffset: oe - w - ce,
...
function Ef(e, t, n) {
	return (e ? [...n.filter((t) => nf(t) === e), ...n.filter((t) => nf(t) !== e)] : n.filter((e) => tf(e) === e)).filter((n) => !e || nf(n) === e || (t ? df(n) !== n : !1));
}
var Df = function(e) {
	return e === void 0 && (e = {}), {
		name: "autoPlacement",
		options: e,
		async fn(t) {
			let { rects: n, middlewareData: r, placement: i, platform: a, elements: o } = t, { crossAxis: s = !1, alignment: c, allowedPlacements: l = qd, autoAlignment: u = !0, ...d } = ef(e, t), f = c !== void 0 || l === qd ? Ef(c || null, u, l) : l, p = await wf(t, d), m = r.autoPlacement?.index || 0, h = f[m];
			if (h == null) return {};
			let g = lf(h, n, await (a.isRTL == null ? void 0 : a.isRTL(o.floating)));
			...
			let b = v.map((e) => {
				let t = nf(e.placement);
				return [
					e.placement,
					t && s ? e.overflows.slice(0, 2).reduce((e, t) => e + t, 0) : e.overflows[0],
					e.overflows
				];
			}).sort((e, t) => e[1] - t[1]), x = b.filter((e) => e[2].slice(0, nf(e[0]) ? 2 : 3).every((e) => e <= 0))[0]?.[0] || b[0][0];
			return x === i ? {} : {
				data: {
					index: m + 1,
					overflows: v
	...
	return e === void 0 && (e = {}), {
		...
		async fn(t) {
			var n;
			let { placement: r, middlewareData: i, rects: a, initialPlacement: o, platform: s, elements: c } = t, { mainAxis: l = !0, crossAxis: u = !0, fallbackPlacements: d, fallbackStrategy: f = "bestFit", fallbackAxisSideDirection: p = "none", flipAlignment: m = !0, ...h } = ef(e, t);
			if ((n = i.arrow) != null && n.alignmentOffset) return {};
			let g = tf(r), _ = sf(o), v = tf(o) === o, y = await (s.isRTL == null ? void 0 : s.isRTL(c.floating)), b = d || (v || !m ? [vf(o)] : uf(o)), x = p !== "none";
			!d && x && b.push(..._f(o, m, p, y));
			let ee = [o, ...b], S = await wf(t, h), te = [], ne = i.flip?.overflows || [];
			if (l && te.push(S[g]), u) {
				let e = lf(r, a, y);
				te.push(S[e[0]], S[e[1]]);
			}
			if (ne = [...ne, {
				...
				if (t && (u !== "alignment" || _ === sf(t) || ne.every((e) => sf(e.placement) !== _ || e.overflows[0] > 0))) return {
					data: {
						index: e,
						overflows: ne
					},
...
var jf = function(e) {
	return e === void 0 && (e = {}), {
		...
		options: e,
		async fn(t) {
			let { rects: n } = t, { strategy: r = "referenceHidden", ...i } = ef(e, t);
			switch (r) {
...
function Mf(e) {
	let t = Jd(...e.map((e) => e.left)), n = Jd(...e.map((e) => e.top)), r = q(...e.map((e) => e.right)), i = q(...e.map((e) => e.bottom));
	return {
		x: t,
		y: n,
		width: r - t,
...
var Pf = function(e) {
	return e === void 0 && (e = {}), {
		...
		options: e,
		async fn(t) {
			let { placement: n, elements: r, rects: i, platform: a, strategy: o } = t, { padding: s = 2, x: c, y: l } = ef(e, t), u = Array.from(await (a.getClientRects == null ? void 0 : a.getClientRects(r.reference)) || []), d = Nf(u), f = xf(Mf(u)), p = bf(s);
			function m() {
				...
				if (d.length >= 2) {
					if (sf(n) === "y") {
						let e = d[0], t = d[d.length - 1], r = tf(n) === "top", i = e.top, a = t.bottom, o = r ? e.left : t.left, s = r ? e.right : t.right;
						return {
							top: i,
							bottom: a,
							left: o,
					...
					let e = tf(n) === "left", t = q(...d.map((e) => e.right)), r = Jd(...d.map((e) => e.left)), i = d.filter((n) => e ? n.left === r : n.right === t), a = i[0].top, o = i[i.length - 1].bottom, s = r, c = t;
					return {
						top: a,
						bottom: o,
						left: s,
...
async function If(e, t) {
	let { placement: n, platform: r, elements: i } = e, a = await (r.isRTL == null ? void 0 : r.isRTL(i.floating)), o = tf(n), s = nf(n), c = sf(n) === "y", l = Ff.has(o) ? -1 : 1, u = a && c ? -1 : 1, d = ef(t, e), { mainAxis: f, crossAxis: p, alignmentAxis: m } = typeof d == "number" ? {
		mainAxis: d,
		crossAxis: 0,
		alignmentAxis: null
	} : {
...
var Lf = function(e) {
	return e === void 0 && (e = 0), {
		...
		async fn(t) {
			var n;
			let { x: r, y: i, placement: a, middlewareData: o } = t, s = await If(t, e);
	...
	return e === void 0 && (e = {}), {
		...
		async fn(t) {
			let { x: n, y: r, placement: i } = t, { mainAxis: a = !0, crossAxis: o = !1, limiter: s = { fn: (e) => {
				...
				x: n,
				y: r
			}, u = await wf(t, c), d = sf(tf(i)), f = rf(d), p = l[f], m = l[d];
			if (a) {
	...
	return e === void 0 && (e = {}), {
		...
		async fn(t) {
			var n, r;
			let { placement: i, rects: a, platform: o, elements: s } = t, { apply: c = () => {}, ...l } = ef(e, t), u = await wf(t, l), d = tf(i), f = nf(i), p = sf(i) === "y", { width: m, height: h } = a.floating, g, _;
			d === "top" || d === "bottom" ? (g = d, _ = f === (await (o.isRTL == null ? void 0 : o.isRTL(s.floating)) ? "start" : "end") ? "left" : "right") : (_ = d, g = f === "end" ? "top" : "bottom");
			let v = h - u.top - u.bottom, y = m - u.left - u.right, b = Jd(h - u[g], v), x = Jd(m - u[_], y), ee = !t.middlewareData.shift, S = b, te = x;
			if ((n = t.middlewareData.shift) != null && n.enabled.x && (te = y), (r = t.middlewareData.shift) != null && r.enabled.y && (S = v), ee && !f) {
				let e = q(u.left, 0), t = q(u.right, 0), n = q(u.top, 0), r = q(u.bottom, 0);
				p ? te = m - 2 * (e !== 0 || t !== 0 ? e + t : q(u.left, u.right)) : S = h - 2 * (n !== 0 || r !== 0 ? n + r : q(u.top, u.bottom));
			}
			await c({
				...t,
				availableWidth: te,
...
var Jf = /*#__PURE__*/ new Set(["inline", "contents"]);
function Yf(e) {
	let { overflow: t, overflowX: n, overflowY: r, display: i } = cp(e);
	return /auto|scroll|overlay|hidden|clip/.test(t + r + n) && !Jf.has(i);
}
...
function rp(e) {
	let t = ap(), n = Gf(e) ? cp(e) : e;
	return ep.some((e) => n[e] ? n[e] !== "none" : !1) || (n.containerType ? n.containerType !== "normal" : !1) || !t && (n.backdropFilter ? n.backdropFilter !== "none" : !1) || !t && (n.filter ? n.filter !== "none" : !1) || tp.some((e) => (n.willChange || "").includes(e)) || np.some((e) => (n.contain || "").includes(e));
}
function ip(e) {
	let t = up(e);
	for (; Kf(t) && !sp(t);) {
...
function dp(e) {
	let t = up(e);
	return sp(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : Kf(t) && Yf(t) ? t : dp(t);
}
function fp(e, t, n) {
	t === void 0 && (t = []), n === void 0 && (n = !0);
	let r = dp(e), i = r === e.ownerDocument?.body, a = Hf(r);
	if (i) {
		let e = pp(a);
		return t.concat(a, a.visualViewport || [], Yf(r) ? r : [], e && n ? fp(e) : []);
	}
	return t.concat(r, fp(r, [], n));
}
function pp(e) {
...
function mp(e) {
	let t = cp(e), n = parseFloat(t.width) || 0, r = parseFloat(t.height) || 0, i = Kf(e), a = i ? e.offsetWidth : n, o = i ? e.offsetHeight : r, s = Yd(n) !== a || Yd(r) !== o;
	return s && (n = a, r = o), {
		width: n,
		height: r,
		$: s
...
function gp(e) {
	let t = hp(e);
	if (!Kf(t)) return Xd(1);
	let n = t.getBoundingClientRect(), { width: r, height: i, $: a } = mp(t), o = (a ? Yd(n.width) : n.width) / r, s = (a ? Yd(n.height) : n.height) / i;
	return (!o || !Number.isFinite(o)) && (o = 1), (!s || !Number.isFinite(s)) && (s = 1), {
		x: o,
		y: s
	};
}
var _p = /*#__PURE__*/ Xd(0);
function vp(e) {
	let t = Hf(e);
	return !ap() || !t.visualViewport ? _p : {
...
function bp(e, t, n, r) {
	...
	let i = e.getBoundingClientRect(), a = hp(e), o = Xd(1);
	t && (r ? Gf(r) && (o = gp(r)) : o = gp(e));
	let s = yp(a, n, r) ? vp(a) : Xd(0), c = (i.left + s.x) / o.x, l = (i.top + s.y) / o.y, u = i.width / o.x, d = i.height / o.y;
	if (a) {
		let e = Hf(a), t = r && Gf(r) ? Hf(r) : r, n = e, i = pp(n);
		for (; i && r && t !== n;) {
			let e = gp(i), t = i.getBoundingClientRect(), r = cp(i), a = t.left + (i.clientLeft + parseFloat(r.paddingLeft)) * e.x, o = t.top + (i.clientTop + parseFloat(r.paddingTop)) * e.y;
			c *= e.x, l *= e.y, u *= e.x, d *= e.y, c += a, l += o, n = Hf(i), i = pp(n);
		}
	}
	return xf({
		width: u,
...
function xp(e, t) {
	let n = lp(e).scrollLeft;
	return t ? t.left + n : bp(Uf(e)).left + n;
}
function Sp(e, t) {
	let n = e.getBoundingClientRect();
	return {
		x: n.left + t.scrollLeft - xp(e, n),
		y: n.top + t.scrollTop
	};
}
function Cp(e) {
	let { elements: t, rect: n, offsetParent: r, strategy: i } = e, a = i === "fixed", o = Uf(r), s = t ? $f(t.floating) : !1;
	if (r === o || s && a) return n;
	let c = {
		scrollLeft: 0,
		scrollTop: 0
	}, l = Xd(1), u = Xd(0), d = Kf(r);
	if ((d || !d && !a) && ((Vf(r) !== "body" || Yf(o)) && (c = lp(r)), Kf(r))) {
		let e = bp(r);
		l = gp(r), u.x = e.x + r.clientLeft, u.y = e.y + r.clientTop;
	}
	let f = o && !d && !a ? Sp(o, c) : Xd(0);
	return {
		width: n.width * l.x,
		height: n.height * l.y,
...
function Tp(e) {
	let t = Uf(e), n = lp(e), r = e.ownerDocument.body, i = q(t.scrollWidth, t.clientWidth, r.scrollWidth, r.clientWidth), a = q(t.scrollHeight, t.clientHeight, r.scrollHeight, r.clientHeight), o = -n.scrollLeft + xp(e), s = -n.scrollTop;
	return cp(r).direction === "rtl" && (o += q(t.clientWidth, r.clientWidth) - i), {
		width: i,
		height: a,
		x: o,
		y: s
...
var Op = /*#__PURE__*/ new Set(["absolute", "fixed"]);
function kp(e, t) {
	let n = bp(e, !0, t === "fixed"), r = n.top + e.clientTop, i = n.left + e.clientLeft, a = Kf(e) ? gp(e) : Xd(1);
	return {
...
function Ap(e, t, n) {
	let r;
	if (t === "viewport") r = Dp(e, n);
	else if (t === "document") r = Tp(Uf(e));
	else if (Gf(t)) r = kp(t, n);
	else {
		let n = vp(e);
		r = {
			x: t.x - n.x,
...
function jp(e, t) {
	let n = up(e);
	return n === t || !Gf(n) || sp(n) ? !1 : cp(n).position === "fixed" || jp(n, t);
}
function Mp(e, t) {
	let n = t.get(e);
	if (n) return n;
	let r = fp(e, [], !1).filter((e) => Gf(e) && Vf(e) !== "body"), i = null, a = cp(e).position === "fixed", o = a ? up(e) : e;
	for (; Gf(o) && !sp(o);) {
		let t = cp(o), n = rp(o);
		!n && t.position === "fixed" && (i = null), (a ? !n && !i : !n && t.position === "static" && i && Op.has(i.position) || Yf(o) && !n && jp(e, o)) ? r = r.filter((e) => e !== o) : i = t, o = up(o);
	}
	return t.set(e, r), r;
}
function Np(e) {
	let { element: t, boundary: n, rootBoundary: r, strategy: i } = e, a = [...n === "clippingAncestors" ? $f(t) ? [] : Mp(t, this._c) : [].concat(n), r], o = a[0], s = a.reduce((e, n) => {
		let r = Ap(t, n, i);
		return e.top = q(r.top, e.top), e.right = Jd(r.right, e.right), e.bottom = Jd(r.bottom, e.bottom), e.left = q(r.left, e.left), e;
	}, Ap(t, o, i));
	return {
...
function Fp(e, t, n) {
	let r = Kf(t), i = Uf(t), a = n === "fixed", o = bp(e, !0, a, t), s = {
		scrollLeft: 0,
		scrollTop: 0
	}, c = Xd(0);
	function l() {
	...
	if (r || !r && !a) {
		if ((Vf(t) !== "body" || Yf(i)) && (s = lp(t)), r) {
			let e = bp(t, !0, a, t);
			c.x = e.x + t.clientLeft, c.y = e.y + t.clientTop;
		} else i && l();
	}
	a && !r && i && l();
	let u = i && !r && !a ? Sp(i, s) : Xd(0);
	return {
...
function Lp(e, t) {
	if (!Kf(e) || cp(e).position === "fixed") return null;
	if (t) return t(e);
...
function Rp(e, t) {
	...
	if (!Kf(e)) {
		let t = up(e);
		for (; t && !sp(t);) {
			if (Gf(t) && !Ip(t)) return t;
			t = up(t);
		}
		return n;
	}
	let r = Lp(e, t);
	for (; r && Zf(r) && Ip(r);) r = Lp(r, t);
	return r && sp(r) && Ip(r) && !rp(r) ? n : r || ip(e) || n;
}
var zp = async function(e) {
	let t = this.getOffsetParent || Rp, n = this.getDimensions, r = await n(e.floating);
	return {
...
var Vp = {
	...
	isElement: Gf,
	isRTL: Bp
}, Hp = Lf, Up = Df, Wp = Rf, Gp = Of, Kp = zf, qp = jf, Jp = Tf, Yp = Pf, Xp = (e, t, n) => {
...
if (typeof WeakMap < "u") {
	...
	Zp = (t) => e.get(t), Qp = (t, n) => (e.set(t, n), n);
} else {
	let e = [], t = 0;
	Zp = (t) => {
		for (let n = 0; n < e.length; n += 2) if (e[n] == t) return e[n + 1];
	}, Qp = (n, r) => (t == 10 && (t = 0), e[t++] = n, e[t++] = r);
}
var $p = class {
	constructor(e, t, n, r) {
...
function nm(e, t, n) {
	...
	for (let i = 0; i < e.map.length; i++) {
		...
		for (let n = 0; n < c.colspan; n++) {
			...
			r != null && (!c.colwidth || c.colwidth[n] != r) && ((s ||= rm(c))[n] = r);
		}
...
function dm(e, t, n) {
	let r = e.node(-1), i = $p.get(r), a = e.start(-1), o = i.nextCell(e.pos - a, t, n);
...
var pm = class e extends k {
	constructor(e, t = e) {
		let n = e.node(-1), r = $p.get(n), i = e.start(-1), a = r.rectBetween(e.pos - i, t.pos - i), o = e.node(0), s = r.cellsInRect(a).filter((e) => e != t.pos - i);
		s.unshift(t.pos - i);
		let c = s.map((e) => {
			let t = n.nodeAt(e);
			if (!t) throw RangeError(`No cell with offset ${e} found`);
			let r = i + e + 1;
			return new Rn(o.resolve(r), o.resolve(r + t.content.size));
		});
	...
	content() {
		let e = this.$anchorCell.node(-1), t = $p.get(e), n = this.$anchorCell.start(-1), r = t.rectBetween(this.$anchorCell.pos - n, this.$headCell.pos - n), i = {}, a = [];
		for (let n = r.top; n < r.bottom; n++) {
			...
			for (let a = n * t.width + r.left, s = r.left; s < r.right; s++, a++) {
				...
				if (l > 0 || u > 0) {
					let e = c.attrs;
					if (l > 0 && (e = fm(e, 0, l)), u > 0 && (e = fm(e, e.colspan - u, u)), s.left < r.left) {
	...
	replace(e, t = E.empty) {
		...
		let i = k.findFrom(e.doc.resolve(e.mapping.slice(n).map(this.to)), -1);
		i && e.setSelection(i);
	}
	replaceWith(e, t) {
	...
	forEachCell(e) {
		let t = this.$anchorCell.node(-1), n = $p.get(t), r = this.$anchorCell.start(-1), i = n.cellsInRect(n.rectBetween(this.$anchorCell.pos - r, this.$headCell.pos - r));
	...
	static colSelection(t, n = t) {
		let r = t.node(-1), i = $p.get(r), a = t.start(-1), o = i.findCell(t.pos - a), s = i.findCell(n.pos - a), c = t.node(0);
	...
	isRowSelection() {
		let e = this.$anchorCell.node(-1), t = $p.get(e), n = this.$anchorCell.start(-1), r = t.colCount(this.$anchorCell.pos - n), i = t.colCount(this.$headCell.pos - n);
	...
	getBookmark() {
		return new mm(this.$anchorCell.pos, this.$headCell.pos);
	}
};
pm.prototype.visible = !1, k.jsonID("cell", pm);
var mm = class e {
	constructor(e, t) {
		this.anchor = e, this.head = t;
	}
	...
	resolve(e) {
		...
		return t.parent.type.spec.tableRole == "row" && n.parent.type.spec.tableRole == "row" && t.index() < t.parent.childCount && n.index() < n.parent.childCount && um(t, n) ? new pm(t, n) : k.near(n, 1);
	}
};
new N("fix-tables");
function hm(e) {
	let t = e.selection, n = sm(e), r = n.node(-1), i = n.start(-1), a = $p.get(r);
	return {
		...t instanceof pm ? a.rectBetween(t.$anchorCell.pos - i, t.$headCell.pos - i) : a.findCell(n.pos - i),
		tableStart: i,
		map: a,
		table: r
	};
...
function gm(e) {
	return function(t, n) {
		if (!om(t)) return !1;
		if (n) {
			let r = im(t.schema), i = hm(t), a = t.tr, o = i.map.cellsInRect(e == "column" ? {
				left: i.left,
				top: 0,
				right: i.right,
				bottom: i.map.height
...
function vm(e, t) {
	return t ||= { useDeprecatedLogic: !1 }, t.useDeprecatedLogic ? gm(e) : function(t, n) {
		if (!om(t)) return !1;
		if (n) {
			let r = im(t.schema), i = hm(t), a = t.tr, o = _m("row", i, r), s = _m("column", i, r), c = (e === "column" ? o : e === "row" && s) ? 1 : 0, l = e == "column" ? {
				left: 0,
				top: c,
				right: 1,
				bottom: i.map.height
...
vm("row", { useDeprecatedLogic: !0 }), vm("column", { useDeprecatedLogic: !0 }), vm("cell", { useDeprecatedLogic: !0 });
function ym(e, t) {
	let n = e.selection;
	if (!(n instanceof pm)) return !1;
	if (t) {
		let r = e.tr, i = im(e.schema).cell.createAndFill().content;
		n.forEachCell((e, t) => {
...
Sc({
	ArrowLeft: xm("horiz", -1),
	ArrowRight: xm("horiz", 1),
	ArrowUp: xm("vert", -1),
	ArrowDown: xm("vert", 1),
	"Shift-ArrowLeft": Sm("horiz", -1),
	"Shift-ArrowRight": Sm("horiz", 1),
	"Shift-ArrowUp": Sm("vert", -1),
	"Shift-ArrowDown": Sm("vert", 1),
	Backspace: ym,
	"Mod-Backspace": ym,
	Delete: ym,
	"Mod-Delete": ym
...
function xm(e, t) {
	return (n, r, i) => {
		if (!i) return !1;
		let a = n.selection;
		if (a instanceof pm) return bm(n, r, k.near(a.$headCell, t));
		if (e != "horiz" && !a.empty) return !1;
		let o = Cm(i, e, t);
		if (o == null) return !1;
		if (e == "horiz") return bm(n, r, k.near(n.doc.resolve(a.head + t), t));
		{
			let i = n.doc.resolve(o), a = dm(i, e, t), s;
			return s = a ? k.near(a, 1) : t < 0 ? k.near(n.doc.resolve(i.before(-1)), -1) : k.near(n.doc.resolve(i.after(-1)), 1), bm(n, r, s);
		}
	};
}
function Sm(e, t) {
	return (n, r, i) => {
		if (!i) return !1;
		let a = n.selection, o;
		if (a instanceof pm) o = a;
		else {
			let r = Cm(i, e, t);
			if (r == null) return !1;
			o = new pm(n.doc.resolve(r));
		}
		let s = dm(o.$headCell, e, t);
		return s ? bm(n, r, new pm(o.$anchorCell, s)) : !1;
	};
}
function Cm(e, t, n) {
	if (!(e.state.selection instanceof A)) return null;
...
var Tm = class {
	constructor({ editor: e, element: t, view: n, updateDelay: r = 250, resizeDelay: i = 60, shouldShow: a, appendTo: o, getReferencedVirtualElement: s, options: c }) {
		this.preventHide = !1, this.isVisible = !1, this.scrollTarget = window, this.floatingUIOptions = {
			...
			let { doc: i, selection: a } = t, { empty: o } = a, s = !i.textBetween(n, r).length && Jc(t.selection), c = this.element.contains(document.activeElement);
			...
			e.getMeta("bubbleMenu") === "updatePosition" && this.updatePosition();
	...
	get middlewares() {
		let e = [];
		return this.floatingUIOptions.flip && e.push(Gp(typeof this.floatingUIOptions.flip == "boolean" ? void 0 : this.floatingUIOptions.flip)), this.floatingUIOptions.shift && e.push(Wp(typeof this.floatingUIOptions.shift == "boolean" ? void 0 : this.floatingUIOptions.shift)), this.floatingUIOptions.offset && e.push(Hp(typeof this.floatingUIOptions.offset == "boolean" ? void 0 : this.floatingUIOptions.offset)), this.floatingUIOptions.arrow && e.push(Jp(this.floatingUIOptions.arrow)), this.floatingUIOptions.size && e.push(Kp(typeof this.floatingUIOptions.size == "boolean" ? void 0 : this.floatingUIOptions.size)), this.floatingUIOptions.autoPlacement && e.push(Up(typeof this.floatingUIOptions.autoPlacement == "boolean" ? void 0 : this.floatingUIOptions.autoPlacement)), this.floatingUIOptions.hide && e.push(qp(typeof this.floatingUIOptions.hide == "boolean" ? void 0 : this.floatingUIOptions.hide)), this.floatingUIOptions.inline && e.push(Yp(typeof this.floatingUIOptions.inline == "boolean" ? void 0 : this.floatingUIOptions.inline)), e;
	}
	get virtualElement() {
		let { selection: e } = this.editor.state, t = this.getReferencedVirtualElement?.call(this);
		if (t) return t;
		let n = Cu(this.view, e.from, e.to), r = {
		...
		if (e instanceof pm) {
			...
			if (!o || !s) return;
			let c = o === s ? o.getBoundingClientRect() : wm(o.getBoundingClientRect(), s.getBoundingClientRect());
			r = {
	...
	updatePosition() {
		...
		}).then(({ x: e, y: t, strategy: n }) => {
			this.element.style.width = "max-content", this.element.style.position = n, this.element.style.left = `${e}px`, this.element.style.top = `${t}px`, this.isVisible && this.floatingUIOptions.onUpdate && this.floatingUIOptions.onUpdate();
		});
	}
	update(e, t) {
...
K.create({
	...
	addProseMirrorPlugins() {
		return this.options.element ? [Em({
...
var Dm = s({
	...
	setup(e, { slots: t, attrs: n }) {
		...
		return g(() => {
			...
			u && (u.style.visibility = "hidden", u.style.position = "absolute", u.remove(), f(() => {
				t.registerPlugin(Em({
					editor: t,
					element: u,
					options: n,
	...
	constructor({ editor: e, element: t, view: n, options: r, appendTo: i, shouldShow: a }) {
		this.preventHide = !1, this.isVisible = !1, this.shouldShow = ({ view: e, state: t }) => {
			...
			...this.floatingUIOptions,
			...r
		}, this.element.tabIndex = 0, a && (this.shouldShow = a), this.element.addEventListener("mousedown", this.mousedownHandler, { capture: !0 }), this.editor.on("focus", this.focusHandler), this.editor.on("blur", this.blurHandler), this.update(n, n.state), this.getShouldShow() && (this.show(), this.updatePosition());
	}
	getTextContent(e) {
		return ru(e, { textSerializers: iu(this.editor.schema) });
	}
	get middlewares() {
		let e = [];
		return this.floatingUIOptions.flip && e.push(Gp(typeof this.floatingUIOptions.flip == "boolean" ? void 0 : this.floatingUIOptions.flip)), this.floatingUIOptions.shift && e.push(Wp(typeof this.floatingUIOptions.shift == "boolean" ? void 0 : this.floatingUIOptions.shift)), this.floatingUIOptions.offset && e.push(Hp(typeof this.floatingUIOptions.offset == "boolean" ? void 0 : this.floatingUIOptions.offset)), this.floatingUIOptions.arrow && e.push(Jp(this.floatingUIOptions.arrow)), this.floatingUIOptions.size && e.push(Kp(typeof this.floatingUIOptions.size == "boolean" ? void 0 : this.floatingUIOptions.size)), this.floatingUIOptions.autoPlacement && e.push(Up(typeof this.floatingUIOptions.autoPlacement == "boolean" ? void 0 : this.floatingUIOptions.autoPlacement)), this.floatingUIOptions.hide && e.push(qp(typeof this.floatingUIOptions.hide == "boolean" ? void 0 : this.floatingUIOptions.hide)), this.floatingUIOptions.inline && e.push(Yp(typeof this.floatingUIOptions.inline == "boolean" ? void 0 : this.floatingUIOptions.inline)), e;
	...
	updatePosition() {
		let { selection: e } = this.editor.state, t = Cu(this.view, e.from, e.to);
		Xp({
...
K.create({
	...
	addProseMirrorPlugins() {
		return this.options.element ? [km({
			pluginKey: this.options.pluginKey,
			editor: this.editor,
			element: this.options.element,
			options: this.options.options,
	...
	setup(e, { slots: t, attrs: n }) {
		let r = v(null);
		return g(() => {
			let { pluginKey: t, editor: n, options: i, appendTo: a, shouldShow: o } = e, s = r.value;
			s && (s.style.visibility = "hidden", s.style.position = "absolute", s.remove(), n.registerPlugin(km({
				pluginKey: t,
				editor: n,
				element: s,
				options: i,
...
var Am = zd.create({
	...
	parseMarkdown: (e, t) => {
		let n = e.tokens || [];
		return n.length === 1 && n[0].type === "image" ? t.parseChildren([n[0]]) : t.createNode("paragraph", void 0, t.parseInline(n));
	},
...
var Fm = class {
	...
	dragover(e) {
		...
		if (t && !i) {
			...
			if (this.editorView.dragging && this.editorView.dragging.slice) {
				let t = _n(this.editorView.state.doc, e, this.editorView.dragging.slice);
				t != null && (e = t);
			}
	...
	getBookmark() {
		return new Lm(this.anchor);
	}
	static valid(e) {
		let t = e.parent;
		if (t.isTextblock || !zm(e) || !Bm(e)) return !1;
...
Im.prototype.visible = !1, Im.findFrom = Im.findGapCursorFrom, k.jsonID("gapcursor", Im);
var Lm = class e {
	constructor(e) {
		this.pos = e;
	}
	...
	resolve(e) {
		...
		return Im.valid(t) ? new Im(t) : k.near(t);
	}
};
function Rm(e) {
...
function Vm() {
	return new M({ props: {
		...
		createSelectionBetween(e, t, n) {
			return t.pos == n.pos && Im.valid(n) ? new Im(n) : null;
		},
		handleClick: Wm,
		handleKeyDown: Hm,
...
var Hm = Sc({
	ArrowLeft: Um("horiz", -1),
	ArrowRight: Um("horiz", 1),
	ArrowUp: Um("vert", -1),
	ArrowDown: Um("vert", 1)
});
function Um(e, t) {
	...
	return function(e, r, i) {
		...
		let c = Im.findGapCursorFrom(o, t, s);
		return c ? (r && r(e.tr.setSelection(new Im(c))), !0) : !1;
	};
}
function Wm(e, t, n) {
	if (!e || !e.editable) return !1;
	let r = e.state.doc.resolve(t);
	if (!Im.valid(r)) return !1;
	let i = e.posAtCoords({
		left: n.clientX,
		top: n.clientY
	});
	return i && i.inside > -1 && j.isSelectable(e.state.doc.nodeAt(i.inside)) ? !1 : (e.dispatch(e.state.tr.setSelection(new Im(r))), !0);
}
function Gm(e, t) {
	if (t.inputType != "insertCompositionText" || !(e.state.selection instanceof Im)) return !1;
...
function Km(e) {
	if (!(e.selection instanceof Im)) return null;
	let t = document.createElement("div");
	return t.className = "ProseMirror-gapcursor", z.create(e.doc, [Ss.widget(e.selection.head, t, { key: "gapcursor" })]);
}
//#endregion
//#region node_modules/rope-sequence/dist/index.js
var qm = 200, J = function() {};
J.prototype.append = function(e) {
	return e.length ? (e = J.from(e), !this.length && e || e.length < qm && this.leafAppend(e) || this.length < qm && e.leafPrepend(this) || this.appendInner(e)) : this;
	...
	return e instanceof J ? e : e && e.length ? new Jm(e) : J.empty;
};
var Jm = /* @__PURE__ */ function(e) {
	...
	return t.prototype.flatten = function() {
		...
		if (this.length + e.length <= qm) return new t(this.values.concat(e.flatten()));
	}, t.prototype.leafPrepend = function(e) {
		if (this.length + e.length <= qm) return new t(e.flatten().concat(this.values));
...
var Ym = /* @__PURE__ */ function(e) {
	...
	popEvent(t, n) {
		...
		return this.items.forEach((t, n) => {
			...
			if (i) {
				...
				e && o.maybeStep(e).doc && (n = o.mapping.maps[o.mapping.maps.length - 1], l.push(new $m(n, void 0, void 0, l.length + u.length))), a--, n && i.appendMap(n, a);
	...
	addTransform(t, n, r, i) {
		...
		for (let e = 0; e < t.steps.length; e++) {
			let r = t.steps[e].invert(t.docs[e]), l = new $m(t.mapping.maps[e], r, n), u;
			(u = c && c.merge(l)) && (l = u, e ? a.pop() : s = s.slice(0, s.length - 1)), a.push(l), n &&= (o++, void 0), i || (c = l);
		}
		let l = o - r.depth;
		return l > th && (s = Qm(s, l), o -= l), new e(s.append(a), o);
	}
	remapping(e, t) {
		let n = new It();
	...
	addMaps(t) {
		return this.eventCount == 0 ? this : new e(this.items.append(t.map((e) => new $m(e))), this.eventCount);
	}
	rebased(t, n) {
		...
		this.items.forEach((e) => {
			...
			if (e.step) {
				...
				l && s++, r.push(new $m(i, o, l));
			} else r.push(new $m(i));
		}, i);
		let l = [];
		for (let e = n; e < o; e++) l.push(new $m(a.maps[e]));
		let u = this.items.slice(0, i).append(l).append(r), d = new e(u, s);
		return d.emptyItemCount() > Xm && (d = d.compress(this.items.length - r.length)), d;
	}
	emptyItemCount() {
		let e = 0;
		...
		return this.items.forEach((e, o) => {
			if (o >= t) i.push(e), e.selection && a++;
				...
				if (r--, o && n.appendMap(o, r), t) {
					...
					s && a++;
					let c = new $m(o.invert(), t, s), l, u = i.length - 1;
...
function nh(e, t, n, r) {
	let i = n.getMeta(uh), a;
	if (i) return i.historyState;
	n.getMeta(dh) && (e = new eh(e.done, e.undone, null, 0, -1));
	let o = n.getMeta("appendedTransaction");
	if (n.steps.length == 0) return e;
	if (o && o.getMeta(uh)) return o.getMeta(uh).redo ? new eh(e.done.addTransform(n, void 0, r, lh(t)), e.undone, ih(n.mapping.maps), e.prevTime, e.prevComposition) : new eh(e.done, e.undone.addTransform(n, void 0, r, lh(t)), null, e.prevTime, e.prevComposition);
	if (n.getMeta("addToHistory") !== !1 && !(o && o.getMeta("addToHistory") === !1)) {
		let i = n.getMeta("composition"), a = e.prevTime == 0 || !o && e.prevComposition != i && (e.prevTime < (n.time || 0) - r.newGroupDelay || !rh(n, e.prevRanges)), s = o ? ah(e.prevRanges, n.mapping) : ih(n.mapping.maps);
		return new eh(e.done.addTransform(n, a ? t.selection.getBookmark() : void 0, r, lh(t)), Zm.empty, s, n.time, i ?? e.prevComposition);
	}
	return (a = n.getMeta("rebased")) ? new eh(e.done.rebased(n, a), e.undone.rebased(n, a), ah(e.prevRanges, n.mapping), e.prevTime, e.prevComposition) : new eh(e.done.addMaps(n.mapping.maps), e.undone.addMaps(n.mapping.maps), ah(e.prevRanges, n.mapping), e.prevTime, e.prevComposition);
}
function rh(e, t) {
	if (!t) return !1;
...
function oh(e, t, n) {
	let r = lh(t), i = uh.get(t).spec.config, a = (n ? e.undone : e.done).popEvent(t, r);
	if (!a) return null;
	let o = a.selection.resolve(a.transform.doc), s = (n ? e.done : e.undone).addTransform(a.transform, t.selection.getBookmark(), i, r), c = new eh(n ? s : a.remaining, n ? a.remaining : s, null, 0, -1);
	return a.transform.setSelection(o).setMeta(uh, {
		redo: n,
		historyState: c
	});
}
...
var uh = new N("history"), dh = new N("closeHistory");
function fh(e = {}) {
	return e = {
		depth: e.depth || 100,
		...
		state: {
			init() {
				return new eh(Zm.empty, Zm.empty, null, 0, -1);
			},
			apply(t, n, r) {
				return nh(n, r, t, e);
			}
		...
		props: { handleDOMEvents: { beforeinput(e, t) {
			let n = t.inputType, r = n == "historyUndo" ? mh : n == "historyRedo" ? hh : null;
...
K.create({
	...
	addProseMirrorPlugins() {
		...
		return [new M({
			key: new N("selection"),
			props: { decorations(n) {
				return n.selection.empty || e.isFocused || !e.isEditable || Su(n.selection) || e.view.dragging ? null : z.create(n.doc, [Ss.inline(n.selection.from, n.selection.to, { class: t.className })]);
			} }
		})];
	}
});
function _h({ types: e, node: t }) {
...
K.create({
	...
	addProseMirrorPlugins() {
		let e = new N(this.name), t = this.editor.schema.topNodeType.contentMatch.defaultType?.name || this.options.node || "paragraph", n = Object.entries(this.editor.schema.nodes).map(([, e]) => e).filter((e) => (this.options.notAfter || []).concat(t).includes(e.name));
		return [new M({
			key: e,
...
var vh = K.create({
	...
	addCommands() {
		return {
			undo: () => ({ state: e, dispatch: t }) => mh(e, t),
			redo: () => ({ state: e, dispatch: t }) => hh(e, t)
		};
	},
	addProseMirrorPlugins() {
		return [fh(this.options)];
	},
	addKeyboardShortcuts() {
		return {
...
}, bh = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/, xh = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g, Sh = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/, Ch = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g, wh = td.create({
	name: "bold",
	addOptions() {
		return { HTMLAttributes: {} };
	},
	...
	renderHTML({ HTMLAttributes: e }) {
		return /* @__PURE__ */ yh("strong", {
			...G(this.options.HTMLAttributes, e),
			children: /* @__PURE__ */ yh("slot", {})
		});
	},
...
}), Th = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/, Eh = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))/g, Dh = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/, Oh = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g, kh = td.create({
	name: "italic",
	addOptions() {
		return { HTMLAttributes: {} };
	},
...
}), jh = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/, Mh = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))/g, Nh = td.create({
	name: "strike",
	addOptions() {
		return { HTMLAttributes: {} };
	},
...
}), Ph = Object.defineProperty, Fh = (e, t) => {
	for (var n in t) Ph(e, n, {
		get: t[n],
		enumerable: !0
	});
}, Ih = "listItem", Lh = "textStyle", Rh = /^\s*([-+*])\s$/, zh = zd.create({
	name: "bulletList",
	addOptions() {
		return {
	...
	addCommands() {
		return { toggleBulletList: () => ({ commands: e, chain: t }) => this.options.keepAttributes ? t().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(Ih, this.editor.getAttributes(Lh)).run() : e.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks) };
	},
	addKeyboardShortcuts() {
	...
	addInputRules() {
		...
		return (this.options.keepMarks || this.options.keepAttributes) && (e = Dd({
			find: Rh,
			type: this.type,
	...
	parseMarkdown: (e, t) => {
		...
		if (e.tokens && e.tokens.length > 0) {
			if (e.tokens.some((e) => e.type === "paragraph")) n = t.parseChildren(e.tokens);
			else {
				let r = e.tokens[0];
	...
	renderMarkdown: (e, t, n) => Ld(e, t, (e) => e.parentType === "bulletList" ? "- " : e.parentType === "orderedList" ? `${e.index + 1}. ` : "- ", n),
	addKeyboardShortcuts() {
		return {
...
Fh({}, {
	...
	hasListBefore: () => Uh,
	hasListItemAfter: () => Xh,
	hasListItemBefore: () => Wh,
	listItemHasSubList: () => Gh,
	nextListIsDeeper: () => qh,
	nextListIsHigher: () => Jh
});
var Vh = (e, t) => {
	...
	if (!yl(e.state, t) && Uh(e.state, t, n)) {
	...
	if (!yl(e.state, t) || !vu(e.state)) return !1;
	let r = Vh(t, e.state);
	if (!r) return !1;
	let i = e.state.doc.resolve(r.$pos.pos - 2).node(r.depth), a = Gh(t, e.state, i);
	return Wh(t, e.state) && !a ? e.commands.joinItemBackward() : e.chain().liftListItem(t).run();
}, qh = (e, t) => {
	let n = Hh(e, t), r = Vh(e, t);
	return !r || !n ? !1 : n > r.depth;
}, Jh = (e, t) => {
	let n = Hh(e, t), r = Vh(e, t);
	return !r || !n ? !1 : n < r.depth;
}, Yh = (e, t) => {
	if (!yl(e.state, t) || !_u(e.state, t)) return !1;
	let { selection: n } = e.state, { $from: r, $to: i } = n;
	return !n.empty && r.sameParent(i) ? !1 : qh(t, e.state) ? e.chain().focus(e.state.selection.from + 4).lift(t).joinBackward().run() : Jh(t, e.state) ? e.chain().joinForward().joinBackward().run() : e.commands.joinItemForward();
}, Xh = (e, t) => {
		...
		return {
			Delete: ({ editor: e }) => {
				...
				return this.options.listTypes.forEach(({ itemName: n }) => {
					e.state.schema.nodes[n] !== void 0 && Yh(e, n) && (t = !0);
				}), t;
			},
			"Mod-Delete": ({ editor: e }) => {
				let t = !1;
			...
			Backspace: ({ editor: e }) => {
				...
				return this.options.listTypes.forEach(({ itemName: n, wrapperNames: r }) => {
					e.state.schema.nodes[n] !== void 0 && Kh(e, n, r) && (t = !0);
				}), t;
			},
...
function tg(e, t, n) {
	...
	for (; i < e.length;) {
		...
		if (a.indent === t) {
			...
			if (d.length > 0) {
				let e = tg(d, Math.min(...d.map((e) => e.indent)), n);
				c.push({
					type: "list",
					ordered: !0,
					start: d[0].number,
...
var rg = "listItem", ig = "textStyle", ag = /^(\d+)\.\s$/, og = zd.create({
	name: "orderedList",
	addOptions() {
		return {
			itemTypeName: "listItem",
	...
	parseMarkdown: (e, t) => {
		...
		let n = e.start || 1, r = e.items ? ng(e.items, t) : [];
		return n === 1 ? {
			type: "orderedList",
			content: r
		} : {
	...
	markdownOptions: { indentsContent: !0 },
	addCommands() {
		return { toggleOrderedList: () => ({ commands: e, chain: t }) => this.options.keepAttributes ? t().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(rg, this.editor.getAttributes(ig)).run() : e.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks) };
	},
	addKeyboardShortcuts() {
	...
	addInputRules() {
		...
		return (this.options.keepMarks || this.options.keepAttributes) && (e = Dd({
			...
			getAttributes: (e) => ({
				start: +e[1],
				...this.editor.getAttributes(ig)
			}),
			joinPredicate: (e, t) => t.childCount + t.attrs.start === +e[1],
			editor: this.editor
		})), [e];
	}
}), sg = /^\s*(\[([( |x])?\])\s$/, cg = zd.create({
	name: "taskItem",
	addOptions() {
		return {
			nested: !1,
	...
	renderMarkdown: (e, t) => Ld(e, t, `- [${e.attrs?.checked ? "x" : " "}] `),
	addKeyboardShortcuts() {
		let e = {
			Enter: () => this.editor.commands.splitListItem(this.name),
			"Shift-Tab": () => this.editor.commands.liftListItem(this.name)
	...
	addNodeView() {
		return ({ node: e, HTMLAttributes: t, getPos: n, editor: r }) => {
			...
			return l(e), a.contentEditable = "false", s.type = "checkbox", s.addEventListener("mousedown", (e) => e.preventDefault()), s.addEventListener("change", (t) => {
				...
				dom: i,
				contentDOM: c,
				update: (e) => e.type === this.type && (i.dataset.checked = e.attrs.checked, s.checked = e.attrs.checked, l(e), !0)
			};
		};
	},
	addInputRules() {
...
K.create({
	...
	addExtensions() {
		let e = [];
		return this.options.bulletList !== !1 && e.push(zh.configure(this.options.bulletList)), this.options.listItem !== !1 && e.push(Bh.configure(this.options.listItem)), this.options.listKeymap !== !1 && e.push(Zh.configure(this.options.listKeymap)), this.options.orderedList !== !1 && e.push(og.configure(this.options.orderedList)), this.options.taskItem !== !1 && e.push(cg.configure(this.options.taskItem)), this.options.taskList !== !1 && e.push(lg.configure(this.options.taskList)), e;
	}
});
var ug = zd.create({
	name: "heading",
	...
	addInputRules() {
		return this.options.levels.map((e) => Ed({
	...
	addCommands() {
		return { setHorizontalRule: () => ({ chain: e, state: t }) => {
			if (!Od(t, t.schema.nodes[this.name])) return !1;
			let { selection: n } = t, { $to: r } = n, i = e();
			return Su(n) ? i.insertContentAt(r.pos, { type: this.name }) : i.insertContent({ type: this.name }), i.command(({ state: e, tr: t, dispatch: n }) => {
				if (n) {
...
}), hg = "ö", gg = "ελ1υ2бг1ел3дети4ею2католик6ом3мкд2он1сква6онлайн5рг3рус2ф2сайт3рб3укр3қаз3հայ3ישראל5קום3ابوظبي5رامكو5لاردن4بحرين5جزائر5سعودية6عليان5مغرب5مارات5یران5بارت2زار4يتك3ھارت5تونس4سودان3رية5شبكة4عراق2ب2مان4فلسطين6قطر3كاثوليك6وم3مصر2ليسيا5وريتانيا7قع4همراه5پاکستان7ڀارت4कॉम3नेट3भारत0म्3ोत5संगठन5বাংলা5ভারত2ৰত4ਭਾਰਤ4ભારત4ଭାରତ4இந்தியா6லங்கை6சிங்கப்பூர்11భారత్5ಭಾರತ4ഭാരതം5ලංකා4คอม3ไทย3ລາວ3გე2みんな3アマゾン4クラウド4グーグル4コム2ストア3セール3ファッション6ポイント4世界2中信1国1國1文网3亚马逊3企业2佛山2信息2健康2八卦2公司1益2台湾1灣2商城1店1标2嘉里0大酒店5在线2大拿2天主教3娱乐2家電2广东2微博2慈善2我爱你3手机2招聘2政务1府2新加坡2闻2时尚2書籍2机构2淡马锡3游戏2澳門2点看2移动2组织机构4网址1店1站1络2联通2谷歌2购物2通販2集团2電訊盈科4飞利浦3食品2餐厅2香格里拉3港2닷넷1컴2삼성2한국2", _g = "numeric", vg = "ascii", yg = "alpha", bg = "asciinumeric", xg = "alphanumeric", Sg = "domain", Cg = "emoji", wg = "scheme", Tg = "slashscheme", Eg = "whitespace";
function Dg(e, t) {
	return e in t || (t[e] = []), t[e];
}
function Og(e, t, n) {
	t[_g] && (t[bg] = !0, t[xg] = !0), t[vg] && (t[bg] = !0, t[yg] = !0), t[bg] && (t[xg] = !0), t[yg] && (t[xg] = !0), t[xg] && (t[Sg] = !0), t[Cg] && (t[Sg] = !0);
	for (let r in t) {
		let t = Dg(r, n);
...
Y.groups = {}, Y.prototype = {
	...
	tr(e, t, n, r) {
		r ||= Y.groups;
		let i;
		return t && t.j ? i = t : (i = new Y(t), n && r && Og(t, n, r)), this.jr.push([e, i]), i;
	},
	ts(e, t, n, r) {
	...
	tt(e, t, n, r) {
		...
		let a = t, o, s = i.go(e);
		return s ? (o = new Y(), Object.assign(o.j, s.j), o.jr.push.apply(o.jr, s.jr), o.jd = s.jd, o.t = s.t) : o = new Y(), a && (r && (o.t && typeof o.t == "string" ? Og(a, Object.assign(kg(o.t, r), n), r) : n && Og(a, n, r)), o.t = a), i.j[e] = o, o;
	}
};
var X = (e, t, n, r, i) => e.ta(t, n, r, i), Z = (e, t, n, r, i) => e.tr(t, n, r, i), Ag = (e, t, n, r, i) => e.ts(t, n, r, i), Q = (e, t, n, r, i) => e.tt(t, n, r, i), jg = "WORD", Mg = "UWORD", Ng = "ASCIINUMERICAL", Pg = "ALPHANUMERICAL", Fg = "LOCALHOST", Ig = "TLD", Lg = "UTLD", Rg = "SCHEME", zg = "SLASH_SCHEME", Bg = "NUM", Vg = "WS", Hg = "NL", Ug = "OPENBRACE", Wg = "CLOSEBRACE", Gg = "OPENBRACKET", Kg = "CLOSEBRACKET", qg = "OPENPAREN", Jg = "CLOSEPAREN", Yg = "OPENANGLEBRACKET", Xg = "CLOSEANGLEBRACKET", Zg = "FULLWIDTHLEFTPAREN", Qg = "FULLWIDTHRIGHTPAREN", $g = "LEFTCORNERBRACKET", e_ = "RIGHTCORNERBRACKET", t_ = "LEFTWHITECORNERBRACKET", n_ = "RIGHTWHITECORNERBRACKET", r_ = "FULLWIDTHLESSTHAN", i_ = "FULLWIDTHGREATERTHAN", a_ = "AMPERSAND", o_ = "APOSTROPHE", s_ = "ASTERISK", c_ = "AT", l_ = "BACKSLASH", u_ = "BACKTICK", d_ = "CARET", f_ = "COLON", p_ = "COMMA", m_ = "DOLLAR", h_ = "DOT", g_ = "EQUALS", __ = "EXCLAMATION", v_ = "HYPHEN", y_ = "PERCENT", b_ = "PIPE", x_ = "PLUS", S_ = "POUND", C_ = "QUERY", w_ = "QUOTE", T_ = "FULLWIDTHMIDDLEDOT", E_ = "SEMI", D_ = "SLASH", O_ = "TILDE", k_ = "UNDERSCORE", A_ = "EMOJI", j_ = "SYM", M_ = /*#__PURE__*/ Object.freeze({
	__proto__: null,
	ALPHANUMERICAL: Pg,
	AMPERSAND: a_,
	APOSTROPHE: o_,
	...
	EQUALS: g_,
	EXCLAMATION: __,
	FULLWIDTHGREATERTHAN: i_,
	FULLWIDTHLEFTPAREN: Zg,
	FULLWIDTHLESSTHAN: r_,
	FULLWIDTHMIDDLEDOT: T_,
	FULLWIDTHRIGHTPAREN: Qg,
	HYPHEN: v_,
	LEFTCORNERBRACKET: $g,
	LEFTWHITECORNERBRACKET: t_,
	LOCALHOST: Fg,
	NL: Hg,
	NUM: Bg,
	OPENANGLEBRACKET: Yg,
	...
	QUERY: C_,
	QUOTE: w_,
	RIGHTCORNERBRACKET: e_,
	RIGHTWHITECORNERBRACKET: n_,
	SCHEME: Rg,
	SEMI: E_,
	SLASH: D_,
	SLASH_SCHEME: zg,
	...
	WORD: jg,
	WS: Vg
}), N_ = /[a-z]/, P_ = /\p{L}/u, F_ = /\p{Emoji}/u, I_ = /\d/, L_ = /\s/, R_ = "\r", z_ = "\n", B_ = "️", V_ = "‍", H_ = "￼", U_ = null, W_ = null;
function G_(e = []) {
	let t = {};
	Y.groups = t;
	let n = new Y();
	U_ ??= Y_(hg), W_ ??= Y_(gg), Q(n, "'", o_), Q(n, "{", Ug), Q(n, "}", Wg), Q(n, "[", Gg), Q(n, "]", Kg), Q(n, "(", qg), Q(n, ")", Jg), Q(n, "<", Yg), Q(n, ">", Xg), Q(n, "（", Zg), Q(n, "）", Qg), Q(n, "「", $g), Q(n, "」", e_), Q(n, "『", t_), Q(n, "』", n_), Q(n, "＜", r_), Q(n, "＞", i_), Q(n, "&", a_), Q(n, "*", s_), Q(n, "@", c_), Q(n, "`", u_), Q(n, "^", d_), Q(n, ":", f_), Q(n, ",", p_), Q(n, "$", m_), Q(n, ".", h_), Q(n, "=", g_), Q(n, "!", __), Q(n, "-", v_), Q(n, "%", y_), Q(n, "|", b_), Q(n, "+", x_), Q(n, "#", S_), Q(n, "?", C_), Q(n, "\"", w_), Q(n, "/", D_), Q(n, ";", E_), Q(n, "~", O_), Q(n, "_", k_), Q(n, "\\", l_), Q(n, "・", T_);
	let r = Z(n, I_, Bg, { [_g]: !0 });
	Z(r, I_, r);
	let i = Z(r, N_, Ng, { [bg]: !0 }), a = Z(r, P_, Pg, { [xg]: !0 }), o = Z(n, N_, jg, { [vg]: !0 });
	Z(o, I_, i), Z(o, N_, o), Z(i, I_, i), Z(i, N_, i);
	let s = Z(n, P_, Mg, { [yg]: !0 });
	Z(s, N_), Z(s, I_, a), Z(s, P_, s), Z(a, I_, a), Z(a, N_), Z(a, P_, a);
	let c = Q(n, z_, Hg, { [Eg]: !0 }), l = Q(n, R_, Vg, { [Eg]: !0 }), u = Z(n, L_, Vg, { [Eg]: !0 });
	Q(n, H_, u), Q(l, z_, c), Q(l, H_, u), Z(l, L_, u), Q(u, R_), Q(u, z_), Z(u, L_, u), Q(u, H_, u);
	let d = Z(n, F_, A_, { [Cg]: !0 });
	Q(d, "#"), Z(d, F_, d), Q(d, B_, d);
	let f = Q(d, V_);
	Q(f, "#"), Z(f, F_, d);
	let p = [[N_, o], [I_, i]], m = [
		[N_, null],
	...
	for (let e = 0; e < U_.length; e++) J_(n, U_[e], Ig, jg, p);
	for (let e = 0; e < W_.length; e++) J_(n, W_[e], Lg, Mg, m);
	Og(Ig, {
		tld: !0,
		ascii: !0
	}, t), Og(Lg, {
		utld: !0,
		alpha: !0
	}, t), J_(n, "file", Rg, jg, p), J_(n, "mailto", Rg, jg, p), J_(n, "http", zg, jg, p), J_(n, "https", zg, jg, p), J_(n, "ftp", zg, jg, p), J_(n, "ftps", zg, jg, p), Og(Rg, {
		scheme: !0,
		ascii: !0
	}, t), Og(zg, {
		slashscheme: !0,
	...
	for (let t = 0; t < e.length; t++) {
		let r = e[t][0], i = e[t][1] ? { [wg]: !0 } : { [Tg]: !0 };
		r.indexOf("-") >= 0 ? i[Sg] = !0 : N_.test(r) ? I_.test(r) ? i[bg] = !0 : i[vg] = !0 : i[_g] = !0, Ag(n, r, r, i);
	}
	return Ag(n, "localhost", Fg, { ascii: !0 }), n.jd = new Y(j_), {
		start: n,
		tokens: Object.assign({ groups: t }, M_)
	};
}
function K_(e, t) {
	let n = q_(t.replace(/[A-Z]/g, (e) => e.toLowerCase())), r = n.length, i = [], a = 0, o = 0;
	for (; o < r;) {
...
function Z_(e, t = null) {
	let n = Object.assign({}, X_);
	e && (n = Object.assign(n, e instanceof Z_ ? e.o : e));
...
Z_.prototype = {
	...
	get(e, t, n) {
		...
		return i && (typeof i == "object" ? (i = n.t in i ? i[n.t] : X_[e], typeof i == "function" && r && (i = i(t, n))) : typeof i == "function" && r && (i = i(t, n.t, n)), i);
	},
	getObj(e, t, n) {
		let r = this.o[e];
...
}), nv = ev("text"), rv = ev("nl"), iv = ev("url", {
	isLink: !0,
	toHref(e = X_.defaultProtocol) {
		return this.hasProtocol() ? this.v : `${e}://${this.v}`;
	},
	hasProtocol() {
		let e = this.tk;
		return e.length >= 2 && e[0].t !== Fg && e[1].t === f_;
	}
}), av = (e) => new Y(e);
function ov({ groups: e }) {
	...
	X(f, e.domain, d);
	let p = av(tv);
	X(f, e.tld, p), X(f, e.utld, p), Q(l, Fg, p);
	let m = Q(d, v_);
	Q(m, v_, m), X(m, e.domain, d), X(p, e.domain, d), Q(p, h_, f), Q(p, v_, m), X(Q(p, f_), e.numeric, tv);
	let h = Q(o, v_), g = Q(o, h_);
	Q(h, v_, h), X(h, e.domain, o), X(g, r, a), X(g, e.domain, o);
	let _ = av(iv);
	X(g, e.tld, _), X(g, e.utld, _), X(_, e.domain, o), X(_, r, a), Q(_, h_, g), Q(_, v_, h), Q(_, c_, l);
	let v = Q(_, f_), y = av(iv);
	X(v, e.numeric, y);
	let b = av(iv), x = av();
	X(b, t, b), X(b, n, x), X(x, t, b), X(x, n, x), Q(_, D_, b), Q(y, D_, b);
	let ee = Q(s, f_), S = Q(Q(Q(c, f_), D_), D_);
	X(s, e.domain, o), Q(s, h_, g), Q(s, v_, h), X(c, e.domain, o), Q(c, h_, g), Q(c, v_, h), X(ee, e.domain, b), Q(ee, D_, b), Q(ee, C_, b), X(S, e.domain, b), X(S, t, b), Q(S, D_, b);
	let te = [
		[Ug, Wg],
		[Gg, Kg],
		[qg, Jg],
...
function sv(e, t, n) {
	...
	for (; i < r;) {
		...
		if (f < 0) i -= u, i < r && (o.push(n[i]), i++);
			...
			o.length > 0 && (a.push(cv(nv, t, o)), o = []), i -= f, u -= f;
			let e = d.t, r = n.slice(i - u, i);
			a.push(cv(e, t, r));
		}
	}
	return o.length > 0 && a.push(cv(nv, t, o)), a;
}
function cv(e, t, n) {
	let r = n[0].s, i = n[n.length - 1].e;
	return new e(t.slice(r, i), n);
}
var lv = typeof console < "u" && console && console.warn || (() => {}), uv = "until manual call of linkify.init(). Register all schemes and plugins before invoking linkify the first time.", $ = {
	scanner: null,
	parser: null,
	tokenQueue: [],
	pluginQueue: [],
...
function fv(e, t = !1) {
	if ($.initialized && lv(`linkifyjs: already initialized - will not register custom scheme "${e}" ${uv}`), !/^[0-9a-z]+(-[0-9a-z]+)*$/.test(e)) throw Error("linkifyjs: incorrect scheme format.\n1. Must only contain digits, lowercase ASCII letters or \"-\"\n2. Cannot start or end with \"-\"\n3. \"-\" cannot repeat");
	$.customSchemes.push([e, t]);
}
function pv() {
	$.scanner = G_($.customSchemes);
	for (let e = 0; e < $.tokenQueue.length; e++) $.tokenQueue[e][1]({ scanner: $.scanner });
	$.parser = ov($.scanner.tokens);
...
function mv(e) {
	return $.initialized || pv(), sv($.parser.start, e, K_($.scanner.start, e));
}
mv.scan = K_;
function hv(e, t = null, n = null) {
	if (t && typeof t == "object") {
		if (n) throw Error(`linkifyjs: Invalid link type ${t}; must be a string`);
		n = t, t = null;
	}
	let r = new Z_(n), i = mv(e), a = [];
	for (let e = 0; e < i.length; e++) {
		let n = i[e];
...
var gv = "[\0- \xA0 ᠎ -\u2029 　]", _v = new RegExp(gv), vv = RegExp(`${gv}$`), yv = new RegExp(gv, "g");
function bv(e) {
...
function xv(e) {
	return new M({
		...
		appendTransaction: (t, n, r) => {
			...
			if (!i || a) return;
			let { tr: o } = r;
			if (lu(Ll(n.doc, [...t])).forEach(({ newRange: t }) => {
				...
				if (i && a) {
					let t = a.split(_v).filter(Boolean);
					if (t.length <= 0) return !1;
					let n = t[t.length - 1], s = i.pos + a.lastIndexOf(n);
					if (!n) return !1;
					let c = mv(n).map((t) => t.toObject(e.defaultProtocol));
					if (!bv(c)) return !1;
					c.filter((e) => e.isLink).map((e) => ({
						...
						uu(t.from, t.to, r.doc).some((t) => t.mark.type === e.type) || o.addMark(t.from, t.to, e.type.create({ href: t.href }));
					});
				}
	...
	return new M({
		...
		props: { handleClick: (t, n, r) => {
			...
			if (r.target instanceof HTMLAnchorElement) i = r.target;
				...
				let e = r.target, t = [];
				for (; e.nodeName !== "DIV";) t.push(e), e = e.parentNode;
				i = t.find((e) => e.nodeName === "A");
			}
			if (!i) return !1;
			let a = ou(t.state, e.type.name), o = i?.href ?? a.href, s = i?.target ?? a.target;
			return e.enableClickSelection && e.editor.commands.extendMarkRange(e.type.name), i && o ? (window.open(o, s), !0) : !1;
		} }
	});
}
function Cv(e) {
	return new M({
		...
		props: { handlePaste: (t, n, r) => {
			...
			let l = hv(c, { defaultProtocol: e.defaultProtocol }).find((e) => e.isLink && e.value === c);
			return !c || !l || i !== void 0 && !i(l.href) ? !1 : e.editor.commands.setMark(e.type, { href: l.href });
		} }
	});
}
function wv(e, t) {
	...
	return t && t.forEach((e) => {
		...
		t && n.push(t);
	}), !e || e.replace(yv, "").match(RegExp(`^(?:(?:${n.join("|")}):|[^a-z]|[a-z0-9+.-]+(?:[^a-z+.-:]|$))`, "i"));
}
var Tv = td.create({
	name: "link",
	priority: 1e3,
	...
	addOptions() {
		return {
			...
			isAllowedUri: (e, t) => !!wv(e, t.protocols),
			validate: (e) => !!e,
			shouldAutoLink: (e) => !!e
		};
	},
		...
		return [{
			...
			getAttrs: (e) => {
				...
				return !t || !this.options.isAllowedUri(t, {
					defaultValidate: (e) => !!wv(e, this.options.protocols),
	...
	addPasteRules() {
		return [Bd({
			find: (e) => {
				let t = [];
				if (e) {
					let { protocols: n, defaultProtocol: r } = this.options, i = hv(e).filter((e) => e.isLink && this.options.isAllowedUri(e.value, {
						defaultValidate: (e) => !!wv(e, n),
						protocols: n,
						defaultProtocol: r
					}));
	...
	addProseMirrorPlugins() {
		...
		return this.options.autolink && e.push(xv({
			type: this.type,
			defaultProtocol: this.options.defaultProtocol,
			validate: (e) => this.options.isAllowedUri(e, {
				defaultValidate: (e) => !!wv(e, t),
				protocols: t,
				defaultProtocol: n
			}),
			shouldAutoLink: this.options.shouldAutoLink
		})), this.options.openOnClick === !0 && e.push(Sv({
			type: this.type,
			editor: this.editor,
			enableClickSelection: this.options.enableClickSelection
		})), this.options.linkOnPaste && e.push(Cv({
			editor: this.editor,
			defaultProtocol: this.options.defaultProtocol,
			type: this.type,
			shouldAutoLink: this.options.shouldAutoLink
	...
	key: 0,
	class: "v-wysiwyg"
}, kv = { class: "toolbar" }, Av = { class: "button-group" }, jv = ["title", "aria-label"], Mv = ["data-replicated-value"], Nv = { class: "toolbar" }, Pv = [
	"aria-pressed",
	"disabled",
	"aria-disabled",
	"title",
	...
	setup(o) {
		let s = v(!1), c = ee(o, "modelValue"), l = o, u = mg.configure({ types: ["heading", "paragraph"] }), d = Tv.configure({
			openOnClick: !1,
			...l.linkConfiguration
		}), f = {
			bold: {
		...
		}, h = l.toolbar.flat().flatMap((e) => f[e].extensions).filter((e, t, n) => n.indexOf(e) === t), g = zd.create({
			name: "info-block",
			content: "block+",
			group: "block",
			defining: !0,
		...
		let ne = function(e) {
			...
			return Vl((t) => bu(t.type.name, e.extensionManager.extensions))(e.state.selection)?.node?.type.name;
		};
		return (l, u) => x(b) ? (_(), r("div", Ov, [x(s) ? (_(), r(e, { key: 0 }, [i("div", kv, [u[2] ||= i("div", { class: "button-group gap" }, null, -1), i("div", Av, [i("button", {
			type: "button",
		...
		}, null, 4), [[S, c.value]])], 8, Mv)], 64)) : (_(), r(e, { key: 1 }, [
			i("div", Nv, [(_(!0), r(e, null, y(o.toolbar, (t) => (_(), r("div", { class: p(["button-group", { gap: t.length === 0 }]) }, [(_(!0), r(e, null, y(t, (e) => (_(), r("button", {
				type: "button",
				key: e,
			...
			x(b) && o.bubbleToolbar ? (_(), t(x(Dm), {
				key: 0,
				editor: x(b)
			}, {
				default: re(() => [i("div", Fv, [(_(!0), r(e, null, y(o.bubbleToolbar, (t) => (_(), r("div", { class: p(["button-group", { gap: t.length === 0 }]) }, [(_(!0), r(e, null, y(t, (e) => (_(), r("button", {
					type: "button",
					key: e,
					class: p([f[e].class, { "is-active": f[e].active?.(x(b)) }]),
					"aria-pressed": f[e].active?.(x(b)),
	...
	infoBlock: "Information"
}, Bv = { install: function(e, t) {
	e.component("v-wysiwyg", Lv), VertigoUi.lang.enUS.wysiwyg = Rv, VertigoUi.lang.fr.wysiwyg = zv;
} };
window && (window.WYSIWYG = Bv);
//#endregion
export { Bv as default };

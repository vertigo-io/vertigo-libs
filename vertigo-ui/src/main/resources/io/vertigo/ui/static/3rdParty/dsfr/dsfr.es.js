...
const Tv = /* @__PURE__ */ Ae(lv, [["render", Dv], ["__scopeId", "data-v-628fafbe"]]), fa = () => {
  ...
  setup(a, { emit: t }) {
    ...
    let W = (A) => {
      ...
      d.value.includes(O) ? d.value.splice(d.value.indexOf(O), 1) : (d.value.push(O), p.value.length === 1 && (x.value = "", p.value = o.options)), B("update:model-value");
    };
    return (A, O) => {
      const ee = Te("v-icon");
      return i(), f(z, null, [
...
}), Jv = /* @__PURE__ */ Ae(Zv, [["__scopeId", "data-v-a038ccc5"]]), eg = ["id", "onKeydown", "aria-disabled", "aria-controls", "aria-expanded"], tg = ["id", "aria-labelledby", "onKeydown"], ag = {
  key: 0,
  class: "fr-label fr-mb-0"
}, ng = {
  key: 0,

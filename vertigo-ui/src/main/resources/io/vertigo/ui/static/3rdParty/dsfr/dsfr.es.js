...
const yt = Symbol("accordions"), kt = Symbol("header"), Ge = Symbol("tabs"), be = () => {
  ...
  setup(t) {
    const e = t, {
      ...
      doExpand: o,
      onTransitionEnd: r
    } = be(), i = O(), u = De(yt), { isActive: c, expand: p } = (u == null ? void 0 : u($e(() => e.title))) ?? { isActive: i, expand: () => i.value = !i.value };
    return ne(() => {
      c.value && o(!0);
    }), ae(c, (g, _) => {
      g !== _ && o(g);
      ...
      d("div", {
        ...
        onTransitionend: _[1] || (_[1] = (x) => F(r)(F(c)))
      }, [
        A(g.$slots, "default")
      ], 42, bl)
    ]));
...
}), xl = ["aria-label"], Cl = ["aria-expanded", "aria-controls"], Tl = ["id"], El = { class: "fr-breadcrumb__list" }, Sl = ["aria-current"], Ll = /* @__PURE__ */ M({
...
function vn(t, e, a, n) {
  ...
  const i = Date.now();
  let u = "pending", c = 0, p, g = null, _ = [], x = [];
  ...
  function v(m, T) {
    T && (x = []), typeof m == "function" && x.push(m);
  }
  function S() {
    return {
      startTime: i,
...
const Dn = (t, e) => {
  ...
  return n.pending.forEach((u) => {
    ...
    const { provider: c, prefix: p, name: g } = u, _ = we(c, p), x = _.pendingIcons || (_.pendingIcons = /* @__PURE__ */ new Set());
    x.has(g) || (x.add(g), l[c][p].push(g));
  }), o.forEach((u) => {
    const { provider: c, prefix: p } = u;
...
const Ut = (t, e) => {
  ...
  const { body: p, width: g, height: _ } = t, x = l === "mask" || (l === "bg" ? !1 : p.indexOf("currentColor") !== -1), B = En(p, {
    ...c,
    width: g + "",
    height: _ + ""
  });
...
const Fn = {
  ...
  setup(t) {
    ...
    async function o() {
      ...
      if (!((u = a.value) != null && u.$el))
        return;
      const _ = !!((c = a.value) == null ? void 0 : c.$el).querySelector("title"), x = document.createElement("title");
      if (!e.title) {
        x.remove();
        return;
      }
      x.innerHTML = e.title, await ua(), _ || (g = ((p = a.value) == null ? void 0 : p.$el).firstChild) == null || g.before(x);
    }
    ne(o);
    const r = w(() => {
      var u;
  ...
  setup(t) {
    const e = t, a = O(null), n = w(() => ["sm", "small"].includes(e.size)), l = w(() => ["md", "medium"].includes(e.size)), o = w(() => ["lg", "large"].includes(e.size)), r = w(() => ["always", "", !0].includes(e.inlineLayoutWhen)), i = w(() => ["sm", "small"].includes(e.inlineLayoutWhen)), u = w(() => ["md", "medium"].includes(e.inlineLayoutWhen)), c = w(() => ["lg", "large"].includes(e.inlineLayoutWhen)), p = w(() => e.align === "center"), g = w(() => e.align === "right"), _ = O("auto"), x = w(() => `--equisized-width: ${_.value};`), B = async () => {
      var P;
      let v = 0;
    ...
    return ne(async () => {
      ...
      (s(!0), f(K, null, W(P.buttons, ({ onClick: S, ...C }, L) => (s(), f("li", { key: L }, [
        X(Fe, q({ ref_for: !0 }, C, { onClick: S }), null, 16, ["onClick"])
      ]))), 128)),
      A(P.$slots, "default")
    ], 6));
  }
  ...
  setup(t) {
    ...
    return (l, o) => (s(), f("div", {
      ...
      l.button ? (s(), R(Fe, ue(q({ key: 2 }, l.button)), null, 16)) : h("", !0),
      ...
      return s(), f("div", {
        ...
        d("div", Kn, [
          ...
          c.buttons.length || c.linksGroup.length ? (s(), f("div", Xn, [
            ...
            c.linksGroup.length ? (s(), f("ul", Yn, [
              (s(!0), f(K, null, W(c.linksGroup, (_, x) => (s(), f("li", {
                key: `card-link-${x}`
              }, [
                _.to ? (s(), R(g, {
                  key: 0,
        ...
        c.imgSrc || c.badges.length ? (s(), f("div", Jn, [
          ...
          c.badges.length ? (s(), f("ul", ao, [
            (s(!0), f(K, null, W(c.badges, (_, x) => (s(), f("li", { key: x }, [
...
}, wo = { class: "fr-pagination__list" }, _o = ["href", "title", "disabled", "aria-disabled"], Io = ["href", "title", "disabled", "aria-disabled"], Do = ["href", "title", "aria-current", "onClick"], Bo = { key: 0 }, xo = { key: 1 }, Co = ["href", "title", "disabled", "aria-disabled"], To = ["href", "title", "disabled", "aria-disabled"], Eo = /* @__PURE__ */ M({
  ...
  setup(t, { emit: e }) {
    const a = t, n = e, l = w(() => Math.min(a.pages.length - 1 - a.truncLimit, Math.max(a.currentPage - (a.truncLimit - a.truncLimit % 2) / 2, 0))), o = w(() => Math.min(a.pages.length - 1, l.value + a.truncLimit)), r = w(() => a.pages.length > a.truncLimit ? a.pages.slice(l.value, o.value + 1) : a.pages), i = (B) => n("update:current-page", B), u = (B) => i(B), c = () => u(0), p = () => u(Math.max(0, a.currentPage - 1)), g = () => u(Math.min(a.pages.length - 1, a.currentPage + 1)), _ = () => u(a.pages.length - 1), x = (B) => a.pages.indexOf(B) === a.currentPage;
    return (B, P) => {
      var v, S, C, L;
      return s(), f("nav", ko, [
        d("ul", wo, [
          ...
          (s(!0), f(K, null, W(r.value, (D, I) => (s(), f("li", { key: I }, [
            d("a", {
              ...
              title: D.title,
              "aria-current": x(D) ? "page" : void 0,
              onClick: U((m) => u(B.pages.indexOf(D)), ["prevent"])
            }, [
              r.value.indexOf(D) === 0 && l.value > 0 ? (s(), f("span", Bo, "...")) : h("", !0),
              j(" " + b(D.label) + " ", 1),
              r.value.indexOf(D) === r.value.length - 1 && o.value < B.pages.length - 1 ? (s(), f("span", xo, "...")) : h("", !0)
            ], 8, Do)
          ]))), 128)),
          d("li", null, [
            d("a", {
              href: (C = B.pages[Math.min(B.currentPage + 1, B.pages.length - 1)]) == null ? void 0 : C.href,
                  ...
                  (s(!0), f(K, null, W(m.headersRow, (y, Q) => (s(), f("th", q({
                    ...
                    d("div", {
                      ...
                      _.value !== (y.key ?? y) && (m.sortableRows === !0 || Array.isArray(m.sortableRows) && m.sortableRows.includes(y.key ?? y)) ? (s(), f("span", jo, [
                        ...
                        X(le, {
                          name: x.value ? "ri-sort-desc" : "ri-sort-asc"
                        }, null, 8, ["name"])
                      ])) : h("", !0)
                    ], 2)
                  ], 16, Vo))), 128))
...
}), vr = ["href", "download"], mr = { class: "fr-link__detail" }, xa = /* @__PURE__ */ M({
...
}), xr = { class: "fr-follow__newsletter" }, Cr = { class: "fr-h5 fr-follow__title" }, Tr = { class: "fr-text--sm fr-follow__desc" }, Er = { key: 0 }, Sr = ["title"], Lr = { key: 1 }, Ar = { action: "" }, Mr = {
  class: "fr-label",
    ...
    return (p, g) => (s(), R(oe(l.value), q({
      ...
      default: G(() => {
        ...
        return [
          ...
          j(" " + b(p.label) + " ", 1),
          !u.value && (p.icon || (x = p.iconAttrs) != null && x.name) && p.iconRight ? (s(), R(le, q({
            key: 1,
            class: "fr-ml-1w"
          }, c.value), null, 16)) : h("", !0)
        ];
        ...
        d("div", ss, [
          d("div", is, [
            ...
            d("div", vs, [
              ...
              d("ul", gs, [
                (s(!0), f(K, null, W(p.ecosystemLinks, ({ href: x, label: B, title: P, ...v }, S) => (s(), f("li", {
                  key: S,
          ...
          d("div", hs, [
            d("ul", ys, [
              (s(!0), f(K, null, W(a.value, (x, B) => (s(), f("li", {
                key: B,
                class: "fr-footer__bottom-item"
              }, [
                X(Ea, q({ ref_for: !0 }, x), null, 16)
              ]))), 128))
            ]),
...
}), _s = /* @__PURE__ */ re(ws, [["__scopeId", "data-v-4d6f52aa"]]), Is = { class: "fr-footer__top-cat" }, Ds = { class: "fr-footer__top-list" }, Bs = ["href"], xs = /* @__PURE__ */ M({
      ...
      return s(), f("nav", Ls, [
        d("div", As, [
          d("button", {
            ...
            type: "button",
            onClick: x[0] || (x[0] = U((v) => c.value = !c.value, ["prevent", "stop"]))
          }, [
          ...
          d("div", {
            ...
            onTransitionend: x[1] || (x[1] = (v) => F(u)(c.value))
          }, [
            d("ul", Ps, [
  ...
  setup(t) {
    ...
    return (g, _) => (s(), R(oe(o.value), q({
      ...
      target: g.target,
      onClick: _[0] || (_[0] = U((x) => g.onClick(x), ["stop"]))
    }), {
      default: G(() => {
        var x, B;
        return [
  ...
  setup(t, { emit: e }) {
    const a = t, n = e, l = $e(a, "languageSelector"), o = O(!1), r = O(!1), i = O(!1), u = () => {
      var v;
    ...
    const p = () => {
      ...
      var v;
      return !!((v = x.operator) != null && v.call(x).length) || !!a.operatorImgSrc;
    }), P = w(() => !!x.mainnav);
    return ge(kt, () => u), (v, S) => {
      var C, L, D;
          ...
          d("div", Qs, [
            d("div", Gs, [
              ...
              d("div", si, [
                (D = v.quickLinks) != null && D.length || l.value ? (s(), f("div", ii, [
                  ...
                  l.value ? (s(), R(Ae, q({ key: 1 }, l.value, {
            ...
            v.showSearch || P.value || v.quickLinks && v.quickLinks.length || l.value ? (s(), f("div", {
              ...
              d("div", ci, [
                ...
                d("div", fi, [
                  l.value ? (s(), R(Ae, q({ key: 0 }, l.value, {
...
var La = ["input:not([inert])", "select:not([inert])", "textarea:not([inert])", "a[href]:not([inert])", "button:not([inert])", "[tabindex]:not(slot):not([inert])", "audio[controls]:not([inert])", "video[controls]:not([inert])", '[contenteditable]:not([contenteditable="false"]):not([inert])', "details>summary:first-of-type:not([inert])", "details:not([inert])"], He = /* @__PURE__ */ La.join(","), Aa = typeof Element > "u", _e = Aa ? function() {
  ...
  for (var l = [], o = Array.from(e); o.length; ) {
    ...
    if (!Ke(r, !1))
      if (r.tagName === "SLOT") {
        ...
        if (g && _) {
          var x = t(g === !0 ? r.children : g.children, !0, n);
          n.flatten ? l.push.apply(l, x) : l.push({
            scopeParent: r,
            candidates: x
          });
        } else
  ...
  if (e = e || {}, !t)
    throw new Error("No node provided");
  return _e.call(t, Oi) === !1 ? !1 : ze(e, t);
};
/*!
* focus-trap 7.5.4
...
var ta = {
  ...
  var a = (e == null ? void 0 : e.document) || document, n = (e == null ? void 0 : e.trapStack) || Ui, l = ea({
    ...
    if (o.active)
      return ta.activateTrap(n, r), o.delayInitialFocusTimer = l.delayInitialFocus ? aa(function() {
        x(p());
      }) : x(p()), a.addEventListener("focusin", S, !0), a.addEventListener("mousedown", v, {
        capture: !0,
        passive: !1
  ...
  return r = {
    ...
    deactivate: function(k) {
      ...
      var Z = function() {
        aa(function() {
          z && x(B(o.nodeFocusedBeforeActivation)), $ == null || $();
        });
      };
...
const Yi = {
  ...
  setup(t, { emit: e }) {
    ...
    const _ = w(() => typeof a.icon == "string" && a.icon.startsWith("fr-icon-")), x = w(
      () => _.value ? void 0 : typeof a.icon == "string" ? { name: a.icon, scale: na } : { scale: na, ...a.icon ?? {} }
    );
    return (B, P) => B.opened ? (s(), R(F(Zi), { key: 0 }, {
      default: G(() => {
        var v, S;
        return [
          d("dialog", {
                  ...
                  d("div", au, [
                    ...
                    d("div", ou, [
                      d("h1", {
                        ...
                        _.value || x.value ? (s(), f("span", {
                          key: 0,
                          class: N({
                            [String(B.icon)]: _.value
                          })
                        }, [
                          B.icon && x.value ? (s(), R(le, ue(q({ key: 0 }, x.value)), null, 16)) : h("", !0)
                        ], 2)) : h("", !0),
                        j(" " + b(B.title), 1)
                      ], 8, ru),
                    ...
                    (v = B.actions) != null && v.length || B.$slots.footer ? (s(), f("div", su, [
                      ...
                      (S = B.actions) != null && S.length ? (s(), R(Ye, {
                        key: 0,
                        align: "right",
                        buttons: B.actions,
...
}), Bu = ["aria-expanded", "aria-current", "aria-controls"], xu = ["id"], Cu = { class: "fr-menu__list" }, Ha = /* @__PURE__ */ M({
...
}), Id = { class: "fr-segmented__element" }, Dd = ["id", "name", "value", "checked", "disabled", "aria-disabled"], Bd = ["for"], xd = { key: 1 }, Ka = /* @__PURE__ */ M({
  ...
  setup(t) {
    ...
    return (p, g) => {
      ...
      return s(), f("div", {
        ...
        onTransitionend: g[2] || (g[2] = (x) => F(r)(!!p.expanded))
      }, [
        d("ul", Yd, [
          A(p.$slots, "default"),
          (s(!0), f(K, null, W(p.menuItems, (x, B) => (s(), R(Qa, {
            key: B,
            active: x.active
          }, {
            default: G(() => [
              x.menuItems ? h("", !0) : (s(), R(oe(u(x.to)), q({
                key: 0,
  ...
  setup(t) {
    ...
    const e = t, a = { true: "100%", false: "-100%" }, n = De(Ge), { isVisible: l, asc: o } = n($e(() => e.tabId)), r = w(() => a[String(o == null ? void 0 : o.value)]), i = w(() => a[String(!(o != null && o.value))]);
    return (u, c) => (s(), R(cl, {
      name: "slide-fade",
      mode: "in-out"
    }, {
...
}), Wa = /* @__PURE__ */ re(Ic, [["__scopeId", "data-v-5774b16c"]]), Dc = { role: "presentation" }, Bc = ["id", "data-testid", "tabindex", "aria-selected", "aria-controls"], xc = {
  key: 0,
  ...
  setup(t, { emit: e }) {
    ...
    const i = De(Ge), { isVisible: u } = i($e(() => a.tabId));
  ...
  setup(t) {
    ...
    ne(() => {
      document.documentElement.addEventListener("click", x), document.documentElement.addEventListener("keydown", B);
    }), fe(() => {
      document.documentElement.removeEventListener("click", x), document.documentElement.removeEventListener("keydown", B);
    });
    const P = () => {
      e.onHover && (a.value = !0);
    }, v = () => {
...
}), ff = /* @__PURE__ */ re(cf, [["__scopeId", "data-v-67870551"]]), pf = { class: "fr-transcription" }, vf = ["aria-expanded", "aria-controls"], mf = ["id"], gf = ["id", "aria-labelledby"], bf = { class: "fr-container fr-container--fluid fr-container-md" }, hf = { class: "fr-grid-row fr-grid-row--center" }, yf = { class: "fr-col-12 fr-col-md-10 fr-col-lg-8" }, kf = { class: "fr-modal__body" }, wf = { class: "fr-modal__header" }, _f = ["aria-controls"], If = { class: "fr-modal__content" }, Df = ["id"], Bf = { class: "fr-transcription__footer" }, xf = { class: "fr-transcription__actions-group" }, Cf = ["aria-controls"], tl = /* @__PURE__ */ M({
  ...
  setup(t) {
    ...
    return ae(u, (g, _) => {
      ...
      d("button", {
        ...
        onClick: _[0] || (_[0] = (x) => u.value = !u.value)
      }, " Transcription ", 8, vf),
      d("div", {
        id: p.value,
        ref_key: "collapse",
        ...
        onTransitionend: _[2] || (_[2] = (x) => F(r)(u.value))
      }, [
        d("dialog", {
          id: c.value,
          class: "fr-modal",
  ...
  name: "DsfrFacets",
  components: { DsfrCheckbox: Ct, DsfrTag: Lt, DsfrButton: Fe },
  props: {
    facets: Array,
...
const tp = /* @__PURE__ */ he(Pf, [["render", ep], ["__scopeId", "data-v-0be4e596"]]), At = () => {
  ...
  return ra[t];
}, np = (t) => Array.from({ length: t }).map(lp).join(""), Be = (t = "", e = "") => (t ? `${t}-` : "") + np(5) + (e ? `-${e}` : ""), op = ["id", "onKeydown", "aria-disabled", "aria-controls", "aria-expanded"], rp = ["id", "aria-labelledby", "onKeydown"], sp = {
  class: "fr-menu__list",
  role: "none"
}, ip = /* @__PURE__ */ M({
  inheritAttrs: !1,
  ...
  setup(t, { expose: e }) {
    ...
    const x = (D, I) => {
      ...
      return T.ariaDisabled === "true" ? x(m, I) : T;
    }, B = (D) => {
...
}), up = /* @__PURE__ */ he(ip, [["__scopeId", "data-v-089ea365"]]), dp = { role: "none" }, cp = ["id", "href"], fp = /* @__PURE__ */ M({
  inheritAttrs: !1,
  __name: "DsfrMenuLink",
  props: {
    label: { default: "" },
  ...
  class: "fr-select__ul"
}, xp = ["aria-selected"], Cp = ["id", "data-id", "value"], Tp = ["for"], Ep = ["id"], Sp = /* @__PURE__ */ M({
  inheritAttrs: !1,
  ...
  setup(t) {
    ...
    const p = O(null), g = O(null), _ = O(null), x = w(() => r.errorMessage || r.successMessage), B = w(() => r.errorMessage !== "" ? "error" : "valid"), P = w(() => r.modelValue.length === c.value.length ? "fr-icon-close-circle-line" : "fr-icon-check-line"), v = w(() => r.modelValue.length === c.value.length ? "Tout déselectionner" : "Tout sélectionner"), S = w(() => {
    ...
    return ($, V) => (s(), f(K, null, [
      d("div", {
        ref_key: "container",
        ref: p,
        class: N(["fr-select-group", { [`fr-select-group--${B.value}`]: x.value !== "" }]),
        onKeyup: V[13] || (V[13] = Y(
          //@ts-ignore
          (...z) => F(H) && F(H)(...z),
          ["tab"]
        ...
        d("div", q({
          id: $.id,
          class: [{ [`fr-select--${B.value}`]: x.value !== "" }, "fr-input"],
  ...
  setup(t) {
    ...
    ge("menuItem", { menuItemIndex: c, addMenuItem: g }), ge("id", r.id), ae(u, (C, L) => {
      C !== L && (l(C), C ? (setTimeout(() => B(), 100), document.addEventListener("click", S), document.addEventListener("touchstart", S)) : (document.removeEventListener("click", S), document.removeEventListener("touchstart", S)));
    }), ne(() => {
          ...
          d("div", Qp, [
            d("div", Gp, [
              ...
              d("div", sv, [
                (I = v.quickLinks) != null && I.length || l.value ? (s(), f("div", iv, [
                  ...
                  l.value ? (s(), R(F(Ae), q({ key: 1 }, l.value, {
                    onSelect: S[2] || (S[2] = (m) => n("language-select", m))
                  }), null, 16)) : h("", !0)
                ])) : h("", !0),
                d("div", uv, [
                  A(v.$slots, "header-search"),
                  v.showSearch ? (s(), R(F(Me), {
                    key: 0,
                    "searchbar-id": v.searchbarId,
                    label: v.searchLabel,
                    "model-value": v.modelValue,
            ...
            v.showSearch || P.value || v.quickLinks && v.quickLinks.length || l.value ? (s(), f("div", {
              ...
              d("div", cv, [
                ...
                d("div", fv, [
                  l.value ? (s(), R(F(Ae), q({ key: 0 }, l.value, {
                    onSelect: S[6] || (S[6] = (m) => l.value.currentLanguage = m.codeIso)
                  }), null, 16)) : h("", !0),
                  o.value ? (s(), R(mt, {
                    key: 1,
  ...
  class: "fr-cell--fixed",
  role: "columnheader"
}, Iv = { class: "fr-checkbox-group fr-checkbox-group--sm" }, Dv = ["id", "checked"], Bv = ["for"], xv = ["tabindex", "onClick", "onKeydown"], Cv = { key: 0 }, Tv = { key: 1 }, Ev = ["data-row-key"], Sv = {
  key: 0,
  class: "fr-cell--fixed",
  role: "columnheader"
  ...
  setup(t) {
    ...
    const g = w(() => ["sm", "small"].includes(e.size)), _ = w(() => ["md", "medium"].includes(e.size)), x = w(() => ["lg", "large"].includes(e.size)), B = w(() => typeof e.icon == "string" && e.icon.startsWith("fr-icon-")), P = w(() => `transform: translate(${o.value}, ${r.value}); --arrow-x: ${i.value}; opacity: ${c.value};'`), v = w(() => ({
      "fr-tooltip--shown": a.value,
      "fr-placement--top": u.value,
      "fr-placement--bottom": !u.value
    })), S = (I) => {
...
}), Wv = /* @__PURE__ */ he(Gv, [["__scopeId", "data-v-e08e9ba0"]]);
var Uv = {

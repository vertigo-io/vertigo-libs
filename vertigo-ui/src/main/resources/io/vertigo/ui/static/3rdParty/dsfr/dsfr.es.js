import { defineComponent as M, ref as O, computed as w, onMounted as ne, watch as ae, onUnmounted as fe, Comment as nl, cloneVNode as ol, h as $t, openBlock as s, createElementBlock as f, normalizeClass as R, createElementVNode as d, withModifiers as U, createTextVNode as V, toDisplayString as b, unref as F, Fragment as K, renderList as W, createVNode as X, withKeys as Y, withCtx as G, createBlock as N, resolveDynamicComponent as oe, mergeProps as H, createCommentVNode as h, mergeModels as ge, useModel as ie, withDirectives as pe, vModelCheckbox as $e, renderSlot as A, inject as Be, toRef as Fe, provide as be, resolveComponent as se, vShow as sa, useCssVars as ia, nextTick as ua, normalizeStyle as de, normalizeProps as ue, guardReactiveProps as gt, useAttrs as rl, useSlots as bt, hasInjectionContext as sl, reactive as il, Teleport as ul, vModelSelect as ht, onBeforeUnmount as dl, Transition as cl } from "vue";
const yt = Symbol("accordions"), kt = Symbol("header"), Ge = Symbol("tabs"), he = () => {
  ...
  setup(t) {
    const e = t, {
      ...
      doExpand: o,
      onTransitionEnd: r
    } = he(), i = O(), u = Be(yt), { isActive: c, expand: p } = (u == null ? void 0 : u(Fe(() => e.title))) ?? { isActive: i, expand: () => i.value = !i.value };
    return ne(() => {
      c.value && o(!0);
    }), ae(c, (g, _) => {
      g !== _ && o(g);
    }), (g, _) => (s(), f("section", ml, [
      (s(), N(oe(g.titleTag), { class: "fr-accordion__title" }, {
        default: G(() => [
          d("button", {
      ...
      d("div", {
        ...
        onTransitionend: _[1] || (_[1] = (C) => F(r)(F(c)))
      }, [
        A(g.$slots, "default")
      ], 42, bl)
    ]));
  ...
  if (a && n === "") {
    ...
    return e && !je(i, a) ? null : i;
  }
  return null;
}, je = (t, e) => t ? !!((t.provider === "" || t.provider.match(xe)) && (e && t.prefix === "" || t.prefix.match(xe)) && t.name.match(xe)) : !1, ca = Object.freeze(
  {
    left: 0,
    top: 0,
    width: 16,
...
function Pt(t, e) {
  const a = Al(t, e);
  for (const n in nt)
    n in qe ? n in t && !(n in a) && (a[n] = qe[n]) : n in e ? a[n] = e[n] : n in t && (a[n] = t[n]);
  return a;
}
function Ml(t, e) {
...
function pa(t) {
  ...
  for (const l in a) {
    const o = a[l];
    if (!l.match(xe) || typeof o.body != "string" || !tt(
      o,
      nt
    ))
      return null;
  ...
  for (const l in n) {
    ...
    if (!l.match(xe) || typeof r != "string" || !a[r] && !n[r] || !tt(
      o,
      nt
    ))
      return null;
...
const ma = Object.freeze({
  ...
  // Transformations
  ...qe
}), Ol = /(-?[0-9.]*[0-9]+[0-9.]*)/g, ql = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
function Nt(t, e, a) {
  if (e === 1)
    return t;
...
for (; Re.length > 0; )
  Re.length === 1 || Math.random() > 0.5 ? st.push(Re.shift()) : st.push(Re.pop());
It[""] = _t({
...
function sn(t) {
  ...
  return t.forEach((l) => {
    if (n.name === l.name && n.prefix === l.prefix && n.provider === l.provider)
      return;
    n = l;
    const o = l.provider, r = l.prefix, i = l.name, u = a[o] || (a[o] = /* @__PURE__ */ Object.create(null)), c = u[r] || (u[r] = we(o, r));
    let p;
...
const Ot = "iconify2", Se = "iconify", ya = Se + "-count", qt = Se + "-version", ka = 36e5, bn = 168, hn = 50;
function it(t, e) {
  try {
    return t.getItem(e);
  } catch {
...
function Ia(t, e) {
  ...
  const l = Math.floor(Date.now() / ka) - bn, o = (i) => {
    const u = Se + i.toString(), c = it(a, u);
    if (typeof c == "string") {
      try {
...
function Da() {
  if (!Ct) {
    ...
    for (const t in Xe)
      Ia(t, (e) => {
        const a = e.data, n = e.provider, l = a.prefix, o = we(
          n,
          l
        );
        if (!wt(o, a).length)
...
["horizontal", "vertical"].forEach((t) => {
  ...
  Oe[t + "-flip"] = e, Oe[t.slice(0, 1) + "-flip"] = e, Oe[t + "Flip"] = e;
});
function Wt(t) {
  return t + (t.match(/^[-0-9.]+$/) ? "px" : "");
}
const Ut = (t, e) => {
  const a = Bn(zt, e), n = { ...Mn }, l = e.mode || "svg", o = {}, r = e.style, i = typeof r == "object" && !(r instanceof Array) ? r : {};
  for (let P in e) {
    const v = e[P];
    if (v !== void 0)
      switch (P) {
...
const Fn = {
  ...
  setup(t, { expose: e }) {
    ...
    return (p, g) => (s(), f("button", {
      ...
      p.icon && !i.value ? (s(), N(le, ue(H({ key: 0 }, c.value)), null, 16)) : h("", !0),
...
}), Pe = /* @__PURE__ */ re(jn, [["__scopeId", "data-v-77b13897"]]), Ye = /* @__PURE__ */ M({
  ...
  setup(t) {
    const e = t, a = O(null), n = w(() => ["sm", "small"].includes(e.size)), l = w(() => ["md", "medium"].includes(e.size)), o = w(() => ["lg", "large"].includes(e.size)), r = w(() => ["always", "", !0].includes(e.inlineLayoutWhen)), i = w(() => ["sm", "small"].includes(e.inlineLayoutWhen)), u = w(() => ["md", "medium"].includes(e.inlineLayoutWhen)), c = w(() => ["lg", "large"].includes(e.inlineLayoutWhen)), p = w(() => e.align === "center"), g = w(() => e.align === "right"), _ = O("auto"), C = w(() => `--equisized-width: ${_.value};`), B = async () => {
      var P;
      let v = 0;
    ...
    return ne(async () => {
      ...
      (s(!0), f(K, null, W(P.buttons, ({ onClick: S, ...x }, L) => (s(), f("li", { key: L }, [
        X(Pe, H({ ref_for: !0 }, x, { onClick: S }), null, 16, ["onClick"])
      ]))), 128)),
      A(P.$slots, "default")
    ], 6));
  }
}), On = { class: "fr-callout__text" }, qn = /* @__PURE__ */ M({
  __name: "DsfrCallout",
  props: {
    title: {},
    content: {},
  ...
  setup(t) {
    ...
    return (l, o) => (s(), f("div", {
      ...
      l.icon && n.value ? (s(), N(le, ue(H({ key: 0 }, n.value)), null, 16)) : h("", !0),
      ...
      l.button ? (s(), N(Pe, ue(H({ key: 2 }, l.button)), null, 16)) : h("", !0),
      A(l.$slots, "default", {}, void 0, !0)
    ], 2));
  }
}), Hn = /* @__PURE__ */ re(qn, [["__scopeId", "data-v-a34b4ad8"]]), ft = /* @__PURE__ */ M({
  ...
  setup(t) {
    ...
    return (l, o) => (s(), f("p", {
      ...
      l.icon && !a.value ? (s(), N(le, ue(H({ key: 0 }, n.value)), null, 16)) : h("", !0),
      A(l.$slots, "default")
    ], 2));
  }
  ...
  setup(t, { expose: e }) {
    ...
    return e({ goToTargetLink: () => {
      ...
      return s(), f("div", {
        ...
        d("div", Kn, [
          d("div", zn, [
            (s(), N(oe(c.titleTag), { class: "fr-card__title" }, {
              default: G(() => [
                i.value ? (s(), f("a", {
                  key: 0,
                  href: c.link,
          ...
          c.buttons.length || c.linksGroup.length ? (s(), f("div", Xn, [
            ...
            c.linksGroup.length ? (s(), f("ul", Yn, [
              (s(!0), f(K, null, W(c.linksGroup, (_, C) => (s(), f("li", {
                key: `card-link-${C}`
              }, [
                _.to ? (s(), N(g, {
                  key: 0,
        ...
        c.imgSrc || c.badges.length ? (s(), f("div", Jn, [
          ...
          c.badges.length ? (s(), f("ul", ao, [
            (s(!0), f(K, null, W(c.badges, (_, C) => (s(), f("li", { key: C }, [
              X(da, H({ ref_for: !0 }, _), null, 16)
            ]))), 128))
          ])) : h("", !0)
        ])) : h("", !0)
      ], 2);
  ...
  setup(t) {
    ...
    return (r, i) => (s(), f("div", uo, [
      d("fieldset", {
        ...
        A(r.$slots, "default", {}, () => [
          (s(!0), f(K, null, W(r.options, (u) => (s(), N(xt, {
            id: u.id,
            key: u.id || u.name,
            modelValue: o.value,
      ...
      d("div", go, [
        d("p", bo, [
          A(o.$slots, "default", {}, () => [
            ...
            (s(), N(oe(n.value), H(l.value, { "data-testid": "link" }), {
              default: G(() => r[3] || (r[3] = [
  ...
  setup(t, { emit: e }) {
    const a = t, n = e, l = w(() => Math.min(a.pages.length - 1 - a.truncLimit, Math.max(a.currentPage - (a.truncLimit - a.truncLimit % 2) / 2, 0))), o = w(() => Math.min(a.pages.length - 1, l.value + a.truncLimit)), r = w(() => a.pages.length > a.truncLimit ? a.pages.slice(l.value, o.value + 1) : a.pages), i = (B) => n("update:current-page", B), u = (B) => i(B), c = () => u(0), p = () => u(Math.max(0, a.currentPage - 1)), g = () => u(Math.min(a.pages.length - 1, a.currentPage + 1)), _ = () => u(a.pages.length - 1), C = (B) => a.pages.indexOf(B) === a.currentPage;
    return (B, P) => {
      var v, S, x, L;
      return s(), f("nav", ko, [
        d("ul", wo, [
          ...
          (s(!0), f(K, null, W(r.value, (D, I) => (s(), f("li", { key: I }, [
            d("a", {
              ...
              r.value.indexOf(D) === 0 && l.value > 0 ? (s(), f("span", Bo, "...")) : h("", !0),
              V(" " + b(D.label) + " ", 1),
              r.value.indexOf(D) === r.value.length - 1 && o.value < B.pages.length - 1 ? (s(), f("span", Co, "...")) : h("", !0)
            ], 8, Do)
          ]))), 128)),
          d("li", null, [
            d("a", {
  ...
  class: "fr-cell--fixed",
  role: "columnheader"
}, Po = { class: "fr-checkbox-group fr-checkbox-group--sm" }, Ro = ["id", "checked"], No = ["for"], Vo = ["tabindex", "onClick", "onKeydown"], jo = { key: 0 }, Oo = { key: 1 }, qo = ["data-row-key"], Ho = {
  key: 0,
  class: "fr-cell--fixed",
  role: "columnheader"
  ...
  setup(t, { emit: e }) {
    ...
    const _ = ie(t, "sortedBy"), C = ie(t, "sortedDesc");
    function B(m) {
            ...
            d("table", { id: m.id }, [
              ...
              d("thead", null, [
                d("tr", null, [
                  ...
                  (s(!0), f(K, null, W(m.headersRow, (y, Q) => (s(), f("th", H({
                    ...
                    d("div", {
                      ...
                      A(m.$slots, "header", H({ ref_for: !0 }, typeof y == "object" ? y : { key: y, label: y }), () => [
              ...
              d("tbody", null, [
                (s(!0), f(K, null, W(v.value, (y, Q) => (s(), f("tr", {
                  ...
                  (s(!0), f(K, null, W(y, (k, E) => (s(), f("td", {
                    ...
                    tabindex: "0",
                    onKeydown: [
                      Y(U((q) => I(typeof k == "object" ? k[m.rowKey] : k), ["ctrl"]), ["c"]),
                      Y(U((q) => I(typeof k == "object" ? k[m.rowKey] : k), ["meta"]), ["c"])
                    ]
                  }, [
                    A(m.$slots, "cell", H({ ref_for: !0 }, {
                      colKey: typeof m.headersRow[E] == "object" ? m.headersRow[E].key : m.headersRow[E],
                      cell: k
                    }), () => [
                      V(b(typeof k == "object" ? k[m.rowKey] : k), 1)
                    ], !0)
                  ], 40, Go))), 128))
                ], 8, qo))), 128))
              ])
...
}), Hr = { class: "fr-follow" }, Kr = { class: "fr-container" }, zr = { class: "fr-grid-row" }, Qr = /* @__PURE__ */ M({
  __name: "DsfrFollow",
  props: {
  ...
  setup(t) {
    ...
    return (p, g) => (s(), N(oe(l.value), H({
      ...
      default: G(() => {
        var _, C;
        return [
          !u.value && (p.icon || (_ = p.iconAttrs) != null && _.name) && !p.iconRight ? (s(), N(le, H({
            key: 0,
            class: "fr-mr-1w"
          }, c.value), null, 16)) : h("", !0),
          V(" " + b(p.label) + " ", 1),
          !u.value && (p.icon || (C = p.iconAttrs) != null && C.name) && p.iconRight ? (s(), N(le, H({
            key: 1,
            class: "fr-ml-1w"
          }, c.value), null, 16)) : h("", !0)
        ];
        ...
        d("div", ss, [
          d("div", is, [
            ...
            d("div", vs, [
              ...
              d("ul", gs, [
                (s(!0), f(K, null, W(p.ecosystemLinks, ({ href: C, label: B, title: P, ...v }, S) => (s(), f("li", {
                  key: S,
          ...
          p.partners ? (s(), N(Sa, ue(H({ key: 0 }, p.partners)), null, 16)) : h("", !0),
          d("div", hs, [
            d("ul", ys, [
              (s(!0), f(K, null, W(a.value, (C, B) => (s(), f("li", {
                key: B,
                class: "fr-footer__bottom-item"
              }, [
                X(Ea, H({ ref_for: !0 }, C), null, 16)
              ]))), 128))
            ]),
            p.licenceText ? (s(), f("div", ks, [
              d("p", null, [
                V(b(p.licenceText) + " ", 1),
                (s(), N(oe(o.value ? "a" : "RouterLink"), H({
...
}), _s = /* @__PURE__ */ re(ws, [["__scopeId", "data-v-4d6f52aa"]]), Is = { class: "fr-footer__top-cat" }, Ds = { class: "fr-footer__top-list" }, Bs = ["href"], Cs = /* @__PURE__ */ M({
...
}), xs = { class: "fr-connect-group" }, Ts = { class: "fr-connect__brand" }, Es = ["href", "title"], Ss = /* @__PURE__ */ M({
...
}, As = { class: "fr-nav__item" }, Ms = ["aria-controls", "aria-expanded"], $s = { class: "fr-hidden-lg" }, Fs = ["id"], Ps = { class: "fr-menu__list" }, Rs = ["hreflang", "lang", "aria-current", "href", "onClick"], Ae = /* @__PURE__ */ M({
      ...
      return s(), f("nav", Ls, [
        d("div", As, [
          d("button", {
            ...
            V(b((B = g.value) == null ? void 0 : B.codeIso.toUpperCase()), 1),
  ...
  setup(t, { expose: e }) {
    ...
    return e({
      ...
      i.value ? (s(), f("div", {
        ...
        (s(), N(oe(r.value), H({ id: c.id }, c.$attrs, {
          ref_key: "__input",
          ref: l,
          class: ["fr-input", {
...
}), Et = /* @__PURE__ */ re(Os, [["__scopeId", "data-v-6e6c295a"]]), Me = /* @__PURE__ */ M({
  ...
  setup(t) {
    ...
    return (g, _) => (s(), N(oe(o.value), H({
      ...
      default: G(() => {
        var C, B;
        return [
          !c.value && (g.icon || (C = g.iconAttrs) != null && C.name) && !g.iconRight ? (s(), N(le, H({
            key: 0,
            class: "fr-mr-1w"
          }, p.value), null, 16)) : h("", !0),
          V(" " + b(g.label) + " ", 1),
          !c.value && (g.icon || (B = g.iconAttrs) != null && B.name) && g.iconRight ? (s(), N(le, H({
            key: 1,
            class: "fr-ml-1w"
          }, p.value), null, 16)) : h("", !0)
        ];
...
}), qs = ["aria-label"], Hs = { class: "fr-btns-group" }, pt = /* @__PURE__ */ M({
  ...
  setup(t, { emit: e }) {
    const a = t, n = e, l = Fe(a, "languageSelector"), o = O(!1), r = O(!1), i = O(!1), u = () => {
      var v;
          ...
          d("div", Qs, [
            d("div", Gs, [
              d("div", Ws, [
                d("div", Us, [
                  ...
                  v.showSearch || P.value || (x = v.quickLinks) != null && x.length ? (s(), f("div", Js, [
              ...
              d("div", si, [
                (D = v.quickLinks) != null && D.length || l.value ? (s(), f("div", ii, [
                  ...
                  l.value ? (s(), N(Ae, H({ key: 1 }, l.value, {
            ...
            v.showSearch || P.value || v.quickLinks && v.quickLinks.length || l.value ? (s(), f("div", {
              ...
              d("div", ci, [
                ...
                d("div", fi, [
                  l.value ? (s(), N(Ae, H({ key: 0 }, l.value, {
  ...
  setup(t) {
    return (e, a) => (s(), f("div", {
      ...
      A(e.$slots, "default"),
      e.$slots.default ? h("", !0) : (s(), N(Et, H({ key: 0 }, e.$attrs, {
...
var La = ["input:not([inert])", "select:not([inert])", "textarea:not([inert])", "a[href]:not([inert])", "button:not([inert])", "[tabindex]:not(slot):not([inert])", "audio[controls]:not([inert])", "video[controls]:not([inert])", '[contenteditable]:not([contenteditable="false"]):not([inert])', "details>summary:first-of-type:not([inert])", "details:not([inert])"], He = /* @__PURE__ */ La.join(","), Aa = typeof Element > "u", _e = Aa ? function() {
} : Element.prototype.matches || Element.prototype.msMatchesSelector || Element.prototype.webkitMatchesSelector, Ke = !Aa && Element.prototype.getRootNode ? function(t) {
  var e;
  ...
  for (var l = [], o = Array.from(e); o.length; ) {
    ...
    if (!ze(r, !1))
      if (r.tagName === "SLOT") {
        ...
        typeof n.getShadowRoot == "function" && n.getShadowRoot(r), _ = !ze(g, !1) && (!n.shadowRootFilter || n.shadowRootFilter(r));
        if (g && _) {
          var C = t(g === !0 ? r.children : g.children, !0, n);
          n.flatten ? l.push.apply(l, C) : l.push({
            scopeParent: r,
            candidates: C
          });
  ...
  return t.tabIndex < 0 && (/^(AUDIO|VIDEO|DETAILS)$/.test(t.tagName) || Bi(t)) && !Fa(t) ? 0 : t.tabIndex;
}, Ci = function(t, e) {
  var a = ke(t);
  ...
  if (!t.name)
    return !0;
  var e = t.form || Ke(t), a = function(o) {
  ...
  var e, a = t && Ke(t), n = (e = a) === null || e === void 0 ? void 0 : e.host, l = !1;
  if (a && a !== t) {
    var o, r, i;
    for (l = !!((o = n) !== null && o !== void 0 && (r = o.ownerDocument) !== null && r !== void 0 && r.contains(n) || t != null && (i = t.ownerDocument) !== null && i !== void 0 && i.contains(t)); !l && n; ) {
      var u, c, p;
      a = Ke(n), n = (u = a) === null || u === void 0 ? void 0 : u.host, l = !!((c = n) !== null && c !== void 0 && (p = c.ownerDocument) !== null && p !== void 0 && p.contains(n));
    }
  }
  return l;
}, Zt = function(t) {
  ...
  if (getComputedStyle(t).visibility === "hidden")
    return !0;
  var l = _e.call(t, "details>summary:first-of-type"), o = l ? t.parentElement : t;
  if (_e.call(o, "details:not([open]) *"))
    return !0;
  if (!a || a === "full" || a === "legacy-full") {
    if (typeof n == "function") {
      for (var r = t; t; ) {
        var i = t.parentElement, u = Ke(t);
  ...
  ze(e) || Ti(e) || Fi(e, t) || // For a details element with a summary, the summary element gets the focus
  Ei(e) || Pi(e));
}, vt = function(t, e) {
  return !(Mi(e) || ke(e) < 0 || !Qe(t, e));
}, Ri = function(t) {
  ...
  return e.forEach(function(l, o) {
    var r = !!l.scopeParent, i = r ? l.scopeParent : l, u = Ci(i, r), c = r ? t(l.candidates) : i;
  ...
  var a;
  return e.getShadowRoot ? a = $a([t], e.includeContainer, {
    filter: Qe.bind(null, e),
    flatten: !0,
    getShadowRoot: e.getShadowRoot
  }) : a = Ma(t, e.includeContainer, Qe.bind(null, e)), a;
}, De = function(t, e) {
  if (e = e || {}, !t)
    throw new Error("No node provided");
  ...
  if (e = e || {}, !t)
    throw new Error("No node provided");
  return _e.call(t, Oi) === !1 ? !1 : Qe(e, t);
};
/*!
* focus-trap 7.5.4
...
var ta = {
  ...
  var a = (e == null ? void 0 : e.document) || document, n = (e == null ? void 0 : e.trapStack) || Ui, l = ea({
    ...
    return k && k[E] !== void 0 ? k[E] : l[q || E];
  }, u = function(k, E) {
    var q = typeof (E == null ? void 0 : E.composedPath) == "function" ? E.composedPath() : void 0;
    return o.containerGroups.findIndex(function($) {
      var j = $.container, z = $.tabbableNodes;
      return j.contains(k) || // fall back to explicit tabbable search which will take into consideration any
      //  web components if the `tabbableOptions.getShadowRoot` option was used for
      //  the trap, enabling shadow DOM support in tabbable (`Node.contains()` doesn't
      //  look inside web components even if open)
      (q == null ? void 0 : q.includes(j)) || z.find(function(Z) {
        return Z === k;
      });
    });
  }, c = function(k) {
    ...
    if (typeof E == "function") {
      for (var q = arguments.length, $ = new Array(q > 1 ? q - 1 : 0), j = 1; j < q; j++)
        $[j - 1] = arguments[j];
      E = E.apply(void 0, $);
    }
    if (E === !0 && (E = void 0), !E) {
    ...
    if (o.containerGroups = o.containers.map(function(k) {
      var E = Vi(k, l.tabbableOptions), q = ji(k, l.tabbableOptions), $ = E.length > 0 ? E[0] : void 0, j = E.length > 0 ? E[E.length - 1] : void 0, z = q.find(function(te) {
        return De(te);
      }), Z = q.slice().reverse().find(function(te) {
        return De(te);
      ...
      return {
        ...
        nextTabbableNode: function(te) {
          var ve = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0, me = E.indexOf(te);
          return me < 0 ? ve ? q.slice(q.indexOf(te) + 1).find(function(ce) {
            return De(ce);
          }) : q.slice(0, q.indexOf(te)).reverse().find(function(ce) {
            return De(ce);
          }) : E[me + (ve ? 1 : -1)];
        }
      };
    ...
    var q = E.activeElement;
    if (q)
      return q.shadowRoot && q.shadowRoot.activeElement !== null ? k(q.shadowRoot) : q;
  }, C = function k(E) {
    if (E !== !1 && E !== _(document)) {
      if (!E || !E.focus) {
        k(p());
    ...
    var E = k.target, q = k.event, $ = k.isBackward, j = $ === void 0 ? !1 : $;
    E = E || Ve(q), g();
    var z = null;
    if (o.tabbableGroups.length > 0) {
      var Z = u(E, q), ee = Z >= 0 ? o.containerGroups[Z] : void 0;
      if (Z < 0)
        j ? z = o.tabbableGroups[o.tabbableGroups.length - 1].lastTabbableNode : z = o.tabbableGroups[0].firstTabbableNode;
      else if (j) {
        var te = la(o.tabbableGroups, function(Je) {
          var et = Je.firstTabbableNode;
          return E === et;
        });
        if (te < 0 && (ee.container === E || lt(E, l.tabbableOptions) && !De(E, l.tabbableOptions) && !ee.nextTabbableNode(E, !1)) && (te = Z), te >= 0) {
          var ve = te === 0 ? o.tabbableGroups.length - 1 : te - 1, me = o.tabbableGroups[ve];
          z = ke(E) >= 0 ? me.lastTabbableNode : me.lastDomTabbableNode;
        } else Te(q) || (z = ee.nextTabbableNode(E, !1));
      } else {
        var ce = la(o.tabbableGroups, function(Je) {
          var et = Je.lastTabbableNode;
          return E === et;
        });
        if (ce < 0 && (ee.container === E || lt(E, l.tabbableOptions) && !De(E, l.tabbableOptions) && !ee.nextTabbableNode(E)) && (ce = Z), ce >= 0) {
          var ll = ce === o.tabbableGroups.length - 1 ? 0 : ce + 1, Mt = o.tabbableGroups[ll];
          z = ke(E) >= 0 ? Mt.firstTabbableNode : Mt.firstDomTabbableNode;
        } else Te(q) || (z = ee.nextTabbableNode(E));
      }
    } else
      z = c("fallbackFocus");
    return z;
      ...
      if (o.mostRecentlyFocusedNode)
        if (ke(o.mostRecentlyFocusedNode) > 0) {
          ...
          if (Z.length > 0) {
            ...
            ee >= 0 && (l.isKeyForward(o.recentNavEvent) ? ee + 1 < Z.length && ($ = Z[ee + 1], j = !1) : ee - 1 >= 0 && ($ = Z[ee - 1], j = !1));
          }
        } else
    ...
    q && (Te(k) && k.preventDefault(), C(q));
  }, L = function(k) {
    if (Qi(k) && Ce(l.escapeDeactivates, k) !== !1) {
    ...
    var E = k.some(function(q) {
      var $ = Array.from(q.removedNodes);
      return $.some(function(j) {
  ...
  return r = {
    ...
    activate: function(k) {
      if (o.active)
        return this;
      var E = i(k, "onActivate"), q = i(k, "onPostActivate"), $ = i(k, "checkCanFocusTrap");
      $ || g(), o.active = !0, o.paused = !1, o.nodeFocusedBeforeActivation = a.activeElement, E == null || E();
      var j = function() {
        $ && g(), I(), Q(), q == null || q();
      };
      return $ ? ($(o.containers.concat()).then(j, j), this) : (j(), this);
    },
    deactivate: function(k) {
      ...
      var q = i(E, "onDeactivate"), $ = i(E, "onPostDeactivate"), j = i(E, "checkCanReturnFocus"), z = i(E, "returnFocus", "returnFocusOnDeactivate");
      q == null || q();
      var Z = function() {
        aa(function() {
          z && C(B(o.nodeFocusedBeforeActivation)), $ == null || $();
        });
      };
      return z && j ? (j(B(o.nodeFocusedBeforeActivation)).then(Z, Z), this) : (Z(), this);
    },
    pause: function(k) {
      if (o.paused || !o.active)
        return this;
      var E = i(k, "onPause"), q = i(k, "onPostPause");
      return o.paused = !0, E == null || E(), m(), Q(), q == null || q(), this;
    },
    unpause: function(k) {
      if (!o.paused || !o.active)
        return this;
      var E = i(k, "onUnpause"), q = i(k, "onPostUnpause");
      return o.paused = !1, E == null || E(), g(), I(), Q(), q == null || q(), this;
    },
    updateContainerElements: function(k) {
      var E = [].concat(k).filter(Boolean);
      return o.containers = E.map(function(q) {
        return typeof q == "string" ? a.querySelector(q) : q;
      }), o.active && g(), Q(), this;
    }
...
const Yi = {
  ...
  setup(t, { emit: e }) {
    ...
    ae(() => a.opened, (B) => {
      var P, v;
      B ? ((P = i.value) == null || P.showModal(), setTimeout(() => {
        var S;
        (S = r.value) == null || S.focus();
      }, 100)) : (v = i.value) == null || v.close(), u(B);
    });
    function u(B) {
    ...
    return (B, P) => B.opened ? (s(), N(F(Zi), { key: 0 }, {
      default: G(() => {
        var v, S;
        return [
          d("dialog", {
            ...
            role: o.value,
            class: R(["fr-modal", { "fr-modal--opened": B.opened }]),
            open: B.opened
          }, [
            d("div", eu, [
              d("div", tu, [
                  ...
                  d("div", au, [
                    ...
                    d("div", ou, [
                      d("h1", {
                        ...
                        _.value || C.value ? (s(), f("span", {
                          key: 0,
                          class: R({
                            [String(B.icon)]: _.value
                          })
                        }, [
                          B.icon && C.value ? (s(), N(le, ue(H({ key: 0 }, C.value)), null, 16)) : h("", !0)
                        ], 2)) : h("", !0),
                        V(" " + b(B.title), 1)
                      ], 8, ru),
                      A(B.$slots, "default", {}, void 0, !0)
                    ]),
                    (v = B.actions) != null && v.length || B.$slots.footer ? (s(), f("div", su, [
                      A(B.$slots, "footer", {}, void 0, !0),
                      (S = B.actions) != null && S.length ? (s(), N(Ye, {
                        key: 0,
                        align: "right",
                        buttons: B.actions,
  ...
  setup(t) {
    ...
    ), o = sl() ? Be(kt) : void 0, r = (o == null ? void 0 : o()) ?? (() => {
    });
    return (i, u) => {
      const c = se("RouterLink");
      return a.value ? (s(), f("a", {
        ...
        default: G(() => [
          i.icon && l.value ? (s(), N(le, ue(H({ key: 0 }, l.value)), null, 16)) : h("", !0),
          V(" " + b(i.text), 1)
        ]),
        _: 1
      }, 8, ["to", "class"]));
        ...
        d("div", {
          ...
          d("div", bu, [
            ...
            d("div", hu, [
              ...
              (s(!0), f(K, null, W(u.menus, (g, _) => (s(), N(Va, H({
                key: _,
                ref_for: !0
              }, g), null, 16))), 128))
            ])
...
}), Bu = ["aria-expanded", "aria-current", "aria-controls"], Cu = ["id"], xu = { class: "fr-menu__list" }, qa = /* @__PURE__ */ M({
  ...
  setup(t) {
    ...
    return ae(i, (u, c) => {
      ...
      d("div", {
        ...
        d("ul", xu, [
          A(u.$slots, "default"),
          (s(!0), f(K, null, W(u.links, (p, g) => (s(), N(Oa, { key: g }, {
            default: G(() => [
              X(Ze, H({ ref_for: !0 }, p, {
  ...
  setup(t) {
    ...
    return ne(() => {
      ...
      d("ul", Eu, [
        A(i.$slots, "default"),
        (s(!0), f(K, null, W(i.navItems, (c, p) => (s(), N(Na, { key: p }, {
          default: G(() => [
            c.to && c.text ? (s(), N(Ze, H({
              key: 0,
              ref_for: !0
            }, c, {
              "expanded-id": a.value,
              onToggleId: u[0] || (u[0] = (g) => n(g))
            }), null, 16, ["expanded-id"])) : c.title && c.links ? (s(), N(qa, H({
              key: 1,
              ref_for: !0
            }, c, {
              "expanded-id": a.value,
              onToggleId: u[1] || (u[1] = (g) => n(g))
            }), null, 16, ["expanded-id"])) : c.title && c.menus ? (s(), N(ja, H({
              key: 2,
              ref_for: !0
            }, c, {
              "expanded-id": a.value,
...
}), Ou = { class: "fr-quote fr-quote--column" }, qu = ["cite"], Hu = { class: "fr-quote__author" }, Ku = { class: "fr-quote__source" }, zu = ["href"], Qu = {
  key: 0,
...
}, ed = ["src", "title"], td = { key: 0 }, ad = ["href"], ld = ["href"], nd = ["href"], Ha = /* @__PURE__ */ M({
  ...
  setup(t, { emit: e }) {
    ...
    return (u, c) => (s(), f("div", od, [
      d("fieldset", {
        ...
        A(u.$slots, "default", {}, () => [
          (s(!0), f(K, null, W(u.options, (p, g) => (s(), N(Ha, H({
  ...
  setup(t) {
    ...
    return (l, o) => (s(), f("div", Id, [
      ...
      d("label", {
        ...
        l.icon && !n.value ? (s(), N(le, ue(H({ key: 0 }, a.value)), null, 16)) : h("", !0),
        l.icon ? (s(), f("span", Cd, " ")) : h("", !0),
        V(" " + b(l.label), 1)
      ], 10, Bd)
    ]));
  }
  ...
  setup(t, { emit: e }) {
    ...
    return (o, r) => (s(), f("div", xd, [
      d("fieldset", {
        ...
        d("div", Ld, [
          A(o.$slots, "default", {}, () => [
            (s(!0), f(K, null, W(o.options, (i, u) => (s(), N(Ka, H({
              key: i.value || u,
              name: o.name || i.name,
              ref_for: !0
...
}), Od = { class: "fr-share" }, qd = { class: "fr-share__title" }, Hd = { class: "fr-btns-group" }, Kd = ["title", "href", "onClick"], zd = { key: 0 }, Qd = ["href", "title"], Gd = ["title"], Wd = /* @__PURE__ */ M({
  __name: "DsfrShare",
  props: {
  ...
  setup(t) {
    ...
    return (p, g) => {
      ...
      return s(), f("div", {
        ...
        onTransitionend: g[2] || (g[2] = (C) => F(r)(!!p.expanded))
      }, [
        d("ul", Yd, [
          A(p.$slots, "default"),
          (s(!0), f(K, null, W(p.menuItems, (C, B) => (s(), N(Qa, {
            key: B,
            active: C.active
          }, {
            default: G(() => [
              C.menuItems ? h("", !0) : (s(), N(oe(u(C.to)), H({
                key: 0,
  ...
  setup(t) {
    ...
    const e = t, a = { true: "100%", false: "-100%" }, n = Be(Ge), { isVisible: l, asc: o } = n(Fe(() => e.tabId)), r = w(() => a[String(o == null ? void 0 : o.value)]), i = w(() => a[String(!(o != null && o.value))]);
    return (u, c) => (s(), N(cl, {
      name: "slide-fade",
      mode: "in-out"
    }, {
  ...
  setup(t, { emit: e }) {
    ...
    const i = Be(Ge), { isVisible: u } = i(Fe(() => a.tabId));
  ...
  setup(t) {
    const e = t, a = w(() => e.icon && typeof e.icon == "string" && e.icon.startsWith("fr-") ? e.icon : ""), n = w(() => a.value ? void 0 : typeof e.icon == "string" ? { name: e.icon } : e.icon);
    return (l, o) => (s(), f("th", H(l.headerAttrs, { scope: "col" }), [
      V(b(l.header) + " ", 1),
      l.icon && !a.value ? (s(), N(le, ue(H({ key: 0 }, n.value)), null, 16)) : h("", !0),
      a.value ? (s(), f("span", {
        key: 1,
  ...
  setup(t) {
    return (e, a) => e.headers ? (s(), f("tr", xc, [
      (s(!0), f(K, null, W(e.headers, (n, l) => (s(), N(Xa, {
        key: l,
  ...
  setup(t) {
    ...
    return (l, o) => (s(), f("td", ue(gt(l.cellAttrs)), [
      a.value ? (s(), N(oe(a.value), ue(H({ key: 0 }, typeof l.field == "object" ? l.field : {})), {
        default: G(() => [
          V(b(l.field.text), 1)
        ]),
        _: 1
  ...
  setup(t) {
    return (e, a) => (s(), f("tr", ue(gt(e.rowAttrs)), [
      A(e.$slots, "default"),
      (s(!0), f(K, null, W(e.rowData, (n, l) => (s(), N(Za, {
        key: l,
        field: n ?? "",
    ...
    return (v, S) => (s(), f("div", {
      ...
      d("table", null, [
        ...
        d("tbody", null, [
          ...
          v.rows && v.rows.length ? (s(!0), f(K, { key: 0 }, W(g.value, (x, L) => (s(), N(Ja, {
  ...
  setup(t, { expose: e, emit: a }) {
    ...
    return ne(() => {
      ...
      d("ul", {
        ...
        A(D.$slots, "tab-items", {}, () => [
          (s(!0), f(K, null, W(D.tabTitles, (m, T) => (s(), N(Ua, {
            key: T,
            icon: m.icon,
...
}), Lt = /* @__PURE__ */ re(Oc, [["__scopeId", "data-v-f6a89dc8"]]), qc = { class: "fr-tags-group" }, Hc = /* @__PURE__ */ M({
  __name: "DsfrTags",
  props: {
    tags: { default: () => [] }
  },
  setup(t) {
    return (e, a) => (s(), f("ul", qc, [
  ...
  setup(t) {
    ...
    async function p() {
      ...
      const y = (x = n.value) == null ? void 0 : x.getBoundingClientRect().top, Q = (L = n.value) == null ? void 0 : L.offsetHeight, k = (D = n.value) == null ? void 0 : D.offsetWidth, E = (I = n.value) == null ? void 0 : I.getBoundingClientRect().left, q = (m = l.value) == null ? void 0 : m.offsetHeight, $ = (T = l.value) == null ? void 0 : T.offsetWidth, j = !(y - q < 0) && y + Q + q >= document.documentElement.offsetHeight;
      u.value = j;
      const z = E + k >= document.documentElement.offsetWidth, Z = E + k / 2 - $ / 2 <= 0;
      r.value = j ? `${y - q + 8}px` : `${y + Q - 8}px`, c.value = 1, o.value = z ? `${E + k - $ - 4}px` : Z ? `${E + 4}px` : `${E + k / 2 - $ / 2}px`, i.value = z ? `${$ / 2 - k / 2 + 4}px` : Z ? `${-($ / 2) + k / 2 - 4}px` : "0px";
    }
    ...
    return (x, L) => (s(), f(K, null, [
      (s(), N(oe(x.onHover ? "a" : "button"), {
        id: `link-${x.id}`,
        ref_key: "source",
        ref: n,
        class: R(x.onHover ? "fr-link" : "fr-btn  fr-btn--tooltip"),
  ...
  setup(t) {
    const e = t, {
      ...
      doExpand: o,
      onTransitionEnd: r
    } = he(), i = O(!1), u = O(!1), c = w(() => `fr-transcription__modal-${e.id}`), p = w(() => `fr-transcription__collapse-${e.id}`);
    return ae(u, (g, _) => {
      g !== _ && o(g);
    }), (g, _) => (s(), f("div", pf, [
      d("button", {
      ...
      d("div", {
        ...
        onTransitionend: _[2] || (_[2] = (C) => F(r)(u.value))
      }, [
        d("dialog", {
          id: c.value,
          class: "fr-modal",
  ...
  name: "DsfrFacets",
  components: { DsfrCheckbox: xt, DsfrTag: Lt, DsfrButton: Pe },
  props: {
    facets: Array,
...
}, Nf = { class: "fr-mb-1w fr-text--md" }, Vf = { key: 0 }, jf = { class: "facet" }, Of = { class: "flex justify-between w-full fr-mb-0" }, qf = { class: "facet--count" }, Hf = { key: 1 }, Kf = { class: "flex justify-between w-full" }, zf = { class: "facet--count" }, Qf = { key: 0 }, Gf = { class: "facet" }, Wf = { class: "flex justify-between w-full fr-mb-0" }, Uf = { class: "facet--count" }, Xf = { key: 1 }, Yf = { class: "flex justify-between w-full" }, Zf = { class: "facet--count" }, Jf = { class: "fr-mb-2w" };
  ...
  return s(), f("div", null, [
    o.isAnyFacetValueSelected() ? (s(), f("div", Rf, [
      (s(!0), f(K, null, W(a.selectedFacets, (c, p) => (s(), f(K, { key: p }, [
        o.facetMultipleByCode(p) ? h("", !0) : (s(!0), f(K, { key: 0 }, W(c, (g) => (s(), N(r, {
          ...
          default: G(() => [
            V(b(o.facetLabelByCode(p)) + ": " + b(o.facetValueLabelByCode(p, g)), 1)
          ]),
          _: 2
        }, 1032, ["onClick"]))), 128))
      ], 64))), 128))
    ...
    (s(!0), f(K, null, W(a.facets, (c) => (s(), f("div", {
      ...
      c.multiple || !o.isFacetSelected(c.code) ? (s(), f(K, { key: 0 }, [
            ...
            c.multiple ? (s(), f("li", Vf, [
              d("div", jf, [
                X(i, {
                  ...
                  label: G(() => [
                    d("p", Of, [
                      V(b(o.facetValueLabelByCode(c.code, p.code)) + " ", 1),
                      d("span", qf, b(p.count), 1)
                    ])
                  ]),
                  _: 2
        ...
        d("div", Jf, [
          c.values.length > a.maxValues && !o.isFacetExpanded(c.code) ? (s(), N(u, {
            key: 0,
            size: "sm",
            tertiary: "",
...
const tp = /* @__PURE__ */ ye(Pf, [["render", ep], ["__scopeId", "data-v-0be4e596"]]), At = () => {
  const t = O(), e = O(!1), a = O(!1), n = () => {
    if (!t.value)
      return;
    t.value.style.setProperty("--collapser", "none");
  ...
  return ra[t];
}, np = (t) => Array.from({ length: t }).map(lp).join(""), Ie = (t = "", e = "") => (t ? `${t}-` : "") + np(5) + (e ? `-${e}` : ""), op = ["id", "onKeydown", "aria-disabled", "aria-controls", "aria-expanded"], rp = ["id", "aria-labelledby", "onKeydown"], sp = {
  class: "fr-menu__list",
  role: "none"
}, ip = /* @__PURE__ */ M({
  inheritAttrs: !1,
  ...
  setup(t, { expose: e }) {
    ...
    let p = O(0), g = [];
    be("menuItem", { menuItemIndex: p, addMenuItem: (D, I) => {
      p.value += 1, g.push(`${D}@${I}`);
    } }), be("id", i.id), ae(c, (D, I) => {
      D !== I && (o(D), D ? (setTimeout(() => P(), 100), document.addEventListener("click", x), document.addEventListener("touchstart", x)) : (document.removeEventListener("click", x), document.removeEventListener("touchstart", x)));
    });
    const C = (D, I) => {
...
}), up = /* @__PURE__ */ ye(ip, [["__scopeId", "data-v-089ea365"]]), dp = { role: "none" }, cp = ["id", "href"], fp = /* @__PURE__ */ M({
  inheritAttrs: !1,
  __name: "DsfrMenuLink",
  props: {
    label: { default: "" },
  ...
  setup(t) {
    const e = t, { menuItemIndex: a, addMenuItem: n } = Be("menuItem"), l = w(() => typeof e.icon == "string" && e.icon.startsWith("fr-icon-")), o = `fr-btn fr-btn--secondary fr-nav__link ${l ? e.icon : ""} fr-btn--icon-left`, r = Be("id"), i = a.value;
    return n(e.label, i), (u, c) => {
      ...
      return s(), f("li", dp, [
        u.url === "" ? (s(), N(p, H({
          ...
          secondary: "",
          class: "fr-nav__link"
        }, u.$attrs), null, 16, ["label", "id", "icon"])) : (s(), f("a", H({
          key: 1,
          tabindex: "-1",
          role: "menuitem",
          id: `${F(r)}_item_${F(i)}`,
...
}), pp = /* @__PURE__ */ ye(fp, [["__scopeId", "data-v-ca9ed6c2"]]), vp = ["for", "id"], mp = {
  key: 0,
  class: "required"
}, gp = {
  key: 0,
  ...
  setup(t) {
    ...
    ae(i, ($, j) => {
      $ !== j && (l($), $ ? (document.addEventListener("click", q), document.addEventListener("touchstart", q)) : (document.removeEventListener("click", q), document.removeEventListener("touchstart", q)));
    });
    const p = O(null), g = O(null), _ = O(null), C = w(() => r.errorMessage || r.successMessage), B = w(() => r.errorMessage !== "" ? "error" : "valid"), P = w(() => r.modelValue.length === c.value.length ? "fr-icon-close-circle-line" : "fr-icon-check-line"), v = w(() => r.modelValue.length === c.value.length ? "Tout déselectionner" : "Tout sélectionner"), S = w(() => {
      let $ = `${r.modelValue.length} options séléctionnées`;
      return r.modelValue.length > 2 ? $ : r.options.filter((j) => r.modelValue.includes(j.value)).map((j) => j.text).join(", ");
    });
    let x = function() {
      ...
      const j = $.target.value.toLowerCase();
      c.value = r.options.filter((z) => z.text.toLowerCase().indexOf(j) > -1);
    };
    const D = ($, j) => {
      const z = j === "down" ? ($ + 1) % c.value.length : ($ - 1 + c.value.length) % c.value.length, Z = document.getElementById(`${r.id}_option_${z}`);
      return Z.ariaDisabled === "true" ? D(z, j) : Z;
    }, I = ($) => {
      const j = document.activeElement.id, z = j.startsWith(`${r.id}_option_`) ? Number(j.split("_")[2]) : $ === "down" ? -1 : 0;
      D(z, $).focus();
    }, m = ($) => I("down"), T = ($) => I("up");
    let y = function($) {
      ...
      let j = $.key;
      if (j.length > 1 && j.match(/\S/) || document.activeElement.id === `${r.id}_filter`)
        return;
      j = j.toLowerCase();
      let z = c.value.filter((ee) => ee.text.toLowerCase().startsWith(j)), Z = document.activeElement.id;
      for (let ee of z) {
    ...
    return ($, j) => (s(), f(K, null, [
      d("div", H({
        ...
        d("div", {
          ...
          onClick: j[0] || (j[0] = (z) => i.value = !i.value),
          onKeydown: [
            j[1] || (j[1] = Y(U((z) => i.value = !1, ["stop"]), ["esc"])),
            j[2] || (j[2] = Y(U((z) => i.value = !i.value, ["prevent"]), ["space"])),
            Y(U(m, ["prevent"]), ["down"]),
            Y(U(T, ["prevent"]), ["up"]),
            j[3] || (j[3] = Y(
              //@ts-ignore
        ...
        d("div", {
          ...
          onKeyup: j[8] || (j[8] = Y((z) => i.value = !1, ["esc"])),
          onKeydown: [
            j[9] || (j[9] = Y(
              //@ts-ignore
              (...z) => F(Q) && F(Q)(...z),
          ...
          onTransitionend: j[12] || (j[12] = (z) => F(o)(i.value))
        }, [
          ...
          d("ul", Bp, [
            (s(!0), f(K, null, W(c.value, (z, Z) => (s(), f("li", {
              ...
              pe(d("input", {
                ...
                tabindex: "-1",
                value: z.value,
                "onUpdate:modelValue": j[7] || (j[7] = (ee) => u.value = ee)
              }, null, 8, xp), [
                [$e, u.value]
              ]),
              d("label", {
  ...
  setup(t) {
    ...
    be("menuItem", { menuItemIndex: c, addMenuItem: g }), be("id", r.id), ae(u, (x, L) => {
    ...
    const _ = (x, L) => {
      const D = L === "down" ? (x + 1) % p.length : (x - 1 + p.length) % p.length, I = document.getElementById(`${r.id}_item_${D}`);
      return I.ariaDisabled === "true" ? _(D, L) : I;
    }, C = (x) => {
      const L = document.activeElement.id, D = L.startsWith(`${r.id}_item_`) ? Number(L.split("_")[2]) : x === "down" ? -1 : 0;
      _(D, x).focus();
    }, B = (x) => C("down"), P = (x) => C("up");
    let v = (x) => {
      let L = x.key;
      ...
      i.value.contains(x.target) || (u.value = !1);
    };
    return (x, L) => (s(), f("div", {
      ...
      d("div", {
        ...
        A(x.$slots, "detail", {}, () => [
          x.nom === "" && x.email === "" ? h("", !0) : (s(), f("p", $p, [
            V(b(x.nom) + " ", 1),
            x.email !== "" ? (s(), f("span", Fp, b(x.email), 1)) : h("", !0)
          ]))
        ], !0),
        d("ul", Pp, [
          A(x.$slots, "default", {}, void 0, !0),
...
}), jp = /* @__PURE__ */ ye(Vp, [["__scopeId", "data-v-2c51eb4a"]]), Op = Symbol("header"), qp = ["aria-label"], Hp = { class: "fr-btns-group" }, mt = /* @__PURE__ */ M({
          ...
          d("div", Qp, [
            d("div", Gp, [
              ...
              d("div", sv, [
                (I = v.quickLinks) != null && I.length || l.value ? (s(), f("div", iv, [
                  ...
                  l.value ? (s(), N(F(Ae), H({ key: 1 }, l.value, {
                    onSelect: S[2] || (S[2] = (m) => n("language-select", m))
                  }), null, 16)) : h("", !0)
                ])) : h("", !0),
                d("div", uv, [
                  A(v.$slots, "header-search"),
                  v.showSearch ? (s(), N(F(Me), {
                    key: 0,
                    "searchbar-id": v.searchbarId,
                    label: v.searchLabel,
                    "model-value": v.modelValue,
            ...
            v.showSearch || P.value || v.quickLinks && v.quickLinks.length || l.value ? (s(), f("div", {
              ...
              d("div", cv, [
                ...
                d("div", fv, [
                  l.value ? (s(), N(F(Ae), H({ key: 0 }, l.value, {
                    onSelect: S[6] || (S[6] = (m) => l.value.currentLanguage = m.codeIso)
                  }), null, 16)) : h("", !0),
                  o.value ? (s(), N(mt, {
                    key: 1,
                ...
                d("tr", null, [
                  ...
                  (s(!0), f(K, null, W(m.headersRow, (y, Q) => (s(), f("th", H({
                    ...
                    d("div", {
                      ...
                      _.value !== (y.key ?? y) && (m.sortableRows === !0 || Array.isArray(m.sortableRows) && m.sortableRows.includes(y.key ?? y)) ? (s(), f("span", xv, [
                        X(F(le), {
                          name: "ri-sort-asc",
                          color: "var(--grey-625-425)"
                        })
...
}), Ov = /* @__PURE__ */ ye(jv, [["__scopeId", "data-v-0bee5f91"]]), qv = ["id", "name", "value", "checked", "required", "data-testid", "data-test"], Hv = ["for"], Kv = {
  key: 0,
  class: "required"
}, zv = {
  key: 0,
  ...
  setup(t) {
    ...
    async function p() {
      ...
      const I = (z = n.value) == null ? void 0 : z.getBoundingClientRect().top, m = (Z = n.value) == null ? void 0 : Z.offsetHeight, T = (ee = n.value) == null ? void 0 : ee.offsetWidth, y = (te = n.value) == null ? void 0 : te.getBoundingClientRect().left, Q = (ve = l.value) == null ? void 0 : ve.offsetHeight, k = (me = l.value) == null ? void 0 : me.offsetWidth, q = !(I - Q < 0) && I + m + Q >= document.documentElement.offsetHeight;
      u.value = q;
      const $ = y + T >= document.documentElement.offsetWidth, j = y + T / 2 - k / 2 <= 0;
      r.value = q ? `${I - Q + 8}px` : `${I + m - 8}px`, c.value = 1, o.value = $ ? `${y + T - k - 4}px` : j ? `${y + 4}px` : `${y + T / 2 - k / 2}px`, i.value = $ ? `${k / 2 - T / 2 + 4}px` : j ? `${-(k / 2) + T / 2 - 4}px` : "0px";
    }
    ae(a, p, { immediate: !0 }), ne(() => {
      window.addEventListener("scroll", p);
    }), fe(() => {
    ...
    const g = w(() => ["sm", "small"].includes(e.size)), _ = w(() => ["md", "medium"].includes(e.size)), C = w(() => ["lg", "large"].includes(e.size)), B = w(() => typeof e.icon == "string" && e.icon.startsWith("fr-icon-")), P = w(() => `transform: translate(${o.value}, ${r.value}); --arrow-x: ${i.value}; opacity: ${c.value};'`), v = w(() => ({
      "fr-tooltip--shown": a.value,
      "fr-placement--top": u.value,
      "fr-placement--bottom": !u.value
    })), S = (I) => {
...
}), al = /* @__PURE__ */ ye(Uv, [["__scopeId", "data-v-95dd9f76"]]), Xv = /* @__PURE__ */ M({
  __name: "DsfrButtonTooltip",
  setup(t) {
    return (e, a) => (s(), N(al, H({ "is-link": !1 }, e.$attrs), {
      default: G(() => [
        A(e.$slots, "default")
      ]),
      _: 3
...
}), Zv = ["id", "href", "aria-disabled"], Jv = /* @__PURE__ */ M({
  __name: "DsfrLink",
  props: {
    id: { default: () => Ie("link") },
    label: { default: "" },
  ...
  setup(t) {
    const e = t, a = w(() => ["sm", "small"].includes(e.size)), n = w(() => ["md", "medium"].includes(e.size)), l = w(() => ["lg", "large"].includes(e.size)), o = w(() => e.asButton ? "btn" : "link"), r = w(() => typeof e.icon == "string" && e.icon.startsWith("fr-icon-"));
    return (i, u) => (s(), f("a", H({
      id: `link-${i.id}`,
      ref: "source",
      href: i.href !== "" && !i.disabled ? i.href : void 0,
      ...
      class: {
        ...
        "fr-btn--tertiary": i.tertiary && !i.secondary && !i.noOutline,
        "fr-btn--tertiary-no-outline": i.tertiary && !i.secondary && i.noOutline,
        [`fr-${o.value}--sm`]: a.value,
        [`fr-${o.value}--md`]: n.value,
        [`fr-${o.value}--lg`]: l.value,
        [`fr-${o.value}--icon-right`]: !i.iconOnly && r.value && i.iconRight,
        [`fr-${o.value}--icon-left`]: !i.iconOnly && r.value && !i.iconRight,
        "inline-flex": !r.value,
        reverse: i.iconRight && !r.value,
        "fr-btn--custom-tooltip": i.iconOnly,
        "justify-center": !r.value && i.iconOnly,
        [i.icon]: r.value
      }
    }, i.$attrs), [
      A(i.$slots, "default", {}, () => [

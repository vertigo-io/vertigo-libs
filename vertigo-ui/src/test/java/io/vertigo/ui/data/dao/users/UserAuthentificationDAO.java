...
public final class UserAuthentificationDAO extends DAO<UserAuthentification, java.lang.Long> implements StoreServices {
	 ...
	 */
	@Inject
	public UserAuthentificationDAO(final EntityStoreManager entityStoreManager, final TaskManager taskManager) {
		super(UserAuthentification.class, entityStoreManager, taskManager);
	}

...
@Controller
@RequestMapping("/securedActionMovie")
public class SecuredActionController extends AbstractVSpringMvcController {
	...
	public void initContext(final ViewContext viewContext) {
		var movieId = 1000L;
		final Movie movie = movieServices.get(movieId);

		viewContext
				.publishRef(movIdKey, movieId)

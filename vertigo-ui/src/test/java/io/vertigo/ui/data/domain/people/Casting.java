...
public final class Casting implements Entity {
	 ...
	 */
	@Field(domain = "STyId", type = "ID", cardinality = io.vertigo.core.lang.Cardinality.ONE, label = "Cast_id")
	 ...
	 */
	@Field(domain = "STyLabelLong", label = "Character name")
	 ...
	 */
	@io.vertigo.datamodel.structure.stereotype.ForeignKey(domain = "STyId", label = "People", fkDefinition = "DtPeople" )
	 ...
	 */
	@io.vertigo.datamodel.structure.stereotype.ForeignKey(domain = "STyId", label = "Movie", fkDefinition = "DtMovie" )

...
public final class Casting implements Entity {
	...
	private Long peoId;
	private Long movId;
	private io.vertigo.ui.data.domain.people.People people;
	private io.vertigo.ui.data.domain.movies.Movie movie;
	...
	public io.vertigo.dynamo.domain.model.UID<io.vertigo.ui.data.domain.movies.Movie> getMovieURI() {
		return io.vertigo.dynamo.domain.util.DtObjectUtil.createUID(this, "ACastMov", io.vertigo.ui.data.domain.movies.Movie.class);
	}

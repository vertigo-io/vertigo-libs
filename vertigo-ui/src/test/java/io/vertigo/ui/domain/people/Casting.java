...
public final class Casting implements Entity {
	...
	private Long peoId;
	private Long movId;
	private io.vertigo.ui.domain.people.People people;
	private io.vertigo.ui.domain.movies.Movie movie;
	 ...
	 */
	public io.vertigo.ui.domain.people.People getPeople() {
		final io.vertigo.dynamo.domain.model.URI<io.vertigo.ui.domain.people.People> fkURI = getPeopleURI();
		if (fkURI == null) {
			return null;
		}
	...
	public io.vertigo.dynamo.domain.model.URI<io.vertigo.ui.domain.people.People> getPeopleURI() {
	 ...
	 */
	public io.vertigo.ui.domain.movies.Movie getMovie() {
		final io.vertigo.dynamo.domain.model.URI<io.vertigo.ui.domain.movies.Movie> fkURI = getMovieURI();
		if (fkURI == null) {
			return null;
		}
		//On est toujours dans un mode lazy. On s'assure cependant que l'objet associé n'a pas changé
	...
	public io.vertigo.dynamo.domain.model.URI<io.vertigo.ui.domain.movies.Movie> getMovieURI() {

...
public final class DtDefinitions implements Iterable<Class<?>> {
	...
	public enum Definitions {
		...
		ApplicationUser(io.vertigo.ui.domain.users.ApplicationUser.class),
		/** Objet de données Casting. */
		Casting(io.vertigo.ui.domain.people.Casting.class),
		/** Objet de données Commune. */
		Commune(io.vertigo.ui.domain.reference.Commune.class),
		/** Objet de données Dummy. */
		Dummy(io.vertigo.ui.domain.search.Dummy.class),
		...
		People(io.vertigo.ui.domain.people.People.class),
		/** Objet de données Profil. */
		Profil(io.vertigo.ui.domain.users.Profil.class),
		/** Objet de données SecurityRole. */
		SecurityRole(io.vertigo.ui.domain.users.SecurityRole.class),
		/** Objet de données UserAuthentification. */
		UserAuthentification(io.vertigo.ui.domain.users.UserAuthentification.class),
		;

...
public final class Profil implements Entity {
	...
	private io.vertigo.dynamo.domain.model.DtList<io.vertigo.ui.domain.users.SecurityRole> securityRole;
	 ...
	 */
	public io.vertigo.dynamo.domain.model.DtList<io.vertigo.ui.domain.users.SecurityRole> getSecurityRoleList() {
		...
		if (io.vertigo.dynamo.domain.util.DtObjectUtil.getId(this) == null) {
			return new io.vertigo.dynamo.domain.model.DtList<>(io.vertigo.ui.domain.users.SecurityRole.class);
		}

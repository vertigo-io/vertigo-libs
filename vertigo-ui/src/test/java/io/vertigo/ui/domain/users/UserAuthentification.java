...
public final class UserAuthentification implements Entity {
	...
	private Long usrId;
	private io.vertigo.ui.domain.users.ApplicationUser applicationUser;
	 ...
	 */
	public io.vertigo.ui.domain.users.ApplicationUser getApplicationUser() {
		final io.vertigo.dynamo.domain.model.URI<io.vertigo.ui.domain.users.ApplicationUser> fkURI = getApplicationUserURI();
		if (fkURI == null) {
			return null;
		}
	...
	public io.vertigo.dynamo.domain.model.URI<io.vertigo.ui.domain.users.ApplicationUser> getApplicationUserURI() {

 ...
 * under the License.
 */
package io.vertigo.x.account.plugins.identity.ldap;
...
import io.vertigo.x.account.impl.identity.IdentityRealmPlugin;
...
public final class LdapIdentityRealmPlugin implements IdentityRealmPlugin {
	...
	private Map<String, String> parseAccountAttributeMapping(final String ldapAccountAttributeMapping) {

...
public final class RoutesOrderTest {
	...
	public void testCatalogOrder() {
		...
		RestAssured.given()
				...
				.body("get(" + i++ + ")", Matchers.equalTo("Post /search/facetedClusteredResult (class io.vertigo.datafactory.collections.model.SelectedFacetValues :Body:[1]) -> class io.vertigo.datafactory.collections.model.FacetedQueryResult<Contact,class io.vertigo.dynamo.domain.model.DtList<Contact>>"))
				.body("get(" + i++ + ")", Matchers.equalTo("Post /search/facetedResult (class io.vertigo.datafactory.collections.model.SelectedFacetValues :Body:[1]) -> class io.vertigo.datafactory.collections.model.FacetedQueryResult<Contact,class io.vertigo.dynamo.domain.model.DtList<Contact>>"))

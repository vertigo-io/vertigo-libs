...
public final class RoutesOrderTest {
	...
	private void assertOrder(final String... routes) {
		...
		final SortedMap<String, String> myRoutesCodeSorted = new TreeMap<>(
				myRoutesCode.stream()
						.collect(Collectors.toMap(this::normalizePath, p -> p)));
	...
	public void testCatalogOrder() {
		...
		RestAssured.given()
				...
				.body("get(" + i++ + ")", Matchers.equalTo("Get /swaggerApi (interface jakarta.servlet.http.HttpServletRequest :Implicit:Request) -> interface java.util.Map<String,Object>"))
				.body("get(" + i++ + ")", Matchers.equalTo("Get /swaggerUi (interface jakarta.servlet.http.HttpServletResponse :Implicit:Response)"))
				.body("get(" + i++ + ")", Matchers.equalTo("Get /swaggerUi/ (interface jakarta.servlet.http.HttpServletResponse :Implicit:Response)"))
				.body("get(" + i++ + ")",
						Matchers.equalTo("Get /swaggerUi/{resourceUrl} (class java.lang.String :Path:resourceUrl, interface jakarta.servlet.http.HttpServletResponse :Implicit:Response)"))
				.body("get(" + i++ + ")", Matchers.equalTo(
						"Get /swaggerUi/{resourcePathUrl}/{resourceUrl} (class java.lang.String :Path:resourcePathUrl, class java.lang.String :Path:resourceUrl, interface jakarta.servlet.http.HttpServletResponse :Implicit:Response)"))
				...
				.body("get(" + i++ + ")", Matchers.equalTo(
						"Get /test/downloadNotModifiedFile (class java.lang.Integer :Query:id, class java.util.Date :Header:If-Modified-Since, interface jakarta.servlet.http.HttpServletResponse :Implicit:Response) -> VFile"))
				.body("get(" + i++ + ")", Matchers.equalTo("Get /test/dtList10/{id} (long :Path:id) -> class io.vertigo.datamodel.data.model.DtList<Contact>"))
				.body("get(" + i++ + ")", Matchers.equalTo("Get /test/dtList10elts/{id} (long :Path:id) -> class io.vertigo.datamodel.data.model.DtList<Contact>"))
				.body("get(" + i++ + ")", Matchers.equalTo("Get /test/dtListMeta () -> class io.vertigo.datamodel.data.model.DtList<Contact>"))
				...
				.body("get(" + i++ + ")", Matchers.equalTo("Get /test/listComplexMeta () -> class io.vertigo.datamodel.data.model.DtList<Contact>"))
				...
				.body("get(" + i++ + ")", Matchers.equalTo("Get /test/smartTypes/json/path/{geoPoint} (class io.vertigo.vega.webservice.data.domain.GeoPointJson :Path:geoPoint) -> GeoPointJson"))
				.body("get(" + i++ + ")", Matchers.equalTo("Get /test/smartTypes/json/query (class io.vertigo.vega.webservice.data.domain.GeoPointJson :Query:geoPoint) -> GeoPointJson"))
				.body("get(" + i++ + ")", Matchers.equalTo("Get /test/smartTypes/text/path/{geoPoint} (class io.vertigo.vega.webservice.data.domain.GeoPoint :Path:geoPoint) -> GeoPoint"))
				.body("get(" + i++ + ")", Matchers.equalTo("Get /test/smartTypes/text/query (class io.vertigo.vega.webservice.data.domain.GeoPoint :Query:geoPoint) -> GeoPoint"))
				.body("get(" + i++ + ")",
						Matchers.equalTo(" /*send param type='Confirm' or type = 'Contact' \n Return 'OK' or 'Contact'*/\nGet /test/twoResult (class java.lang.String :Query:type) -> UiContext"))
				...
				.body("get(" + i++ + ")", Matchers.equalTo("Get /testPojo/login ()"))
				.body("get(" + i++ + ")", Matchers.equalTo("Get /testPojo/logout ()"))
				...
				.body("get(" + i++ + ")", Matchers.equalTo(
						"Post /search/facetedClusteredResult (class io.vertigo.datafactory.collections.model.SelectedFacetValues :Body:[1]) -> class io.vertigo.datafactory.collections.model.FacetedQueryResult<Contact,class io.vertigo.datamodel.data.model.DtList<Contact>>"))
				.body("get(" + i++ + ")", Matchers.equalTo(
						"Post /search/facetedResult (class io.vertigo.datafactory.collections.model.SelectedFacetValues :Body:[1]) -> class io.vertigo.datafactory.collections.model.FacetedQueryResult<Contact,class io.vertigo.datamodel.data.model.DtList<Contact>>"))
				.body("get(" + i++ + ")", Matchers.equalTo("Post /search/selectedFacetValues (class io.vertigo.datafactory.collections.model.SelectedFacetValues :Body:[1]) -> UiContext"))
				.body("get(" + i++ + ")", Matchers.equalTo("Post /secured/contacts (class io.vertigo.vega.webservice.data.domain.Contact :Body:[1]) -> Contact"))
				.body("get(" + i++ + ")",
						Matchers.equalTo("Post /secured/contacts/search() (class io.vertigo.vega.webservice.data.domain.ContactCriteria :Body:[1]) -> interface java.util.List<Contact>"))
				...
				.body("get(" + i++ + ")", Matchers.equalTo(
						" /*Test ws multipart body with objects. Send a body with an object of to field : contactFrom, contactTo. Each one should be an json of Contact.*/\nPost /test/innerbody (class io.vertigo.vega.webservice.data.domain.Contact :InnerBody:contactFrom, class io.vertigo.vega.webservice.data.domain.Contact :InnerBody:contactTo) -> interface java.util.List<Contact>"))
				.body("get(" + i++ + ")", Matchers.equalTo(
						" /*Test ws multipart body with optional objects. Send a body with an object of to field : contactFrom, Optional<contactTo>. Each one should be an json of Contact.*/\nPost /test/innerbodyOptional (class io.vertigo.vega.webservice.data.domain.Contact :InnerBody:contactFrom, class io.vertigo.vega.webservice.data.domain.Contact :InnerBody:contactTo) -> interface java.util.List<Contact>"))
				.body("get(" + i++ + ")", Matchers.equalTo(
						" /*Test ws multipart body with serverSide objects. Send a body with an object of to field : contactFrom, contactTo. Each one should be an partial json of Contact with clientId.*/\nPost /test/innerBodyServerClient (class io.vertigo.vega.webservice.data.domain.Contact :InnerBody:contactFrom, class io.vertigo.vega.webservice.data.domain.Contact :InnerBody:contactTo) -> interface java.util.List<Contact>"))
				.body("get(" + i++ + ")", Matchers.equalTo(
						"Post /test/innerBodyValidationErrors (class io.vertigo.vega.webservice.data.domain.Contact :InnerBody:contactFrom, class io.vertigo.vega.webservice.data.domain.Contact :InnerBody:contactTo) -> interface java.util.List<Contact>"))
				.body("get(" + i++ + ")", Matchers.equalTo(
						" /*Test ws multipart body with primitives. Send a body with an object of to field : contactId1, contactId2. Each one should be an json of long.*/\nPost /test/innerLong (long :InnerBody:contactId1, long :InnerBody:contactId2) -> interface java.util.List<Contact>"))
				.body("get(" + i++ + ")", Matchers.equalTo(
						" /*Test ws multipart body with primitives. Send a body with an object of to field : contactId1, contactId2. Each one should be an json of long.*/\nPost /test/innerLongToDtList (long :InnerBody:contactId1, long :InnerBody:contactId2) -> class io.vertigo.datamodel.data.model.DtList<Contact>"))
				.body("get(" + i++ + ")", Matchers.equalTo(
						" /*Test ws with multiple path params.*/\nPost /test/multiPath/from/{conIdFrom}/to/{conIdTo} (long :Path:conIdFrom, long :Path:conIdTo) -> class io.vertigo.datamodel.data.model.DtList<Contact>"))
				.body("get(" + i++ + ")", Matchers.equalTo("Post /test/saveDtListContact (io.vertigo.datamodel.data.model.DtList<io.vertigo.vega.webservice.data.domain.Contact> :Body:[1]) -> String"))
				...
				.body("get(" + i++ + ")",
						Matchers.equalTo("Post /test/saveListDelta (io.vertigo.vega.webservice.model.DtListDelta<io.vertigo.vega.webservice.data.domain.Contact> :Body:[1]) -> String"))
				.body("get(" + i++ + ")", Matchers.equalTo(
						"Post /test/saveUiListContact (io.vertigo.vega.webservice.model.UiList<io.vertigo.vega.webservice.data.domain.Contact> :Body:[1], interface io.vertigo.vega.webservice.validation.UiMessageStack :Implicit:UiMessageStack) -> String"))
				...
				.body("get(" + i++ + ")", Matchers.equalTo(
						"Post /test/searchPagined() (class io.vertigo.vega.webservice.data.domain.ContactCriteria :InnerBody:criteria, class io.vertigo.datamodel.data.model.DtListState :InnerBody:listState) -> interface java.util.List<Contact>"))
				.body("get(" + i++ + ")", Matchers.equalTo(
						"Post /test/_searchQueryPagined (class io.vertigo.vega.webservice.data.domain.ContactCriteria :Body:[1], class io.vertigo.datamodel.data.model.DtListState :Query:) -> interface java.util.List<Contact>"))
				.body("get(" + i++ + ")", Matchers.equalTo("Post /test/smartTypes/json/body (class io.vertigo.vega.webservice.data.domain.GeoPointJson :Body:[1]) -> GeoPointJson"))
				.body("get(" + i++ + ")", Matchers.equalTo("Post /test/smartTypes/json/innerbody (class io.vertigo.vega.webservice.data.domain.GeoPointJson :InnerBody:geoPoint) -> GeoPointJson"))
				.body("get(" + i++ + ")", Matchers.equalTo("Post /test/smartTypes/text/body (class io.vertigo.vega.webservice.data.domain.GeoPoint :Body:[1]) -> GeoPoint"))
				.body("get(" + i++ + ")", Matchers.equalTo("Post /test/smartTypes/text/innerbody (class io.vertigo.vega.webservice.data.domain.GeoPoint :InnerBody:geoPoint) -> GeoPoint"))
				.body("get(" + i++ + ")", Matchers.equalTo("Post /test/string (class java.lang.String :Body:[1]) -> String"))
				.body("get(" + i++ + ")",
						Matchers.equalTo(
								"Post /test/string/optionalInnerBodyParam (class io.vertigo.vega.webservice.data.domain.Contact :Body:[1], class java.lang.String :InnerBody:token) -> String"))
				.body("get(" + i++ + ")",
						Matchers.equalTo("Post /test/string/optionalQueryParam (class io.vertigo.vega.webservice.data.domain.Contact :Body:[1], class java.lang.String :Query:token) -> String"))
				.body("get(" + i++ + ")", Matchers.equalTo(
						" /*Test ws returning UiContext. Send a body with an object of to field : contactId1, contactId2. Each one should be an json of long. You get partial Contacts with clientId in each one*/\nPost /test/uiContext (long :InnerBody:contactId1, long :InnerBody:contactId2) -> UiContext"))
				.body("get(" + i++ + ")", Matchers.equalTo(
						"Post /test/uiMessage (class io.vertigo.vega.webservice.data.domain.Contact :Body:[1], interface io.vertigo.vega.webservice.validation.UiMessageStack :Implicit:UiMessageStack) -> UiMessageStack"))
				.body("get(" + i++ + ")", Matchers.equalTo(
						"Post /test/uploadFile (interface io.vertigo.datastore.filestore.model.VFile :Query:upfile, class java.lang.Integer :Query:id, class java.lang.String :Query:note) -> VFile"))
				.body("get(" + i++ + ")", Matchers.equalTo("Post /test/uploadFileFocus (interface io.vertigo.datastore.filestore.model.VFile :Query:upfile) -> Integer"))
				.body("get(" + i++ + ")", Matchers.equalTo("Post /testPojo/contact (class io.vertigo.vega.webservice.data.domain.ContactViewPojo :Body:[1]) -> ContactViewPojo"))
				.body("get(" + i++ + ")", Matchers.equalTo("Post /testPojo/contactExcludeFieldsIn (class io.vertigo.vega.webservice.data.domain.ContactViewPojo :Body:[1]) -> ContactViewPojo"))
				.body("get(" + i++ + ")", Matchers.equalTo("Post /testPojo/contactExcludeFieldsOut (class io.vertigo.vega.webservice.data.domain.ContactViewPojo :Body:[1]) -> ContactViewPojo"))
				.body("get(" + i++ + ")", Matchers.equalTo("Post /testPojo/contactIncludedFieldsIn (class io.vertigo.vega.webservice.data.domain.ContactViewPojo :Body:[1]) -> ContactViewPojo"))
				.body("get(" + i++ + ")", Matchers.equalTo("Post /testPojo/contactIncludedFieldsOut (class io.vertigo.vega.webservice.data.domain.ContactViewPojo :Body:[1]) -> ContactViewPojo"))
				...
				.body("get(" + i++ + ")", Matchers.equalTo(
						"Put /test/contactAliasName/{conId} (long :Path:conId, class io.vertigo.vega.webservice.data.domain.Contact :Body:[1], class java.lang.String :InnerBody:itsatoolongaliasforfieldcontactname) -> Contact"))
				.body("get(" + i++ + ")", Matchers.equalTo(
						"Put /test/contactExtended/{conId} (long :Path:conId, class io.vertigo.vega.webservice.data.domain.Contact :Body:[1], class [I :InnerBody:vanillaUnsupportedMultipleIds) -> class io.vertigo.vega.webservice.model.ExtendedObject<Contact>"))

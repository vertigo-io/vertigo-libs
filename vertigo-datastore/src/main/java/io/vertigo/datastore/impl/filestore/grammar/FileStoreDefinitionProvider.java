package io.vertigo.datastore.impl.filestore.grammar;
 ...
 * @author pchretien
 */
public class FileStoreDefinitionProvider implements DefinitionProvider {
	 ...
	 */
	@Inject
	public FileStoreDefinitionProvider(final ResourceManager resourceManager, @ParamValue("encoding") final Optional<String> encoding) {
	...
	private List<DefinitionSupplier> parse(final DefinitionSpace definitionSpace) {
		...
		final DynamicRegistry searchDynamicRegistry = new FileDynamicRegistry();

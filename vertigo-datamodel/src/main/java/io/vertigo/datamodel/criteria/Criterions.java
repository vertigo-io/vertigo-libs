...
public final class Criterions {
	 ...
	 * @return is null
	 */
	public static <D extends Data> Criteria<D> isNull(final DataFieldName<D> dtFieldName) {
	 ...
	 * @return is not null
	 */
	public static <D extends Data> Criteria<D> isNotNull(final DataFieldName<D> dtFieldName) {
	 ...
	 */
	public static <D extends Data> Criteria<D> isEqualTo(final DataFieldName<D> dtFieldName, final Serializable value) {
	 ...
	 * @param value the value
	 */
	public static <D extends Data> Criteria<D> isNotEqualTo(final DataFieldName<D> dtFieldName, final Serializable value) {
	 ...
	 * @param value the value
	 */
	public static <D extends Data> Criteria<D> isGreaterThan(final DataFieldName<D> dtFieldName, final Serializable value) {
	 ...
	 * @param value the value
	 */
	public static <D extends Data> Criteria<D> isGreaterThanOrEqualTo(final DataFieldName<D> dtFieldName, final Serializable value) {
		Assertion.check().isTrue(value == null || value instanceof Comparable, "value must be comparable");
		//---
	 ...
	 * @param value the value
	 */
	public static <D extends Data> Criteria<D> isLessThan(final DataFieldName<D> dtFieldName, final Serializable value) {
		Assertion.check().isTrue(value == null || value instanceof Comparable, "value must be comparable");
		//---
	 ...
	 * @param value the value
	 */
	public static <D extends Data> Criteria<D> isLessThanOrEqualTo(final DataFieldName<D> dtFieldName, final Serializable value) {
		Assertion.check().isTrue(value == null || value instanceof Comparable, "value must be comparable");
		//---
	 ...
	 * @param value the value
	 */
	public static <D extends Data> Criteria<D> startsWith(final DataFieldName<D> dtFieldName, final String value) {
	 ...
	 */
	public static <D extends Data> Criteria<D> isBetween(final DataFieldName<D> dtFieldName, final CriterionLimit<D> min, final CriterionLimit<D> max) {
		Assertion.check()
				.isNotNull(min)
				.isNotNull(max);
	 ...
	 */
	public static <D extends Data> Criteria<D> in(final DataFieldName<D> dtFieldName, final Serializable... values) {
	 ...
	 * @return true
	 */
	public static <D extends Data> Criteria<D> alwaysTrue() {
	 ...
	 * @return true
	 */
	public static <D extends Data> Criteria<D> alwaysFalse() {
		return AlwaysCriteria.ALWAYS_FALSE;
	}

	private static class AlwaysCriteria<D extends Data> extends Criteria<D> {

...
public final class ApplicationUser implements Entity {
	 ...
	 */
	@Field(domain = "STyId", type = "ID", cardinality = io.vertigo.core.lang.Cardinality.ONE, label = "USR_ID")
	 ...
	 * @return Long proId
	 */
	@io.vertigo.datamodel.structure.stereotype.ForeignKey(domain = "STyId", label = "Profil", fkDefinition = "DtProfil")

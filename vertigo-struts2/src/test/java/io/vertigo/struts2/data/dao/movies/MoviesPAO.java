...
public final class MoviesPAO implements StoreServices {
	...
	*/
	...
	public io.vertigo.datamodel.structure.model.DtList<io.vertigo.struts2.data.domain.movies.MovieIndex> loadMovieIndex(@io.vertigo.datamodel.task.proxy.TaskInput(name = "movieIds", domain = "STyId") final java.util.List<Long> movieIds) {

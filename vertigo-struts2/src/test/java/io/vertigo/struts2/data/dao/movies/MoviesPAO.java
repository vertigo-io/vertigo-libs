...
public final class MoviesPAO implements StoreServices {
	...
	*/
	...
	public io.vertigo.dynamo.domain.model.DtList<io.vertigo.struts2.data.domain.movies.MovieIndex> loadMovieIndex(@io.vertigo.dynamo.task.proxy.TaskInput(name = "movieIds", domain = "STyId") final java.util.List<Long> movieIds) {

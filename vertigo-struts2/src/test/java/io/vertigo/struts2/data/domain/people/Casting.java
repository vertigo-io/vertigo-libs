...
public final class Casting implements Entity {
	 ...
	 */
	@io.vertigo.dynamo.domain.stereotype.ForeignKey(domain = "STyId", label = "People", fkDefinition = "DtPeople")
	 ...
	 */
	@io.vertigo.dynamo.domain.stereotype.ForeignKey(domain = "STyId", label = "Movie", fkDefinition = "DtMovie")

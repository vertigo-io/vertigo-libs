...
// $Id: calendar.js,v 1.1 2013/07/18 17:34:32 npiedeloup Exp $
...
Calendar = function (firstDayOfWeek, dateStr, onSelected, onClose) {
	...
	this.iframe = null; //Pour bug de z-index
...
Calendar.prototype.create = function (_par) {
	...
	if (this.isPopup && (Calendar.is_ie || Calendar.is_opera)) {
...
Calendar.prototype.hideShowCovered = function () {
	...
	if(this.iframe){
		...
		this.iframe.style.width=this.element.offsetWidth+"px";
		this.iframe.style.height=this.element.offsetHeight+"px";
		this.iframe.style.display = this.element.style.display;
	}
};
